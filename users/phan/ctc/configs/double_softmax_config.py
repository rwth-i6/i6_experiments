...
def lbs_960_double_softmax() -> SummaryReport:
    prefix = "experiments/ctc/double_softmax_v2"
    ...
    recog_args = exp_args.get_ctc_recog_step_args(
        ...
        prior_scales=[0.0, 0.45],
        lm_scales=[0.0, 0.9, 1.0, 1.1],
        # prior_scales=[0.45],
        # lm_scales=[0.9],
        feature_type=FeatureType.SAMPLES,
        ...
        for rel_scale in [0.2, 0.3]:
            ...
            # for learning_rate in [1e-4]:
                ...
                system.add_experiment_configs(
                    f"double_softmax_v2_ctc{12}_lstm{1}_am{am_scale}_lm{lm_scale}_adamw_{schedule_str}_lr{learning_rate}_eps{num_subepochs}",
