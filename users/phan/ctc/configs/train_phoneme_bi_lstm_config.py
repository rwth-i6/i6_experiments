...
def returnn_config_generator(
    ...
    return get_returnn_config(
        ...
        keep=list(range(20, num_subepochs+1, 20)),
        **kwargs
    )
...
def lbs960_train_phoneme_bi_lstm() -> SummaryReport:
    prefix = "experiments/ctc/phoneme_bi_lstm"
        ...
        for n_lstm_layers in [1, 2]:
            for mask_ratio in [0.2, 0.4]:
                lr = {
                    ...
                    "error_measure": "dev_loss_pseudo_ppl", # Pseudo PPL, not PPL
                }
                system.add_experiment_configs(
                    f"phoneme_bi_lstm_layers{n_lstm_layers}_embed{embed_dim}_hidden{hidden_dim}_mask{mask_ratio}_eps{num_subepochs}"
