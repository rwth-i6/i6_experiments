...
from i6_experiments.users.phan.models import bigram_lm
...
from i6_experiments.users.phan.models.bigram_lm import BigramLM
...
def get_dataset(data):
    epoch_split = {"train": 1, "cv": 1, "test": 1}
    seq_order = {
        "train": "random",
        "cv": "sorted",
        "test": "default"
...
def returnn_config_generator(
    ...
    model_config = bigram_lm.BigramLMConfig(
    ...
    return get_returnn_config(
        ...
        extra_python=[
            bigram_lm.get_train_serializer(
                model_config,
                "i6_experiments.users.phan.ctc.train_steps.lm_delayed_dataset"
            ),
        ],
...
def lbs960_train_phoneme_bigram() -> SummaryReport:
    prefix = "experiments/ctc/phoneme_bigram"
    ...
    for init_learning_rate in init_learning_rates:
        ...
        system.add_experiment_configs(
            f"phoneme_bigram_layers{num_hidden_layers}_embed{embed_dim}_hidden{hidden_dim}"
            f"_adamw_lr{init_learning_rate}",
