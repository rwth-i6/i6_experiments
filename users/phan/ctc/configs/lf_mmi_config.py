...
num_outputs = 79
num_subepochs = 100
recog_epochs = [5, 20, 40, 60, 80, num_subepochs]
...
def returnn_config_generator(
    ...
    wrapper_config_kwargs = {
        'module_class': {
            ...
            'train_lm': bigram_lm.BigramLM,
        },
        'module_config': {
            'conformer_ctc': conformer_ctc_config,
            'train_lm': bigram_lm_config,
        },
        'module_preload': None,
    }
    ...
    module_class_import = {
        ...
        'train_lm': "i6_experiments.users.phan.models.bigram_lm"
    }
    ...
    if variant == ConfigVariant.TRAIN:
        prologue_serializers_kwargs = {
            "train_step_package": "i6_experiments.users.phan.ctc.train_steps.lf_mmi",
...
def lbs_960_lf_mmi() -> SummaryReport:
    prefix = "experiments/ctc/lf_mmi"
        ...
        for rel_scale in [0.2, 0.3]:
            for learning_rate in [1e-5, 1e-6]:
                ...
                system.add_experiment_configs(
                    f"lf_mmi_2gram_ctc{12}_am{am_scale}_lm{lm_scale}_adamw_{schedule_str}_lr{learning_rate}_eps{num_subepochs}",
