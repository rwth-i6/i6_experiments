...
def lbs_960_run_kldiv_ctc_bigram_mask_gmm_align() -> SummaryReport:
    prefix = "experiments/ctc/kldiv_ctc_bigram_mask_gmm_align"
        ...
        for init_learning_rate in [1e-3, 1e-4]:
            for mask_ratio in [0.2, 0.4, 0.6]:
                ...
                system.add_experiment_configs(
                    f"kldiv_ctc_bigram_ctc12_bigram_adamw_newbobrel_lr{init_learning_rate}_mask{mask_ratio}_eps{num_subepochs}",
