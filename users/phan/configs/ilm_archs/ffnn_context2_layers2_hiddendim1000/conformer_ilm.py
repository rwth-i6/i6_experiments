...
from i6_experiments.users.phan.configs.ilm_archs.ffnn_context2_layers2_hiddendim1000.ilm_config import default_ilm_config as \
    default_ffnn_context2_layers2_hiddendim1000_ilm_config
config_11gb.update({"internal_language_model": default_ffnn_context2_layers2_hiddendim1000_ilm_config})
...
def train_exp(
    ...
    *,
    ...
    recog_config_update = {
        ...
        "internal_language_model": default_ffnn_context2_layers2_hiddendim1000_ilm_config,
