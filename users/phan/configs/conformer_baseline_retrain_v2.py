...
def sis_run_with_prefix(prefix_name: Optional[str] = None):
    ...
    for lr, ep in itertools.product(lr_list, ep_list):
        train_exp( 
            f"conformer_baseline_retrain_noAuxLosses_v2_lr_{lr}_ep_{ep}",
            config_11gb,
...
def train_exp(
    ...
    *,
    ...
    # lm_scales = [0.9, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5, 1.6]
    # ilm_scales = [0.0] 
