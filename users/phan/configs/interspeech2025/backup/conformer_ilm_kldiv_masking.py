"""
Config for training and recognition for LSTM ILM with the masking method
"""
...
from i6_experiments.users.phan.rf_models.model_conformer_with_ilm_v2 import from_scratch_model_def, from_scratch_training_kldiv_masking
...
def train_exp(
    ...
    *,
    ...
    # --------------- LibriSpeech (without frame-level prior) -----------------
    ...
    # ------------ ted2 recognition without frame-level prior ----------
    beam_sizes = [32]
    length_norm_scales = [0.0]
    lm_scales = [1.6]
    ilm_scales = [1.2] 
    ...
    # ------------ ted2 recognition with frame-level prior ----------
    beam_sizes = [32]
    length_norm_scales = [0.0]
    lm_scales = [1.6]
    ilm_scales = [1.1] 
