"""
Config for training and recognition for LSTM ILM with the sequence-level method
"""
...
from i6_experiments.users.phan.rf_models.model_conformer_with_ilm_v2 import from_scratch_model_def, ilm_kldiv_sequence_level
...
def train_exp(
    ...
    *,
    ...
    # # --------------- LibriSpeech recognition no prior -----------------
    ...
    # ---------- ted2 recognition no frame-level prior -----------
    beam_sizes = [32]
