...
def model_recog_time_sync_recomb_first(
    *,
    model,
    data: Tensor,
...
# RecogDef API
model_recog_time_sync_recomb_first: RecogDef[Model]
model_recog_time_sync_recomb_first.output_with_beam = True
model_recog_time_sync_recomb_first.output_blank_label = None
model_recog_time_sync_recomb_first.batch_size_dependent = False
