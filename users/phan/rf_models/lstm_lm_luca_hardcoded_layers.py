...
class LSTM_LM_Model_Hardcoded_Layers(rf.Module):
    """Model definition"""
    ...
    def __init__(
        ...
        *,
        ...
        super(LSTM_LM_Model_Hardcoded_Layers, self).__init__()
        self.in_dim = in_dim
    ...
    def __call__(
        ...
        state,
        spatial_dim: Dim,
        batch_dims=None, # compatible interface with the trafo LM
    ):
        """loop step"""
        lm_state = rf.State()
        ...
        lstm_0, lstm_0_state = self.lstm_0(decoded, state=state.lstm_0, spatial_dim=spatial_dim)
        lm_state.lstm_0 = lstm_0_state
        lstm_1, lstm_1_state = self.lstm_1(lstm_0, state=state.lstm_1, spatial_dim=spatial_dim)
        lm_state.lstm_1 = lstm_1_state
        lstm_2, lstm_2_state = self.lstm_2(lstm_1, state=state.lstm_2, spatial_dim=spatial_dim)
        lm_state.lstm_2 = lstm_2_state
        lstm_3, lstm_3_state = self.lstm_3(lstm_2, state=state.lstm_3, spatial_dim=spatial_dim)
...
class MakeModel:
    ...
    def __call__(self) -> LSTM_LM_Model_Hardcoded_Layers:
    ...
    def make_model(
        ...
        *,
        ...
        # num_enc_layers: int = 12,
    ) -> LSTM_LM_Model_Hardcoded_Layers:
        """make"""
        return LSTM_LM_Model_Hardcoded_Layers(
            in_dim,
