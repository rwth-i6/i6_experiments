"""
Alignments
https://github.com/rwth-i6/i6_experiments/blob/8ed4547318ad3b37503564788418a22ac5c7c67a/users/zeyer/experiments/exp2024_09_09_grad_align.py#L1094
"""
...
class CalcAlignmentMetrics(Job):
    ...
    def run(self):
        ...
        while alignments_ds.is_less_than_num_seqs(seq_idx):
            ...
            # ------------------- incompatible seq name between the alignments and the ref GMM ----------
            if key.startswith("train-clean") or key.startswith("train-other"):
                key = "train-other-960" + key[len("train-clean-XXX"):]
            # ----------------------------------------
            ...
            # passert last_frame_start <= duration_sec <= align_dur + 0.0301
