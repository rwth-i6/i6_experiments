__all__ = [
    ...
    "FFNNTransducerPrunedTrainOptions",
...
from .pytorch_modules import FFNNTransducerQATEncoderModel


@dataclass
class FFNNTransducerQATEncoderTrainOptions(TrainOptions):
    enc_loss_scale: float
    pred_loss_scale: float


@dataclass
class FFNNTransducerQATEncoderPrunedTrainOptions(FFNNTransducerQATEncoderTrainOptions):
    delay_penalty: float
...
def get_train_step_import(
    options: FFNNTransducerQATEncoderTrainOptions,
) -> PartialImport:
...
def get_pruned_train_step_import(
    options: FFNNTransducerQATEncoderPrunedTrainOptions,
) -> PartialImport:
    return PartialImport(
...
def _train_step(
    *,
    model: FFNNTransducerQATEncoderModel,
    data: dict,
    run_ctx: RunCtx,
    enc_loss_scale: float,
    pred_loss_scale: float,
