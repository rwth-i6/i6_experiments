...
from .pytorch_modules import QATFFNNTransducerModel


@dataclass
class QATFFNNTransducerTrainOptions(TrainOptions):
    enc_loss_scale: float
    pred_loss_scale: float


@dataclass
class QATFFNNTransducerPrunedTrainOptions(QATFFNNTransducerTrainOptions):
    delay_penalty: float
...
def get_train_step_import(
    options: QATFFNNTransducerTrainOptions,
) -> PartialImport:
...
def get_pruned_train_step_import(
    options: QATFFNNTransducerPrunedTrainOptions,
) -> PartialImport:
    return PartialImport(
