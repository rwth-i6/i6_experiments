...
from .pytorch_modules import QATFFNNTransducerRecogConfig, QATFFNNTransducerScorer
...
def export_scorer(model_config: QATFFNNTransducerRecogConfig, checkpoint: PtCheckpoint) -> tk.Path:
    model_serializers = get_model_serializers(model_class=QATFFNNTransducerScorer, model_config=model_config)
...
def _scorer_forward_step(*, model: QATFFNNTransducerScorer, extern_data: TensorDict, **_):
