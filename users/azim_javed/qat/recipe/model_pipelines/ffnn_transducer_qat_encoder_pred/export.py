...
from .pytorch_modules import FFNNTransducerQATEncoderPredictionConfig, FFNNTransducerQATEncoderPredictionScorer
...
def export_scorer(model_config: FFNNTransducerQATEncoderPredictionConfig, checkpoint: PtCheckpoint) -> tk.Path:
    model_serializers = get_model_serializers(model_class=FFNNTransducerQATEncoderPredictionScorer, model_config=model_config)
...
def _scorer_forward_step(*, model: FFNNTransducerQATEncoderPredictionScorer, extern_data: TensorDict, **_):
