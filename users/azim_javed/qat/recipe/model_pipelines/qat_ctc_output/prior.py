...
from .pytorch_modules import QATConformerCTCOutputConfig, QATConformerCTCOutputModel


def compute_priors(
    prior_data_config: DataConfig,
    model_config: QATConformerCTCOutputConfig,
    checkpoint: PtCheckpoint,
) -> tk.Path:
    model_serializers = get_model_serializers(model_class=QATConformerCTCOutputModel, model_config=model_config)
