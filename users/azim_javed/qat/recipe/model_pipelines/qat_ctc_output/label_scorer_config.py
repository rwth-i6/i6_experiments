...
from .pytorch_modules import QATConformerCTCOutputConfig


def get_ctc_prefix_label_scorer_config(model_config: QATConformerCTCOutputConfig, scale: float = 1.0) -> RasrConfig:
