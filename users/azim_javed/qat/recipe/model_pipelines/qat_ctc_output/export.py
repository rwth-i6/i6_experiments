...
from .pytorch_modules import QATConformerCTCOutputRecogConfig, QATConformerCTCOutputRecogExportModel


def export_model(model_config: QATConformerCTCOutputRecogConfig, checkpoint: PtCheckpoint) -> tk.Path:
    model_serializers = get_model_serializers(model_class=QATConformerCTCOutputRecogExportModel, model_config=model_config)
...
def _model_forward_step(*, model: QATConformerCTCOutputRecogExportModel, extern_data: TensorDict, **_):
