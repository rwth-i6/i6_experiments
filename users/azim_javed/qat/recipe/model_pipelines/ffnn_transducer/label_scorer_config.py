...
from .pytorch_modules import FFNNTransducerConfig, FFNNTransducerRecogConfig, FFNNTransducerScorer
...
def get_ffnn_transducer_label_scorer_config(
    ...
    imports = [
        Import(f"{FFNNTransducerScorer.__module__}.{FFNNTransducerScorer.__name__}", import_as="ScorerModel"),
        Import(f"{FFNNTransducerRecogConfig.__module__}.{FFNNTransducerRecogConfig.__name__}", import_as="RecogConfig"),
