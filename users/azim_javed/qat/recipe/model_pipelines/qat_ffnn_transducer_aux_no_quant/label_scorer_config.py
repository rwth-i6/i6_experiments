...
from .pytorch_modules import QATFFNNTransducerAuxNoQuantConfig, QATFFNNTransducerAuxNoQuantRecogConfig, QATFFNNTransducerAuxNoQuantScorer
...
def get_ffnn_transducer_label_scorer_config(
    model_config: QATFFNNTransducerAuxNoQuantConfig,
    ...
    imports = [
        Import(f"{QATFFNNTransducerAuxNoQuantScorer.__module__}.{QATFFNNTransducerAuxNoQuantScorer.__name__}", import_as="ScorerModel"),
        Import(f"{QATFFNNTransducerAuxNoQuantRecogConfig.__module__}.{QATFFNNTransducerAuxNoQuantRecogConfig.__name__}", import_as="RecogConfig"),
