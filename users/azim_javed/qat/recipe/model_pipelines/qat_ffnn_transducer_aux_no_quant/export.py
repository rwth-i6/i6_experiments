...
from .pytorch_modules import QATFFNNTransducerAuxNoQuantRecogConfig, QATFFNNTransducerAuxNoQuantScorer
...
def export_scorer(model_config: QATFFNNTransducerAuxNoQuantRecogConfig, checkpoint: PtCheckpoint) -> tk.Path:
    model_serializers = get_model_serializers(model_class=QATFFNNTransducerAuxNoQuantScorer, model_config=model_config)
...
def _scorer_forward_step(*, model: QATFFNNTransducerAuxNoQuantScorer, extern_data: TensorDict, **_):
