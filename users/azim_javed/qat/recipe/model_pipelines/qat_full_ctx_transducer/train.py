...
from .pytorch_modules import LstmTransducerQATEncoderModel


@dataclass
class LstmTransducerQATEncoderTrainOptions(TrainOptions):
    enc_loss_scale: float
    pred_loss_scale: float


@dataclass
class LstmTransducerQATEncoderPrunedTrainOptions(LstmTransducerQATEncoderTrainOptions):
    delay_penalty: float
...
def get_train_step_import(
    options: LstmTransducerQATEncoderTrainOptions,
) -> PartialImport:
...
def get_pruned_train_step_import(
    options: LstmTransducerQATEncoderPrunedTrainOptions,
) -> PartialImport:
    return PartialImport(
...
def _train_step(
    *,
    model: LstmTransducerQATEncoderModel,
    data: dict,
    run_ctx: RunCtx,
