...
from ....model_pipelines.qat_full_ctx_transducer.label_scorer_config import (
...
def run(
    model: TrainedModel[QATLstmTransducerConfig],
...
def _get_label_scorer_configs(
    model: TrainedModel[QATLstmTransducerConfig], variant: TransducerRecogVariant
) -> List[RasrConfig]:
...
def _run_single_variant(
    ...
    return run_single_bpe_variant(
        ...
        checkpoint=model.get_checkpoint(variant.epoch),
        encoder_serializers=get_model_serializers(QATLstmTransducerEncoder, model.model_config),
