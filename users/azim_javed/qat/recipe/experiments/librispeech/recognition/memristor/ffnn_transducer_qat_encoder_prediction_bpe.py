...
from .....model_pipelines.ffnn_transducer_qat_encoder_pred.mem_inited.label_scorer_config import (
    get_ffnn_transducer_label_scorer_config,
)
from .....model_pipelines.ffnn_transducer_qat_encoder_pred.pytorch_modules import (
    FFNNTransducerQATEncoderPredictionConfig as BaseFFNNTransducerQATEncoderPredictionConfig,
    FFNNTransducerQATEncoderPredictionModel as BaseFFNNTransducerQATEncoderPredictionModel,
)

from .....model_pipelines.ffnn_transducer_qat_encoder_pred.mem_inited.pytorch_modules import (
...
def run(
    model: TrainedModel[BaseFFNNTransducerQATEncoderPredictionConfig],
    ...
    for variant in variants:
        if (
            batch_size_seconds is not None
            and variant.search_mode_params.batch_size_seconds == OfflineRecogParameters.batch_size_seconds
        ):
            variant = replace(
                variant,
...
def _convert_model_for_memristor(
    ...
    memristor_model, memristor_config = convert_model_for_memristor(
        ...
        model_class=BaseFFNNTransducerQATEncoderPredictionModel,
        converter_hardware_settings=converter_hardware_settings,
        pos_enc_converter_hardware_settings=pos_enc_converter_hardware_settings,
        correction_settings=correction_settings,
        num_cycles=num_cycles,
...
def _run_single_variant(
    ...
    return run_single_bpe_variant(
        ...
        encoder_serializers=_get_model_serializers(
            FFNNTransducerQATEncoderPredictionEncoder, memristor_model.model_config
        ),
