...
def run(
    ...
    for variant in variants:
        results.extend(_run_single_variant(model=model, variant=variant, corpora=corpora, batched_decoder=batched_decoder))
    return results
...
def mbs1024_offline_tree_recog_variant() -> CTCRecogVariant:
...
def mbs2048_offline_tree_recog_variant() -> CTCRecogVariant:
    return CTCRecogVariant(
...
def _run_single_variant(
    ...
    if batched_decoder:
        variant_prefix = f"batched_decoder_v2_"
