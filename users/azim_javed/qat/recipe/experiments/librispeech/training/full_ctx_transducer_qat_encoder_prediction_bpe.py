...
from ....model_pipelines.full_ctx_transducer_qat_encoder_pred.pytorch_modules import (
    LstmTransducerQATEncoderPredictionConfig,
    LstmTransducerQATEncoderPredictionModel,
)
from ....model_pipelines.full_ctx_transducer_qat_encoder_pred.train import (
...
def run(
    ...
    model_config: Optional[LstmTransducerQATEncoderPredictionConfig] = None,
    train_options: Optional[LstmTransducerQATEncoderPredictionTrainOptions] = None,
) -> TrainedModel[LstmTransducerQATEncoderPredictionConfig]:
    ...
    return train(
        ...
        model_class=LstmTransducerQATEncoderPredictionModel,
...
def get_model_config(
    ...
    return LstmTransducerQATEncoderPredictionConfig(
...
def get_train_options(bpe_size: int = 128) -> LstmTransducerQATEncoderPredictionTrainOptions:
    return LstmTransducerQATEncoderPredictionTrainOptions(
