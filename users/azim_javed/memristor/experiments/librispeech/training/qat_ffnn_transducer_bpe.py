...
def run(
    ...
    if model_config is None:
        ...
        model_config = get_model_config(**kwargs)
...
def get_model_config(weight_bit_prec: Union[int, dict], activation_bit_prec: int, weight_dropout: float, weight_pruning_config: WeightPruningConfig, bpe_size: int = 128) -> QATFFNNTransducerConfig:
