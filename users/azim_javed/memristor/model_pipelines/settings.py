...
if "/u/azim.javed/experiments/training/baselines" not in sys.path:
    sys.path.append("/u/azim.javed/experiments/training/baselines")
...
DEFAULT_ENVIRONMENT_SET.update(
    {
        "TMPDIR": TMP_PREFIX,
        "TMP": TMP_PREFIX,
        "PYTHONPATH": os.environ.get("PWD", os.getcwd()) + ":/u/azim.javed/experiments/training/baselines" + (":" + os.environ["PYTHONPATH"] if "PYTHONPATH" in os.environ else ""),
