"""
https://github.com/iShohei220/adopt/blob/main/adopt.py
(commit 6e94fbc, 2024-11-09)
    ...
    *,
    ...
    for (
        ...
        if device_state_steps[0] == 2:
            ...
            torch._foreach_addcdiv_(device_exp_avgs, device_grads, exp_avg_sq_sqrt, value=1 - beta1)
