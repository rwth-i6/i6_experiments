...
def py():
    ...
    # Better baseline (DecPosEncAbs, featBN, bpeSample001, baseLr0.5) with auxCtcLs0.1.
    ...
    # Again but without aux CTC loss (which seems to be suboptimal).
    for name, opts in [
        ("0", None),
        ("A0.1", _ta_vA_err_prob(0.1)),
        ("A0.2", _ta_vA_err_prob(0.2)),
