...
def py():
    ...
    # TODO add CTC results, the comment out again
    ...
    # +CTC:
    # TODO put results, then comment out again...
    ...
    # TODO new baseline:
    #   bhv24 + s2 + fixMp + auxShared (?) + auxNoBias (?) + auxDec3 + AudioPadRnd100 + ...?
    ...
    # +CTC:
    # TODO put CTC res. then comment out again.
