...
def py():
    ...
    # 21: {"dev-clean": 3.41, "dev-other": 5.56, "test-clean": 3.90, "test-other": 5.77}
    # 23: {"dev-clean": 3.58, "dev-other": 5.09, "test-clean": 3.84, "test-other": 5.66}
    # 24: {"dev-clean": 3.09, "dev-other": 4.97, "test-clean": 3.49, "test-other": 5.40}
    # TODO ???
    for bhv in [21, 23, 24]:
        aed_train_exp(
    ...
    # (0.0: {"dev-clean": 2.38, "dev-other": 4.87, "test-clean": 2.89, "test-other": 5.35}) -- not comparable, s1
    ...
    # TODO redo in consistent setup (fixed s2, better baseline...)
    ...
    aed_train_exp(
        "EncL16-DecLstm-featBN-aux4_10_16-spm10k-bpeSample001-baseLr0.5-b100k",
        config_96gb_bf16_accgrad1,
        prefix=prefix + "/aed/",
        model_config={
            "enc_build_dict": rf.build_dict(
    ...
    # aed_train_exp(
    #     "EncL16-DecL6-D1024-DecPosEncAbs-DecReadoutMax-featBN-aux4_10_16-spm10k-bpeSample001-baseLr0.5-b100k",
    #     config_96gb_bf16_accgrad1,
    #     prefix=prefix + "/aed/",
    #     model_config={
    #         "enc_build_dict": rf.build_dict(
