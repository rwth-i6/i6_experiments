...
def eow_phon_ls100_0824_base():
    ...
    name = ".384dim_sub4_11gbgpu_100eps_sp_lp_fullspec_gradnorm_smallbatch"

    training_name = prefix_name + "/" + network_module_conv_first + name
    train_job = training(training_name, train_data, train_args_conv_first, num_epochs=300, **default_returnn)
