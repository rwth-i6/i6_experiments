...
# Best results: {'best_scores': {'hub5e_00': 22.0, 'hub5e_01': 15.7, 'rt03s': 20.4}, 'best_epoch': 149}
_exclude_me = True
...
class DecoderLabelSync(nn.Module):
    ...
    def __init__(
        ...
        in_dim: nn.Dim,
        *,
        embed_dim: nn.Dim = nn.FeatureDim("embed", 64),
        lstm_dim: nn.Dim = nn.FeatureDim("lstm", 512),
        dropout: float = 0.2,
        l2: float = 0.0001,
    ):
