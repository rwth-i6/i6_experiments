...
# Best results: {'best_scores': {'hub5e_00': 26.1, 'hub5e_01': 20.5, 'rt03s': 28.5}, 'best_epoch': 150}
_exclude_me = True
...
class ConformerEncoder:
  ...
  * Ref: https://arxiv.org/abs/2005.08100
  ...
  def __init__(self, input='data', input_layer='conv', num_blocks=16, conv_kernel_size=32, specaug=True, pos_enc='rel',
               ...
               dropout=0.1, att_dropout=0.1, enc_key_dim=256, att_num_heads=4, l2=0.0, lstm_dropout=0.1,
               ...
               add_to_prefix_name=None, output_layer_name='output', create_only_blocks=False,
