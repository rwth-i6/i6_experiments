...
# Unstable, diverges in the end, needs less label smoothing, or more warmup, slower pretrain.
_exclude_me = True
...
def from_scratch_training(
    *, model: Model, data: nn.Tensor, data_spatial_dim: nn.Dim, targets: nn.Tensor, targets_spatial_dim: nn.Dim
    ...
    out_log_prob = nn.label_smoothed_log_prob_gradient(out_log_prob, 0.1)
