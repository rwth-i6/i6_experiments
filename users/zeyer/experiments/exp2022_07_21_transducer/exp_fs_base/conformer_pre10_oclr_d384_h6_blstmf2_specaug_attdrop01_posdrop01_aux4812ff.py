...
# Best results: {'best_scores': {'hub5e_00': 20.9, 'hub5e_01': 15.8, 'rt03s': 20.2}, 'best_epoch': 149}
_exclude_me = True
...
config = dict(
    ...
    learning_rates=(
        ...
        + list(numpy.linspace(0.0000001, 0.001, num=45))
        + list(numpy.linspace(0.001, 0.0001, num=45))
        + list(numpy.linspace(0.0001, 0.001 / 50, num=30))
    ),
