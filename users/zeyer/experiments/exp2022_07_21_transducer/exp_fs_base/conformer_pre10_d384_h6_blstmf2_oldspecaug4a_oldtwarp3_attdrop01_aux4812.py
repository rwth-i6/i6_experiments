...
# Best results: {'best_scores': {'hub5e_00': 23.0, 'hub5e_01': 15.9, 'rt03s': 21.6}, 'best_epoch': 150}
_exclude_me = True
...
def transform(source, self, **_kwargs):
    ...
    def _get_masked():
        ...
        x_masked = random_warp(
            x_masked, std=(10.0 * step2f + 30.0 * step3f + 50.0 * step4f, 1.0), scale=(10.0, float(data.dim) / 2.0)
        )
