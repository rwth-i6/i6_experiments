...
# Best results: {'best_scores': {'hub5e_00': 19.8, 'hub5e_01': 15.7, 'rt03s': 19.5}, 'best_epoch': 150}
_exclude_me = True
...
config = dict(
    ...
    learning_rates=(
        ...
        list(numpy.linspace(0.0000001, 0.0005, num=10)) * 3 +
        list(numpy.linspace(0.0000001, 0.0005, num=30))
    ),
