...
# Best results: {'best_scores': {'hub5e_00': 22.1, 'hub5e_01': 17.6, 'rt03s': 21.7}, 'best_epoch': 149}
_exclude_me = True
...
config = dict(
    ...
    learning_rates=(
        ...
        list(numpy.linspace(0.0000001, 0.002, num=10)) * 3
        + list(numpy.linspace(0.0000001, 0.002, num=30))
    ),
