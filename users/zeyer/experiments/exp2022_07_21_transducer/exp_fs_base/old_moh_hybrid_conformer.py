...
conformer_net_dict = {
    ...
    'p1': {
        'class': 'pool', 'from': 'y1', 'mode': 'max', 'padding': 'same', 'pool_size': (1, 2),
        'in_spatial_dims': ('stag:time', 'stag:audio'),
    },
    'c3': {'class': 'conv', 'filter_size': (3, 3), 'from': 'p1', 'n_out': 64, 'padding': 'same',
           'in_spatial_dims': ("stag:time", "stag:conv:s1"),
           'with_bias': True},
    'y3': {'activation': 'swish', 'batch_norm': False, 'class': 'activation', 'from': 'c3'},
    'c4': {'class': 'conv', 'filter_size': (3, 3), 'from': 'y3', 'n_out': 64, 'padding': 'same',
           'in_spatial_dims': ("stag:time", "stag:conv:s1"),
           'strides': (2, 1), 'with_bias': True},
    'y4': {'activation': 'swish', 'batch_norm': False, 'class': 'activation', 'from': 'c4'},
    'c2': {'class': 'conv', 'filter_size': (3, 3), 'from': 'y4', 'n_out': 32, 'padding': 'same',
           'in_spatial_dims': ("stag:conv:s0", "stag:conv:s1"),
           'strides': (3, 1), 'with_bias': True},
    ...
    'source_linear': {'activation': None,
                      'class': 'linear',
                      'forward_weights_init': {'class': 'VarianceScaling', 'distribution': 'uniform',
                                               'mode': 'fan_in', 'scale': 0.78},
    ...
    'conformer_block_01_covmod_1_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_01_covmod_1_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_01_covmod_1_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_01_covmod_1_conv_mod_drop'},
    'conformer_block_01_covmod_1_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_01_covmod_2_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_01_covmod_2_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_01_covmod_2_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_01_covmod_2_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_01_covmod_2_conv_mod_drop'},
    'conformer_block_01_covmod_2_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_01_ffmod_1_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_01_ffmod_1_swish'},
    'conformer_block_01_ffmod_1_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_01_ffmod_1_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_01_ffmod_1_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
    ...
    'conformer_block_01_ffmod_1_res': {'class': 'combine',
                                       'from': ['conformer_block_01_ffmod_1_half_step',
                                                'source_dropout'],
                                       'kind': 'add'},
    'conformer_block_01_ffmod_1_swish': {'activation': 'swish', 'class': 'activation',
                                         'from': 'conformer_block_01_ffmod_1_ff1'},
    'conformer_block_01_ffmod_2_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_01_ffmod_2_swish'},
    'conformer_block_01_ffmod_2_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_01_ffmod_2_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_01_ffmod_2_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                             'from': 'conformer_block_01_ffmod_2_drop2'},
    'conformer_block_01_ffmod_2_ln': {'class': 'layer_norm',
                                      'from': 'conformer_block_01_covmod_2_conv_mod_res'},
    'conformer_block_01_ffmod_2_res': {'class': 'combine',
                                       'from': ['conformer_block_01_ffmod_2_half_step',
                                                'conformer_block_01_covmod_2_conv_mod_res'],
                                       'kind': 'add'},
    'conformer_block_01_ffmod_2_swish': {'activation': 'swish', 'class': 'activation',
    ...
    'conformer_block_01_self_att': {'attention_dropout': 0.1,
                                    ...
                                    'num_heads': 6,
                                    'total_key_dim': 384},
    'conformer_block_01_self_att_dropout': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_01_self_att_linear': {'activation': None,
                                           ...
                                           'out_dim': encoder_out_dim,
                                           'with_bias': False},
    'conformer_block_01_self_att_ln': {'class': 'layer_norm',
                                       'from': 'conformer_block_01_covmod_1_conv_mod_res'},
    ...
    'conformer_block_01_self_att_res': {'class': 'combine',
                                        'from': ['conformer_block_01_self_att_dropout',
    ...
    'conformer_block_02_covmod_1_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_02_covmod_1_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_02_covmod_1_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_02_covmod_1_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_02_covmod_1_conv_mod_drop'},
    'conformer_block_02_covmod_1_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_02_covmod_2_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_02_covmod_2_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_02_covmod_2_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_02_covmod_2_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_02_covmod_2_conv_mod_drop'},
    'conformer_block_02_covmod_2_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_02_ffmod_1_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_02_ffmod_1_swish'},
    'conformer_block_02_ffmod_1_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_02_ffmod_1_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_02_ffmod_1_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
    ...
    'conformer_block_02_ffmod_1_res': {'class': 'combine',
                                       'from': ['conformer_block_02_ffmod_1_half_step',
                                                'conformer_block_01'],
                                       'kind': 'add'},
    'conformer_block_02_ffmod_1_swish': {'activation': 'swish', 'class': 'activation',
                                         'from': 'conformer_block_02_ffmod_1_ff1'},
    'conformer_block_02_ffmod_2_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_02_ffmod_2_swish'},
    'conformer_block_02_ffmod_2_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_02_ffmod_2_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_02_ffmod_2_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                             'from': 'conformer_block_02_ffmod_2_drop2'},
    'conformer_block_02_ffmod_2_ln': {'class': 'layer_norm',
                                      'from': 'conformer_block_02_covmod_2_conv_mod_res'},
    'conformer_block_02_ffmod_2_res': {'class': 'combine',
                                       'from': ['conformer_block_02_ffmod_2_half_step',
                                                'conformer_block_02_covmod_2_conv_mod_res'],
                                       'kind': 'add'},
    'conformer_block_02_ffmod_2_swish': {'activation': 'swish', 'class': 'activation',
    ...
    'conformer_block_02_self_att': {'attention_dropout': 0.1,
                                    ...
                                    'num_heads': 6,
                                    'total_key_dim': 384},
    'conformer_block_02_self_att_dropout': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_02_self_att_linear': {'activation': None,
                                           ...
                                           'out_dim': encoder_out_dim,
                                           'with_bias': False},
    'conformer_block_02_self_att_ln': {'class': 'layer_norm',
                                       'from': 'conformer_block_02_covmod_1_conv_mod_res'},
    ...
    'conformer_block_02_self_att_res': {'class': 'combine',
                                        'from': ['conformer_block_02_self_att_dropout',
    ...
    'conformer_block_03_covmod_1_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_03_covmod_1_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_03_covmod_1_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_03_covmod_1_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_03_covmod_1_conv_mod_drop'},
    'conformer_block_03_covmod_1_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_03_covmod_2_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_03_covmod_2_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_03_covmod_2_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_03_covmod_2_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_03_covmod_2_conv_mod_drop'},
    'conformer_block_03_covmod_2_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_03_ffmod_1_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_03_ffmod_1_swish'},
    'conformer_block_03_ffmod_1_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_03_ffmod_1_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_03_ffmod_1_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
    ...
    'conformer_block_03_ffmod_1_res': {'class': 'combine',
                                       'from': ['conformer_block_03_ffmod_1_half_step',
                                                'conformer_block_02'],
                                       'kind': 'add'},
    'conformer_block_03_ffmod_1_swish': {'activation': 'swish', 'class': 'activation',
                                         'from': 'conformer_block_03_ffmod_1_ff1'},
    'conformer_block_03_ffmod_2_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_03_ffmod_2_swish'},
    'conformer_block_03_ffmod_2_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_03_ffmod_2_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_03_ffmod_2_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                             'from': 'conformer_block_03_ffmod_2_drop2'},
    'conformer_block_03_ffmod_2_ln': {'class': 'layer_norm',
                                      'from': 'conformer_block_03_covmod_2_conv_mod_res'},
    'conformer_block_03_ffmod_2_res': {'class': 'combine',
                                       'from': ['conformer_block_03_ffmod_2_half_step',
                                                'conformer_block_03_covmod_2_conv_mod_res'],
                                       'kind': 'add'},
    'conformer_block_03_ffmod_2_swish': {'activation': 'swish', 'class': 'activation',
    ...
    'conformer_block_03_self_att': {'attention_dropout': 0.1,
                                    ...
                                    'num_heads': 6,
                                    'total_key_dim': 384},
    'conformer_block_03_self_att_dropout': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_03_self_att_linear': {'activation': None,
                                           ...
                                           'out_dim': encoder_out_dim,
                                           'with_bias': False},
    'conformer_block_03_self_att_ln': {'class': 'layer_norm',
                                       'from': 'conformer_block_03_covmod_1_conv_mod_res'},
    ...
    'conformer_block_03_self_att_res': {'class': 'combine',
                                        'from': ['conformer_block_03_self_att_dropout',
    ...
    'conformer_block_04_covmod_1_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_04_covmod_1_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_04_covmod_1_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_04_covmod_1_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_04_covmod_1_conv_mod_drop'},
    'conformer_block_04_covmod_1_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_04_covmod_2_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_04_covmod_2_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_04_covmod_2_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_04_covmod_2_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_04_covmod_2_conv_mod_drop'},
    'conformer_block_04_covmod_2_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_04_ffmod_1_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_04_ffmod_1_swish'},
    'conformer_block_04_ffmod_1_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_04_ffmod_1_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_04_ffmod_1_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
    ...
    'conformer_block_04_ffmod_1_res': {'class': 'combine',
                                       'from': ['conformer_block_04_ffmod_1_half_step',
                                                'conformer_block_03'],
                                       'kind': 'add'},
    'conformer_block_04_ffmod_1_swish': {'activation': 'swish', 'class': 'activation',
                                         'from': 'conformer_block_04_ffmod_1_ff1'},
    'conformer_block_04_ffmod_2_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_04_ffmod_2_swish'},
    'conformer_block_04_ffmod_2_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_04_ffmod_2_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_04_ffmod_2_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                             'from': 'conformer_block_04_ffmod_2_drop2'},
    'conformer_block_04_ffmod_2_ln': {'class': 'layer_norm',
                                      'from': 'conformer_block_04_covmod_2_conv_mod_res'},
    'conformer_block_04_ffmod_2_res': {'class': 'combine',
                                       'from': ['conformer_block_04_ffmod_2_half_step',
                                                'conformer_block_04_covmod_2_conv_mod_res'],
                                       'kind': 'add'},
    'conformer_block_04_ffmod_2_swish': {'activation': 'swish', 'class': 'activation',
    ...
    'conformer_block_04_self_att': {'attention_dropout': 0.1,
                                    ...
                                    'num_heads': 6,
                                    'total_key_dim': 384},
    'conformer_block_04_self_att_dropout': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_04_self_att_linear': {'activation': None,
                                           ...
                                           'out_dim': encoder_out_dim,
                                           'with_bias': False},
    'conformer_block_04_self_att_ln': {'class': 'layer_norm',
                                       'from': 'conformer_block_04_covmod_1_conv_mod_res'},
    ...
    'conformer_block_04_self_att_res': {'class': 'combine',
                                        'from': ['conformer_block_04_self_att_dropout',
    ...
    'conformer_block_05_covmod_1_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_05_covmod_1_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_05_covmod_1_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_05_covmod_1_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_05_covmod_1_conv_mod_drop'},
    'conformer_block_05_covmod_1_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_05_covmod_2_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_05_covmod_2_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_05_covmod_2_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_05_covmod_2_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_05_covmod_2_conv_mod_drop'},
    'conformer_block_05_covmod_2_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_05_ffmod_1_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_05_ffmod_1_swish'},
    'conformer_block_05_ffmod_1_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_05_ffmod_1_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_05_ffmod_1_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
    ...
    'conformer_block_05_ffmod_1_res': {'class': 'combine',
                                       'from': ['conformer_block_05_ffmod_1_half_step',
                                                'conformer_block_04'],
                                       'kind': 'add'},
    'conformer_block_05_ffmod_1_swish': {'activation': 'swish', 'class': 'activation',
                                         'from': 'conformer_block_05_ffmod_1_ff1'},
    'conformer_block_05_ffmod_2_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_05_ffmod_2_swish'},
    'conformer_block_05_ffmod_2_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_05_ffmod_2_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_05_ffmod_2_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                             'from': 'conformer_block_05_ffmod_2_drop2'},
    'conformer_block_05_ffmod_2_ln': {'class': 'layer_norm',
                                      'from': 'conformer_block_05_covmod_2_conv_mod_res'},
    'conformer_block_05_ffmod_2_res': {'class': 'combine',
                                       'from': ['conformer_block_05_ffmod_2_half_step',
                                                'conformer_block_05_covmod_2_conv_mod_res'],
                                       'kind': 'add'},
    'conformer_block_05_ffmod_2_swish': {'activation': 'swish', 'class': 'activation',
    ...
    'conformer_block_05_self_att': {'attention_dropout': 0.1,
                                    ...
                                    'num_heads': 6,
                                    'total_key_dim': 384},
    'conformer_block_05_self_att_dropout': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_05_self_att_linear': {'activation': None,
                                           ...
                                           'out_dim': encoder_out_dim,
                                           'with_bias': False},
    'conformer_block_05_self_att_ln': {'class': 'layer_norm',
                                       'from': 'conformer_block_05_covmod_1_conv_mod_res'},
    ...
    'conformer_block_05_self_att_res': {'class': 'combine',
                                        'from': ['conformer_block_05_self_att_dropout',
    ...
    'conformer_block_06_covmod_1_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_06_covmod_1_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_06_covmod_1_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_06_covmod_1_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_06_covmod_1_conv_mod_drop'},
    'conformer_block_06_covmod_1_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_06_covmod_2_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_06_covmod_2_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_06_covmod_2_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_06_covmod_2_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_06_covmod_2_conv_mod_drop'},
    'conformer_block_06_covmod_2_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_06_ffmod_1_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_06_ffmod_1_swish'},
    'conformer_block_06_ffmod_1_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_06_ffmod_1_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_06_ffmod_1_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
    ...
    'conformer_block_06_ffmod_1_res': {'class': 'combine',
                                       'from': ['conformer_block_06_ffmod_1_half_step',
                                                'conformer_block_05'],
                                       'kind': 'add'},
    'conformer_block_06_ffmod_1_swish': {'activation': 'swish', 'class': 'activation',
                                         'from': 'conformer_block_06_ffmod_1_ff1'},
    'conformer_block_06_ffmod_2_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_06_ffmod_2_swish'},
    'conformer_block_06_ffmod_2_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_06_ffmod_2_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_06_ffmod_2_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                             'from': 'conformer_block_06_ffmod_2_drop2'},
    'conformer_block_06_ffmod_2_ln': {'class': 'layer_norm',
                                      'from': 'conformer_block_06_covmod_2_conv_mod_res'},
    'conformer_block_06_ffmod_2_res': {'class': 'combine',
                                       'from': ['conformer_block_06_ffmod_2_half_step',
                                                'conformer_block_06_covmod_2_conv_mod_res'],
                                       'kind': 'add'},
    'conformer_block_06_ffmod_2_swish': {'activation': 'swish', 'class': 'activation',
    ...
    'conformer_block_06_self_att': {'attention_dropout': 0.1,
                                    ...
                                    'num_heads': 6,
                                    'total_key_dim': 384},
    'conformer_block_06_self_att_dropout': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_06_self_att_linear': {'activation': None,
                                           ...
                                           'out_dim': encoder_out_dim,
                                           'with_bias': False},
    'conformer_block_06_self_att_ln': {'class': 'layer_norm',
                                       'from': 'conformer_block_06_covmod_1_conv_mod_res'},
    ...
    'conformer_block_06_self_att_res': {'class': 'combine',
                                        'from': ['conformer_block_06_self_att_dropout',
    ...
    'conformer_block_07_covmod_1_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_07_covmod_1_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_07_covmod_1_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_07_covmod_1_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_07_covmod_1_conv_mod_drop'},
    'conformer_block_07_covmod_1_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_07_covmod_2_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_07_covmod_2_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_07_covmod_2_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_07_covmod_2_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_07_covmod_2_conv_mod_drop'},
    'conformer_block_07_covmod_2_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_07_ffmod_1_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_07_ffmod_1_swish'},
    'conformer_block_07_ffmod_1_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_07_ffmod_1_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_07_ffmod_1_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
    ...
    'conformer_block_07_ffmod_1_res': {'class': 'combine',
                                       'from': ['conformer_block_07_ffmod_1_half_step',
                                                'conformer_block_06'],
                                       'kind': 'add'},
    'conformer_block_07_ffmod_1_swish': {'activation': 'swish', 'class': 'activation',
                                         'from': 'conformer_block_07_ffmod_1_ff1'},
    'conformer_block_07_ffmod_2_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_07_ffmod_2_swish'},
    'conformer_block_07_ffmod_2_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_07_ffmod_2_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_07_ffmod_2_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                             'from': 'conformer_block_07_ffmod_2_drop2'},
    'conformer_block_07_ffmod_2_ln': {'class': 'layer_norm',
                                      'from': 'conformer_block_07_covmod_2_conv_mod_res'},
    'conformer_block_07_ffmod_2_res': {'class': 'combine',
                                       'from': ['conformer_block_07_ffmod_2_half_step',
                                                'conformer_block_07_covmod_2_conv_mod_res'],
                                       'kind': 'add'},
    'conformer_block_07_ffmod_2_swish': {'activation': 'swish', 'class': 'activation',
    ...
    'conformer_block_07_self_att': {'attention_dropout': 0.1,
                                    ...
                                    'num_heads': 6,
                                    'total_key_dim': 384},
    'conformer_block_07_self_att_dropout': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_07_self_att_linear': {'activation': None,
                                           ...
                                           'out_dim': encoder_out_dim,
                                           'with_bias': False},
    'conformer_block_07_self_att_ln': {'class': 'layer_norm',
                                       'from': 'conformer_block_07_covmod_1_conv_mod_res'},
    ...
    'conformer_block_07_self_att_res': {'class': 'combine',
                                        'from': ['conformer_block_07_self_att_dropout',
    ...
    'conformer_block_08_covmod_1_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_08_covmod_1_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_08_covmod_1_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_08_covmod_1_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_08_covmod_1_conv_mod_drop'},
    'conformer_block_08_covmod_1_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_08_covmod_2_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_08_covmod_2_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_08_covmod_2_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_08_covmod_2_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_08_covmod_2_conv_mod_drop'},
    'conformer_block_08_covmod_2_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_08_ffmod_1_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_08_ffmod_1_swish'},
    'conformer_block_08_ffmod_1_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_08_ffmod_1_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_08_ffmod_1_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
    ...
    'conformer_block_08_ffmod_1_res': {'class': 'combine',
                                       'from': ['conformer_block_08_ffmod_1_half_step',
                                                'conformer_block_07'],
                                       'kind': 'add'},
    'conformer_block_08_ffmod_1_swish': {'activation': 'swish', 'class': 'activation',
                                         'from': 'conformer_block_08_ffmod_1_ff1'},
    'conformer_block_08_ffmod_2_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_08_ffmod_2_swish'},
    'conformer_block_08_ffmod_2_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_08_ffmod_2_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_08_ffmod_2_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                             'from': 'conformer_block_08_ffmod_2_drop2'},
    'conformer_block_08_ffmod_2_ln': {'class': 'layer_norm',
                                      'from': 'conformer_block_08_covmod_2_conv_mod_res'},
    'conformer_block_08_ffmod_2_res': {'class': 'combine',
                                       'from': ['conformer_block_08_ffmod_2_half_step',
                                                'conformer_block_08_covmod_2_conv_mod_res'],
                                       'kind': 'add'},
    'conformer_block_08_ffmod_2_swish': {'activation': 'swish', 'class': 'activation',
    ...
    'conformer_block_08_self_att': {'attention_dropout': 0.1,
                                    ...
                                    'num_heads': 6,
                                    'total_key_dim': 384},
    'conformer_block_08_self_att_dropout': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_08_self_att_linear': {'activation': None,
                                           ...
                                           'out_dim': encoder_out_dim,
                                           'with_bias': False},
    'conformer_block_08_self_att_ln': {'class': 'layer_norm',
                                       'from': 'conformer_block_08_covmod_1_conv_mod_res'},
    ...
    'conformer_block_08_self_att_res': {'class': 'combine',
                                        'from': ['conformer_block_08_self_att_dropout',
    ...
    'conformer_block_09_covmod_1_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_09_covmod_1_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_09_covmod_1_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_09_covmod_1_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_09_covmod_1_conv_mod_drop'},
    'conformer_block_09_covmod_1_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_09_covmod_2_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_09_covmod_2_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_09_covmod_2_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_09_covmod_2_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_09_covmod_2_conv_mod_drop'},
    'conformer_block_09_covmod_2_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_09_ffmod_1_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_09_ffmod_1_swish'},
    'conformer_block_09_ffmod_1_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_09_ffmod_1_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_09_ffmod_1_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
    ...
    'conformer_block_09_ffmod_1_res': {'class': 'combine',
                                       'from': ['conformer_block_09_ffmod_1_half_step',
                                                'conformer_block_08'],
                                       'kind': 'add'},
    'conformer_block_09_ffmod_1_swish': {'activation': 'swish', 'class': 'activation',
                                         'from': 'conformer_block_09_ffmod_1_ff1'},
    'conformer_block_09_ffmod_2_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_09_ffmod_2_swish'},
    'conformer_block_09_ffmod_2_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_09_ffmod_2_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_09_ffmod_2_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                             'from': 'conformer_block_09_ffmod_2_drop2'},
    'conformer_block_09_ffmod_2_ln': {'class': 'layer_norm',
                                      'from': 'conformer_block_09_covmod_2_conv_mod_res'},
    'conformer_block_09_ffmod_2_res': {'class': 'combine',
                                       'from': ['conformer_block_09_ffmod_2_half_step',
                                                'conformer_block_09_covmod_2_conv_mod_res'],
                                       'kind': 'add'},
    'conformer_block_09_ffmod_2_swish': {'activation': 'swish', 'class': 'activation',
    ...
    'conformer_block_09_self_att': {'attention_dropout': 0.1,
                                    ...
                                    'num_heads': 6,
                                    'total_key_dim': 384},
    'conformer_block_09_self_att_dropout': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_09_self_att_linear': {'activation': None,
                                           ...
                                           'out_dim': encoder_out_dim,
                                           'with_bias': False},
    'conformer_block_09_self_att_ln': {'class': 'layer_norm',
                                       'from': 'conformer_block_09_covmod_1_conv_mod_res'},
    ...
    'conformer_block_09_self_att_res': {'class': 'combine',
                                        'from': ['conformer_block_09_self_att_dropout',
    ...
    'conformer_block_10_covmod_1_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_10_covmod_1_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_10_covmod_1_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_10_covmod_1_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_10_covmod_1_conv_mod_drop'},
    'conformer_block_10_covmod_1_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_10_covmod_2_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_10_covmod_2_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_10_covmod_2_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_10_covmod_2_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_10_covmod_2_conv_mod_drop'},
    'conformer_block_10_covmod_2_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_10_ffmod_1_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_10_ffmod_1_swish'},
    'conformer_block_10_ffmod_1_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_10_ffmod_1_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_10_ffmod_1_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
    ...
    'conformer_block_10_ffmod_1_res': {'class': 'combine',
                                       'from': ['conformer_block_10_ffmod_1_half_step',
                                                'conformer_block_09'],
                                       'kind': 'add'},
    'conformer_block_10_ffmod_1_swish': {'activation': 'swish', 'class': 'activation',
                                         'from': 'conformer_block_10_ffmod_1_ff1'},
    'conformer_block_10_ffmod_2_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_10_ffmod_2_swish'},
    'conformer_block_10_ffmod_2_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_10_ffmod_2_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_10_ffmod_2_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                             'from': 'conformer_block_10_ffmod_2_drop2'},
    'conformer_block_10_ffmod_2_ln': {'class': 'layer_norm',
                                      'from': 'conformer_block_10_covmod_2_conv_mod_res'},
    'conformer_block_10_ffmod_2_res': {'class': 'combine',
                                       'from': ['conformer_block_10_ffmod_2_half_step',
                                                'conformer_block_10_covmod_2_conv_mod_res'],
                                       'kind': 'add'},
    'conformer_block_10_ffmod_2_swish': {'activation': 'swish', 'class': 'activation',
    ...
    'conformer_block_10_self_att': {'attention_dropout': 0.1,
                                    ...
                                    'num_heads': 6,
                                    'total_key_dim': 384},
    'conformer_block_10_self_att_dropout': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_10_self_att_linear': {'activation': None,
                                           ...
                                           'out_dim': encoder_out_dim,
                                           'with_bias': False},
    'conformer_block_10_self_att_ln': {'class': 'layer_norm',
                                       'from': 'conformer_block_10_covmod_1_conv_mod_res'},
    ...
    'conformer_block_10_self_att_res': {'class': 'combine',
                                        'from': ['conformer_block_10_self_att_dropout',
    ...
    'conformer_block_11_covmod_1_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_11_covmod_1_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_11_covmod_1_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_11_covmod_1_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_11_covmod_1_conv_mod_drop'},
    'conformer_block_11_covmod_1_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_11_covmod_2_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_11_covmod_2_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_11_covmod_2_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_11_covmod_2_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_11_covmod_2_conv_mod_drop'},
    'conformer_block_11_covmod_2_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_11_ffmod_1_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_11_ffmod_1_swish'},
    'conformer_block_11_ffmod_1_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_11_ffmod_1_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_11_ffmod_1_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
    ...
    'conformer_block_11_ffmod_1_res': {'class': 'combine',
                                       'from': ['conformer_block_11_ffmod_1_half_step',
                                                'conformer_block_10'],
                                       'kind': 'add'},
    'conformer_block_11_ffmod_1_swish': {'activation': 'swish', 'class': 'activation',
                                         'from': 'conformer_block_11_ffmod_1_ff1'},
    'conformer_block_11_ffmod_2_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_11_ffmod_2_swish'},
    'conformer_block_11_ffmod_2_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_11_ffmod_2_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_11_ffmod_2_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                             'from': 'conformer_block_11_ffmod_2_drop2'},
    'conformer_block_11_ffmod_2_ln': {'class': 'layer_norm',
                                      'from': 'conformer_block_11_covmod_2_conv_mod_res'},
    'conformer_block_11_ffmod_2_res': {'class': 'combine',
                                       'from': ['conformer_block_11_ffmod_2_half_step',
                                                'conformer_block_11_covmod_2_conv_mod_res'],
                                       'kind': 'add'},
    'conformer_block_11_ffmod_2_swish': {'activation': 'swish', 'class': 'activation',
    ...
    'conformer_block_11_self_att': {'attention_dropout': 0.1,
                                    ...
                                    'num_heads': 6,
                                    'total_key_dim': 384},
    'conformer_block_11_self_att_dropout': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_11_self_att_linear': {'activation': None,
                                           ...
                                           'out_dim': encoder_out_dim,
                                           'with_bias': False},
    'conformer_block_11_self_att_ln': {'class': 'layer_norm',
                                       'from': 'conformer_block_11_covmod_1_conv_mod_res'},
    ...
    'conformer_block_11_self_att_res': {'class': 'combine',
                                        'from': ['conformer_block_11_self_att_dropout',
    ...
    'conformer_block_12_covmod_1_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_12_covmod_1_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_12_covmod_1_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_12_covmod_1_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_12_covmod_1_conv_mod_drop'},
    'conformer_block_12_covmod_1_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_12_covmod_2_conv_mod_depthwise_conv2': {'activation': None,
                                                             ...
                                                             'padding': 'same',
                                                             'with_bias': True},
    'conformer_block_12_covmod_2_conv_mod_drop': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_12_covmod_2_conv_mod_glu': {'activation': 'identity',
                                                 ...
                                                 'gate_activation': 'sigmoid'},
    'conformer_block_12_covmod_2_conv_mod_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                                       'from': 'conformer_block_12_covmod_2_conv_mod_drop'},
    'conformer_block_12_covmod_2_conv_mod_ln': {'class': 'layer_norm',
    ...
    'conformer_block_12_ffmod_1_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_12_ffmod_1_swish'},
    'conformer_block_12_ffmod_1_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_12_ffmod_1_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_12_ffmod_1_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
    ...
    'conformer_block_12_ffmod_1_res': {'class': 'combine',
                                       'from': ['conformer_block_12_ffmod_1_half_step',
                                                'conformer_block_11'],
                                       'kind': 'add'},
    'conformer_block_12_ffmod_1_swish': {'activation': 'swish', 'class': 'activation',
                                         'from': 'conformer_block_12_ffmod_1_ff1'},
    'conformer_block_12_ffmod_2_drop1': {'class': 'dropout', 'dropout': 0.1,
                                         'from': 'conformer_block_12_ffmod_2_swish'},
    'conformer_block_12_ffmod_2_drop2': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_12_ffmod_2_ff2': {'activation': None,
                                       ...
                                       'out_dim': encoder_out_dim,
                                       'with_bias': True},
    'conformer_block_12_ffmod_2_half_step': {'class': 'eval', 'eval': '0.5 * source(0)',
                                             'from': 'conformer_block_12_ffmod_2_drop2'},
    'conformer_block_12_ffmod_2_ln': {'class': 'layer_norm',
                                      'from': 'conformer_block_12_covmod_2_conv_mod_res'},
    'conformer_block_12_ffmod_2_res': {'class': 'combine',
                                       'from': ['conformer_block_12_ffmod_2_half_step',
                                                'conformer_block_12_covmod_2_conv_mod_res'],
                                       'kind': 'add'},
    'conformer_block_12_ffmod_2_swish': {'activation': 'swish', 'class': 'activation',
    ...
    'conformer_block_12_self_att': {'attention_dropout': 0.1,
                                    ...
                                    'num_heads': 6,
                                    'total_key_dim': 384},
    'conformer_block_12_self_att_dropout': {'class': 'dropout', 'dropout': 0.1,
    ...
    'conformer_block_12_self_att_linear': {'activation': None,
                                           ...
                                           'out_dim': encoder_out_dim,
                                           'with_bias': False},
    'conformer_block_12_self_att_ln': {'class': 'layer_norm',
                                       'from': 'conformer_block_12_covmod_1_conv_mod_res'},
    ...
    'conformer_block_12_self_att_res': {'class': 'combine',
                                        'from': ['conformer_block_12_self_att_dropout',
