...
# Best results: {'best_scores': {'hub5e_00': 24.2, 'hub5e_01': 17.5, 'rt03s': 23.6}, 'best_epoch': 146}
_exclude_me = True
...
def from_scratch_training(
    *, model: Model, data: nn.Tensor, data_spatial_dim: nn.Dim, targets: nn.Tensor, targets_spatial_dim: nn.Dim
    ...
    out_log_prob = nn.label_smoothed_log_prob_gradient(
        out_log_prob, 0.1 * min(model.epoch / 60.0, 1.0), exclude_labels=[model.blank_idx]
    )
