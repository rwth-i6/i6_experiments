...
# Best results: {'best_scores': {'hub5e_00': 26.1, 'hub5e_01': 18.9, 'rt03s': 24.4}, 'best_epoch': 150}
_exclude_me = True
    ...
    def decode(
        ...
        *,
        ...
        if all_combinations_out:
            ...
            lm_input = nn.switchout(lm_input, switchout_prob=0.5)
        else:
...
class DecoderLabelSync(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.lstm = nn.ZoneoutLSTM(self.embed.out_dim, lstm_dim, zoneout_factor_cell=0.15, zoneout_factor_output=0.05)
