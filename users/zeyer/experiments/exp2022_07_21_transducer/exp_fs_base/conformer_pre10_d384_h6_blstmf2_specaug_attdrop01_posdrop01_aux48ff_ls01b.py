...
# Best results: {'best_scores': {'hub5e_00': 28.5, 'hub5e_01': 23.6, 'rt03s': 29.1}, 'best_epoch': 149}
_exclude_me = True
...
def from_scratch_training(
    *, model: Model, data: nn.Tensor, data_spatial_dim: nn.Dim, targets: nn.Tensor, targets_spatial_dim: nn.Dim
    ...
    out_log_prob = nn.label_smoothed_log_prob_gradient(out_log_prob, 0.1 * min(model.epoch / 60.0, 1.0))
