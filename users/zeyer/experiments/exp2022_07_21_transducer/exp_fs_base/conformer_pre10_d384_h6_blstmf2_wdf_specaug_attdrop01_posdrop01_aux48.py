...
# Best results: {'best_scores': {'hub5e_00': 21.0, 'hub5e_01': 15.8, 'rt03s': 20.5}, 'best_epoch': 149}
_exclude_me = True
...
class Model(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        for mod in list(self.encoder.modules()) + list(self.enc_ctx.modules()):
            if isinstance(mod, nn.LSTM):
                mod.param_W_re.weight_decay = l2
                mod.param_W.weight_decay = l2
            elif isinstance(mod, nn.Linear):
                mod.weight.weight_decay = l2
