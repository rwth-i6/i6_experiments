...
# Best results: {'best_scores': {'hub5e_00': 21.1, 'hub5e_01': 15.3, 'rt03s': 19.7}, 'best_epoch': 150}
_exclude_me = True
...
class ProbsFromReadout:
    ...
    def get_wb_label_log_probs(self) -> nn.Tensor:
        ...
        label_log_prob = nn.label_smoothed_log_prob_gradient(label_log_prob, 0.1 * min(self.model.epoch / 60.0, 1.0))
