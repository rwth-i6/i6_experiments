...
# Best results: {'best_scores': {'hub5e_00': 23.6, 'hub5e_01': 19.2, 'rt03s': 23.7}, 'best_epoch': 142}
_exclude_me = True
...
config = dict(
    ...
    learning_rates=(
        ...
        list(numpy.linspace(0.0000001, 0.003, num=10)) * 3
        + list(numpy.linspace(0.0000001, 0.003, num=30))
    ),
