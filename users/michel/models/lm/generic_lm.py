...
libri_decoder_like_willi_net = {
  "input": {"class": "linear", "n_out": 128, "activation": "identity", "trainable": False},
  "lstm0": {"class": "rnn_cell", "unit": "LSTMBlock", "n_out": 1000,
            "unit_opts": {"forget_bias": 0.0}, "from": ["input"], "trainable": False},
  "output": {"class": "linear", "from": ["lstm0"], "activation": "identity",
              "use_transposed_weights": False, "n_out": 10025, "trainable": False}
}
libri_decoder_like_willi_model = "/work/asr4/michel/setups-data/language_modelling/librispeech/neurallm/decoder_sized_transcripts_only/net-model/network.007"

ted2_decoder_like_willi_net = {
  "input": {"class": "linear", "n_out": 128, "activation": "identity", "trainable": False},
  "lstm0": {"class": "rnn_cell", "unit": "LSTMBlock", "n_out": 1000,
            "unit_opts": {"forget_bias": 0.0}, "from": ["input"], "trainable": False},
  "output": {"class": "linear", "from": ["lstm0"], "activation": "identity",
              "use_transposed_weights": False, "n_out": 1057, "trainable": False}
}
ted2_decoder_like_willi_model = "/work/asr4/michel/setups-data/language_modelling/tedlium/neurallm/decoder_sized_transcripts_only/net-model/network.005"
