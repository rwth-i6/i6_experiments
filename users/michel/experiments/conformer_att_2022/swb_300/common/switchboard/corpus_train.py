...
def get_spoken_form_train_bliss_corpus_ldc_ogg(
    ...
    ogg_zip_job = BlissToOggZipJob(
        get_spoken_form_train_bliss_corpus_ldc(output_prefix),
        returnn_python_exe=returnn_python_exe,
        returnn_root=returnn_root,
    )
    ogg_zip_job.add_alias(os.path.join(output_prefix, "Switchboard", "train_ogg_zip_job"))
