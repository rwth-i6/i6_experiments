...
def k_means_clustering(
    ...
    **kwargs,
    ...
    for i, exp in enumerate(experiments):
        ...
        tk.register_output(f"clusters-{exp}.pt", returnn_fwd_job.out_files[centroid_file])
    return returnn_fwd_job.out_files[centroid_file]
...
def _returnn_v2_get_model_usp(*, epoch: int, **_kwargs_unused):
    from returnn.tensor import Tensor
    from returnn.config import get_global_config
