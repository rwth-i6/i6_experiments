...
from i6_experiments.users.mann.external.unsupervised.clustering import k_means_clustering
...
def py():
    ...
    train_version = 2                           # Version for training added to change the hash
...
def train_exp(
    ...
    *,
    ...
    tk.register_output(prefix + "/centroids/w2v_large.pt", centroids)
    return None
    ...
    for i in range(self_training_rounds):
        ...
        # config_self["__mem_rqmt"] = 30
        
        model_with_checkpoint.append(k_means_clustering(
...
_sis_prefix: Optional[str] = "clustering"
...
w2v_model_def: ModelDef[Model]
w2v_model_def.behavior_version = 0
w2v_model_def.backend = "torch"
