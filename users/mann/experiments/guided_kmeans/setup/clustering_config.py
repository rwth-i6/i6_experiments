...
from i6_experiments.users.mann.lib.guided_kmeans.clustering import (
...
class ClusteringCallbackConfig:
    ...
    # pool_function: str = "maxpool_time_np"
...
def get_clustering_call_config(
    ...
    return ReturnnConfig(
        config={},
        python_epilog=Collection([initializer, clustering_callback]), # pyright: ignore[reportArgumentType]
    )
