__all__ = ["InstallMinicondaJob", "CreateCondaExeJob", "CreateCondaEnvJob", "CondaEnvArgs", "ActivateCondaEnvJob"]
...
class CreateCondaExeJob(Job):
    """
    Create a conda_exe.sh script. Similar as InstallMinicondaJob
    """

    def __init__(self, conda_dir: tk.Path):
