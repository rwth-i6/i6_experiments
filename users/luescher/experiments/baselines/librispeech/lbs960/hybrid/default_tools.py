...
RETURNN_DATA_ROOT = CloneGitRepositoryJob(
    "https://github.com/rwth-i6/returnn",
    commit="37ba06ab2697e7af4de96037565fdf4f78acdb80",
).out_repository

RETURNN_RC_ROOT = CloneGitRepositoryJob(
    "https://github.com/rwth-i6/returnn",
    commit="4bfcc86c07095faacd6d5650347825c523a29a0f",
).out_repository
...
RETURNN_COMMON = CloneGitRepositoryJob(
    ...
    commit="e3083fac1899bb764710ca46ff9257247e4e6b14",
