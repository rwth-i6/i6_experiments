...
def get_basic_pt_network_serializer(
    ...
    first_import_serializer_objects: Optional[list] = None,
    ...
    if first_import_serializer_objects is not None:
        for obj in first_import_serializer_objects:
            serializer_objects.insert(0, obj)
