...
def returnn_config_generator(num_subepochs:int, train_data_config: dict, dev_data_config: dict, peak_lr: float) -> dict:
    ...
    dict_recog_component_dist = {
        "double_prune_total_num_components_192_adjust_dropout_True_adapt_epochs_60_pct_0.05_iters_1_0.0004_freq_max_num_mask_16":
            {'ff1': [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [4, 4, 4, 4, 4, 4, 4, 4, 6, 8, 6, 4],
             'mhsa': [4, 4, 4, 4, 4, 4, 4, 0, 0, 0, 2, 0], 'ff2': [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4]},
        "double_prune_total_num_components_192_adjust_dropout_True_adapt_epochs_60_pct_0.1_iters_1_0.0004_freq_max_num_mask_16":
            {'ff1': [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [4, 4, 4, 4, 4, 4, 4, 6, 8, 8, 8, 6],
             'mhsa': [4, 4, 4, 4, 4, 3, 4, 0, 0, 1, 0, 0], 'ff2': [4, 4, 4, 4, 2, 1, 1, 4, 4, 4, 4, 4]},
        "double_prune_total_num_components_192_adjust_dropout_True_adapt_epochs_60_pct_0.15_iters_1_0.0004_freq_max_num_mask_16":
            {'ff1': [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [4, 4, 4, 4, 4, 5, 7, 8, 8, 8, 8, 8],
             'mhsa': [4, 4, 4, 4, 4, 1, 1, 0, 0, 0, 0, 0], 'ff2': [0, 4, 4, 4, 2, 0, 0, 4, 4, 4, 4, 4]},
        "double_prune_total_num_components_192_adjust_dropout_True_adapt_epochs_60_pct_0.2_iters_1_0.0004_freq_max_num_mask_16":
            {'ff1': [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [4, 4, 4, 5, 6, 8, 8, 8, 8, 8, 8, 8],
             'mhsa': [4, 4, 4, 4, 3, 0, 0, 0, 0, 0, 0, 0], 'ff2': [4, 4, 4, 3, 0, 0, 0, 0, 2, 4, 4, 2]},
        "double_prune_total_num_components_192_adjust_dropout_True_adapt_epochs_60_pct_0.25_iters_1_0.0004_freq_max_num_mask_16":
            {'ff1': [4, 6, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [3, 4, 4, 8, 8, 8, 8, 8, 8, 8, 8, 8],
             'mhsa': [4, 4, 4, 4, 0, 0, 0, 0, 0, 0, 0, 0], 'ff2': [0, 4, 4, 0, 0, 0, 0, 0, 1, 4, 4, 4]},
        "double_prune_total_num_components_192_adjust_dropout_True_adapt_epochs_60_pct_0.15_iters_1_0.0004_freq_max_num_mask_8":
            {'ff1': [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [4, 4, 4, 4, 4, 6, 7, 8, 8, 8, 8, 6],
             'mhsa': [4, 4, 4, 4, 4, 2, 1, 0, 0, 0, 0, 0], 'ff2': [1, 4, 4, 4, 3, 0, 0, 2, 4, 4, 4, 4]},
        "double_prune_total_num_components_192_adjust_dropout_True_adapt_epochs_60_pct_0.2_iters_1_0.0004_freq_max_num_mask_8":
            {'ff1': [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [4, 4, 4, 4, 7, 8, 8, 8, 8, 8, 8, 8],
             'mhsa': [4, 4, 4, 4, 0, 0, 1, 0, 0, 0, 0, 0], 'ff2': [0, 4, 4, 3, 0, 0, 0, 1, 4, 4, 4, 4]},
    }
                                ...
                                for num_chunks in [4]:
                                    for freq_max_num_masks in [16]:
                                        ...
                                        network_args = {"specaug_args": {"time_min_num_masks": 2,
                                                        ...
                                                        "lst_cmp_cost": ([526080//num_chunks] * num_chunks + [618240//num_chunks] * num_chunks + [65920] * 4 + [526080//num_chunks] * num_chunks) * 12}
                                        ...
                                        adaptation_opts = {
                                            ...
                                            "dict_module_cost": {
                                                "ff1": 526080//num_chunks,
                                                "cgmlp": 618240//num_chunks,
                                                "mhsa": 65920,
                                                "ff2": 526080//num_chunks,
                                            }
                                        }
                                        ...
                                        lst_ff1_h_dims = [i * ((256*4) // num_chunks) for i in
                                                          recog_component_dist["ff1"]]
                                        lst_ff2_h_dims = [i * ((256*4) // num_chunks) for i in
                                                          recog_component_dist["ff2"]]
                                        lst_channels = [i * ((256*6) // num_chunks) for i in recog_component_dist["cgmlp"]]
