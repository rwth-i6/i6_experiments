...
def returnn_config_generator(num_subepochs:int, train_data_config: dict, dev_data_config: dict, peak_lr: float) -> dict:
    ...
    dict_recog_component_dist = {
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.1_iters_1_0.0004":
            {'ff1': [4, 5, 4, 4, 4, 4, 4, 4, 4, 4, 5, 4], 'ff2': [4, 4, 4, 0, 0, 4, 4, 4, 4, 4, 4, 1],
             'conv': [2, 3, 6, 6, 6, 6, 7, 8, 8, 8, 8, 8], 'mhsa': [6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 0]},

        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.15_iters_1_0.0004":
            {'ff1': [4, 5, 4, 4, 4, 3, 4, 4, 4, 4, 8, 8], 'ff2': [2, 4, 4, 0, 0, 0, 3, 4, 4, 4, 4, 4],
             'conv': [2, 3, 6, 6, 6, 6, 6, 8, 8, 8, 8, 8], 'mhsa': [6, 7, 6, 6, 2, 4, 6, 6, 6, 6, 6, 0]},
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.15_iters_2_0.0004":
            {'ff1': [1, 4, 4, 4, 4, 4, 4, 4, 4, 4, 8, 4], 'ff2': [1, 4, 4, 0, 0, 1, 4, 4, 4, 4, 4, 4],
             'conv': [3, 4, 4, 5, 5, 6, 7, 8, 10, 10, 10, 7], 'mhsa': [12, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 0]},
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.15_iters_4_0.0004":
            {'ff1': [5, 4, 4, 4, 4, 4, 4, 4, 4, 4, 5, 4], 'ff2': [4, 1, 0, 0, 0, 4, 4, 4, 4, 4, 4, 3],
             'conv': [3, 5, 2, 7, 5, 4, 6, 6, 8, 12, 10, 9], 'mhsa': [12, 7, 9, 6, 6, 6, 6, 6, 6, 6, 6, 0]},
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.15_iters_8_0.0004":
            {'ff1': [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'ff2': [4, 4, 4, 4, 2, 0, 0, 2, 4, 4, 4, 4],
             'conv': [2, 6, 7, 4, 5, 3, 6, 6, 7, 7, 8, 8], 'mhsa': [11, 11, 6, 6, 6, 6, 6, 6, 6, 6, 6, 4]},
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.15_iters_16_0.0004":
            {'ff1': [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'ff2': [4, 2, 0, 3, 4, 0, 4, 0, 4, 4, 4, 4],
             'conv': [2, 6, 5, 6, 6, 3, 7, 6, 7, 8, 7, 11], 'mhsa': [14, 6, 6, 7, 6, 6, 6, 6, 6, 6, 6, 4]},
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_30_pct_0.15_iters_1_0.0004":
            {'ff1': [8, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'ff2': [7, 4, 0, 0, 0, 0, 0, 3, 4, 4, 4, 4],
             'conv': [6, 6, 6, 6, 6, 6, 6, 6, 8, 8, 8, 6], 'mhsa': [12, 7, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6]},
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_90_pct_0.15_iters_1_0.0004":
            {'ff1': [1, 8, 5, 4, 4, 4, 4, 4, 4, 5, 8, 4], 'ff2': [0, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 0],
             'conv': [1, 6, 6, 6, 6, 6, 6, 7, 8, 8, 8, 6], 'mhsa': [6, 6, 6, 6, 2, 0, 0, 0, 6, 6, 6, 0]},
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_150_pct_0.15_iters_1_0.0004":
            {'ff1': [0, 4, 4, 4, 4, 4, 4, 4, 4, 7, 8, 8], 'ff2': [2, 4, 4, 4, 3, 4, 4, 4, 4, 4, 6, 4],
             'conv': [0, 4, 4, 5, 6, 5, 6, 6, 7, 8, 8, 7], 'mhsa': [6, 6, 6, 1, 0, 0, 0, 0, 4, 6, 6, 0]},

        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.2_iters_1_0.0004":
            {'ff1': [8, 8, 4, 4, 4, 4, 4, 4, 4, 5, 4, 4], 'ff2': [4, 4, 4, 1, 1, 4, 1, 4, 4, 0, 0, 0],
             'conv': [5, 6, 6, 6, 6, 8, 8, 8, 8, 8, 8, 6], 'mhsa': [12, 12, 11, 6, 6, 6, 6, 6, 5, 0, 0, 0]},
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.2_iters_2_0.0004":
            {'ff1': [0, 8, 4, 4, 4, 4, 4, 4, 4, 4, 5, 4], 'ff2': [4, 4, 4, 0, 0, 0, 2, 4, 4, 4, 4, 4],
             'conv': [2, 5, 5, 5, 6, 5, 7, 8, 10, 10, 11, 10], 'mhsa': [12, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 0]},
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.2_iters_4_0.0004":
            {'ff1': [6, 4, 4, 4, 4, 4, 4, 4, 4, 4, 8, 4], 'ff2': [4, 2, 4, 0, 0, 0, 1, 2, 4, 4, 4, 4],
             'conv': [2, 4, 4, 2, 2, 4, 6, 6, 8, 11, 12, 8], 'mhsa': [12, 12, 12, 6, 6, 6, 6, 6, 6, 6, 6, 0]},
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.2_iters_8_0.0004":
            {'ff1': [5, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'ff2': [4, 4, 4, 3, 2, 0, 0, 0, 4, 4, 4, 4],
             'conv': [1, 6, 6, 3, 6, 2, 7, 6, 6, 8, 8, 8], 'mhsa': [12, 12, 11, 6, 6, 6, 6, 6, 6, 6, 6, 2]},
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.2_iters_16_0.0004":
            {'ff1': [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'ff2': [4, 2, 3, 3, 0, 0, 4, 4, 4, 0, 4, 4],
             'conv': [2, 5, 6, 7, 5, 2, 7, 5, 9, 8, 9, 9], 'mhsa': [12, 12, 7, 6, 6, 6, 6, 6, 6, 6, 7, 6]},

        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.25_iters_1_0.0004":
            {'ff1': [4, 8, 4, 4, 4, 2, 4, 4, 4, 8, 8, 8], 'ff2': [0, 4, 4, 0, 0, 0, 0, 1, 4, 4, 4, 3],
             'conv': [3, 4, 6, 6, 6, 6, 8, 8, 8, 8, 8, 8], 'mhsa': [12, 12, 10, 4, 0, 5, 4, 0, 6, 6, 6, 0]},
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.25_iters_2_0.0004":
            {'ff1': [0, 8, 4, 4, 4, 4, 4, 4, 4, 4, 6, 4], 'ff2': [1, 4, 0, 0, 0, 0, 2, 4, 4, 4, 4, 4],
             'conv': [2, 5, 5, 5, 6, 5, 8, 10, 12, 13, 14, 10], 'mhsa': [12, 8, 6, 6, 6, 6, 6, 6, 6, 6, 6, 0]},
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.25_iters_4_0.0004":
            {'ff1': [5, 4, 4, 4, 4, 4, 4, 4, 4, 4, 8, 4], 'ff2': [4, 1, 4, 0, 0, 0, 0, 0, 4, 4, 4, 4],
             'conv': [3, 5, 2, 7, 7, 2, 6, 6, 11, 10, 13, 12], 'mhsa': [13, 12, 12, 7, 6, 6, 6, 6, 6, 6, 6, 0]},
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.25_iters_8_0.0004":
            {'ff1': [7, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'ff2': [4, 4, 0, 2, 2, 0, 0, 4, 4, 4, 4, 4],
             'conv': [1, 5, 4, 3, 7, 4, 7, 7, 7, 9, 9, 9], 'mhsa': [10, 10, 12, 7, 6, 6, 6, 6, 6, 6, 7, 2]},
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.25_iters_16_0.0004":
            {'ff1': [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'ff2': [4, 0, 3, 3, 4, 0, 0, 0, 4, 4, 4, 4],
             'conv': [3, 4, 6, 6, 3, 3, 6, 7, 7, 10, 11, 9], 'mhsa': [12, 8, 11, 6, 6, 6, 6, 6, 6, 6, 8, 1]}
    }
    ...
    for final_adapt_epochs in [30, 60, 90, 150]:
    # for final_adapt_epochs in [50]:
        for pct in [0.15]:
        # for pct in [0.15]:
            for num_iters in [1]:
