...
def returnn_config_generator(num_subepochs:int, train_data_config: dict, dev_data_config: dict, peak_lr: float) -> dict:
    ...
    dict_recog_component_dist = {
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.05_iters_1_0.0004":
            {'ff1': [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [4, 4, 4, 4, 4, 4, 4, 4, 5, 8, 7, 4],
             'mhsa': [6, 6, 6, 6, 6, 6, 6, 2, 0, 6, 4, 0], 'ff2': [1, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4]},
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.1_iters_1_0.0004":
            {'ff1': [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [4, 4, 4, 4, 4, 4, 4, 6, 8, 8, 8, 6],
             'mhsa': [6, 6, 6, 6, 6, 6, 4, 0, 0, 6, 0, 0], 'ff2': [0, 4, 4, 4, 3, 3, 2, 3, 4, 4, 4, 4]},
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.15_iters_1_0.0004":
            {'ff1': [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [4, 4, 4, 4, 4, 5, 8, 8, 8, 8, 8, 6],
             'mhsa': [6, 6, 6, 6, 6, 6, 3, 0, 0, 2, 0, 0], 'ff2': [0, 4, 4, 4, 3, 1, 0, 4, 4, 4, 4, 0]},
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.2_iters_1_0.0004":
            {'ff1': [4, 7, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [2, 4, 4, 4, 4, 8, 8, 8, 8, 8, 8, 8],
             'mhsa': [6, 6, 6, 6, 6, 6, 0, 0, 0, 0, 0, 0], 'ff2': [0, 4, 4, 4, 1, 0, 0, 0, 4, 4, 4, 2]},
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.25_iters_1_0.0004":
            {'ff1': [4, 8, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [0, 4, 4, 7, 8, 8, 8, 8, 8, 8, 8, 8],
             'mhsa': [6, 6, 6, 6, 6, 5, 0, 0, 0, 0, 0, 0], 'ff2': [0, 4, 4, 1, 0, 0, 0, 0, 4, 4, 4, 0]},

        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.05_iters_1_0.0004_freq_max_num_masks_8":
            {'ff1': [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [4, 4, 4, 4, 4, 4, 4, 4, 5, 8, 7, 4],
             'mhsa': [6, 6, 6, 6, 6, 6, 6, 1, 5, 6, 3, 0], 'ff2': [0, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4]},
        # "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.1_iters_1_0.0004_freq_max_num_masks_8":
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.15_iters_1_0.0004_freq_max_num_masks_8":
            {'ff1': [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [4, 4, 4, 4, 4, 5, 6, 8, 8, 8, 8, 8],
             'mhsa': [6, 6, 6, 6, 6, 6, 0, 0, 0, 2, 0, 0], 'ff2': [0, 4, 4, 4, 2, 0, 0, 3, 4, 4, 4, 4]},
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.2_iters_1_0.0004_freq_max_num_masks_8":
            {'ff1': [4, 5, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [4, 4, 4, 5, 7, 8, 8, 8, 8, 8, 8, 6],
             'mhsa': [6, 6, 6, 6, 6, 5, 0, 0, 0, 0, 0, 0], 'ff2': [0, 4, 4, 4, 1, 0, 0, 0, 4, 4, 4, 0]},
        "double_prune_total_num_components_216_adjust_dropout_True_adapt_epochs_60_pct_0.25_iters_1_0.0004_freq_max_num_masks_8":
            {'ff1': [4, 8, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [3, 4, 4, 7, 8, 8, 8, 8, 8, 8, 8, 8],
             'mhsa': [6, 6, 6, 6, 6, 3, 0, 0, 0, 0, 0, 0], 'ff2': [0, 4, 4, 1, 0, 0, 0, 0, 1, 4, 4, 0]}
    }
                        ...
                        for grad_update_beta in [0.1]:
                            for grad_score_metric in ["first_taylor"]:
                                for num_chunks in [4]:
                                    ...
                                    str_replace_pct = f"{str(lst_replace_pct[0])}_{repeat_times}"
                                    # str_replace_pct = "_".join([str(i) for i in lst_replace_pct])
                                    num_layers_12_experiment_name = f"double_prune_total_num_components_{total_num_components}_adjust_dropout_{adjust_dropout}_adapt_epochs_{final_adapt_epochs}_pct_{pct}_iters_{num_iters}_{peak_lr}_freq_max_num_masks_8"
                                    recog_network_args = copy.deepcopy(network_args)
                                    # assert num_layers_12_experiment_name in dict_recog_component_dist
                                    if num_layers_12_experiment_name in dict_recog_component_dist:
                                        recog_component_dist = dict_recog_component_dist[num_layers_12_experiment_name]
