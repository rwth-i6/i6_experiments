...
def get_serializer(model_config, variant: ConfigVariant, in_dim: int = 1) -> Collection:
    from i6_experiments.users.jxu.experiments.ctc.swb.pytorch_networks.dynamic_adaptable_conformer.adapt_based_on_gradient_ranking_finer_granul_random_init import \
...
def returnn_config_generator(num_subepochs:int, train_data_config: dict, dev_data_config: dict, peak_lr: float) -> dict:
    from i6_experiments.users.jxu.experiments.ctc.swb.pytorch_networks.dynamic_adaptable_conformer.adapt_based_on_gradient_ranking_finer_granul_random_init import get_default_config_v1
    ...
    dict_recog_component_dist = {
        "random_prune_total_num_components_216_beta_0.1_first_taylor_update_step_1000":
            {'ff1': [4, 4, 4, 4, 4, 3, 4, 4, 4, 8, 8, 4], 'ff2': [0, 4, 4, 0, 0, 0, 4, 4, 4, 4, 4, 4],
             'conv': [2, 3, 6, 6, 6, 6, 8, 8, 8, 8, 8, 8], 'mhsa': [6, 7, 6, 6, 5, 6, 6, 6, 6, 6, 6, 0]},
        "random_prune_total_num_components_216_beta_0.1_gradient_update_step_1000":
            {'ff1': [4, 5, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'ff2': [4, 4, 1, 0, 0, 0, 4, 4, 4, 4, 4, 1],
             'conv': [2, 5, 6, 6, 6, 6, 8, 8, 8, 8, 8, 8], 'mhsa': [12, 12, 12, 6, 6, 6, 6, 6, 6, 10, 6, 0]},
        "random_prune_total_num_components_1224_beta_0.1_first_taylor_update_step_1000":
            {'ff1': [32, 51, 32, 32, 31, 26, 32, 32, 32, 41, 59, 32],
             'ff2': [26, 32, 30, 3, 0, 2, 25, 32, 32, 32, 32, 31],
             'conv': [22, 33, 48, 48, 48, 49, 57, 61, 64, 64, 64, 62], 'mhsa': [11, 6, 6, 6, 2, 0, 5, 6, 6, 6, 6, 0]}
    }
