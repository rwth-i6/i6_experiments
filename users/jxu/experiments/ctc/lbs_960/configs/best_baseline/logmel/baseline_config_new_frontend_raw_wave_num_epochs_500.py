                ...
                for vgg_act in ["relu"]:
                    for dropout in [0.1, 0.2]:
                        ...
                        system.add_experiment_configs(
                            f"subepochs_500_peak_lr_{str_peak_lr}_vgg_act_{vgg_act}_time_mask_{time_max_mask_per_n_frames}_freq_mask_{freq_max_num_masks}_batch_15000_wei_hyper_new_frontend",
