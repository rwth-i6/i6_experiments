...
def run_lbs_960_torch_conformer_raw_wave_wei_hyper() -> SummaryReport:
    ...
    for peak_lr in [4e-4, 5e-4]:
        for time_max_mask_per_n_frames in [25, 20]:
            for freq_max_num_masks in [5,7,10]:
                for vgg_act in ["relu", "silu"]:
                    ...
                    system.add_experiment_configs(
                        f"peak_lr_{str_peak_lr}_vgg_act_{vgg_act}_time_mask_{time_max_mask_per_n_frames}_freq_mask_{freq_max_num_masks}_batch_15000_wei_hyper_new_frontend",
