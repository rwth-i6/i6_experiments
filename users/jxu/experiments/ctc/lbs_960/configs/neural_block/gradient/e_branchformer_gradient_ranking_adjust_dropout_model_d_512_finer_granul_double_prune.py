...
def returnn_config_generator(train_data_config: dict, dev_data_config: dict, peak_lr: float) -> dict:
    ...
    dict_recog_component_dist = {
        "double_prune_total_num_components_240_freq_mask_50_adapt_epochs_90_pct_0.1_iters_1_0.0004":
            {'ff1': [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [4, 4, 4, 4, 4, 4, 4, 4, 8, 8, 8, 8],
             'mhsa': [8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 0, 0], 'ff2': [0, 4, 4, 4, 4, 0, 3, 4, 4, 4, 4, 4]},
        "double_prune_total_num_components_240_freq_mask_50_adapt_epochs_90_pct_0.15_iters_1_0.0004":
            {'ff1': [4, 6, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [4, 4, 4, 4, 4, 5, 7, 8, 8, 8, 8, 4],
             'mhsa': [8, 14, 10, 10, 8, 8, 8, 8, 5, 4, 0, 0], 'ff2': [0, 4, 4, 4, 3, 0, 1, 4, 4, 4, 4, 0]},
        "double_prune_total_num_components_240_freq_mask_50_adapt_epochs_90_pct_0.2_iters_1_0.0004":
            {'ff1': [4, 8, 4, 4, 4, 4, 4, 4, 4, 4, 7, 6], 'cgmlp': [4, 4, 4, 4, 4, 6, 5, 8, 8, 8, 8, 8],
             'mhsa': [8, 11, 8, 8, 8, 8, 8, 8, 2, 4, 0, 0], 'ff2': [0, 4, 4, 0, 0, 0, 0, 0, 4, 4, 4, 4]},
        "double_prune_total_num_components_240_freq_mask_50_adapt_epochs_90_pct_0.25_iters_1_0.0004":
            {'ff1': [4, 8, 5, 4, 4, 4, 4, 4, 4, 4, 4, 5], 'cgmlp': [4, 4, 4, 5, 6, 6, 8, 8, 8, 8, 8, 8],
             'mhsa': [12, 16, 16, 8, 8, 8, 3, 0, 0, 0, 0, 0], 'ff2': [0, 4, 4, 0, 0, 0, 0, 0, 0, 4, 4, 4]}
    }
                        ...
                        for grad_update_beta in [0.1]:
                            for grad_score_metric in ["first_taylor"]:
                                for num_chunks in [4]:
                                    ...
                                    if num_layers_12_experiment_name in ["double_prune_total_num_components_240_freq_mask_50_adapt_epochs_90_pct_0.1_iters_1_0.0004",
                                                                         "double_prune_total_num_components_240_freq_mask_50_adapt_epochs_90_pct_0.15_iters_1_0.0004",
                                                                         "double_prune_total_num_components_240_freq_mask_50_adapt_epochs_90_pct_0.2_iters_1_0.0004",
                                                                         "double_prune_total_num_components_240_freq_mask_50_adapt_epochs_90_pct_0.25_iters_1_0.0004"]:
