...
def returnn_config_generator(train_data_config: dict, dev_data_config: dict, peak_lr: float) -> dict:
    ...
    dict_recog_component_dist = {
        "double_prune_total_num_components_192_freq_mask_50_adapt_epochs_90_pct_0.1_iters_1_0.0004":
            {'ff1': [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [4, 4, 4, 4, 4, 4, 4, 5, 7, 8, 8, 8],
             'mhsa': [4, 4, 4, 4, 4, 4, 4, 4, 3, 0, 0, 0], 'ff2': [4, 4, 4, 4, 0, 0, 0, 4, 4, 4, 4, 4]},
        "double_prune_total_num_components_192_freq_mask_50_adapt_epochs_90_pct_0.15_iters_1_0.0004":
            {'ff1': [3, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [2, 4, 4, 4, 4, 5, 6, 8, 8, 8, 8, 8],
             'mhsa': [4, 4, 4, 4, 4, 4, 4, 1, 0, 0, 0, 0], 'ff2': [1, 4, 4, 4, 0, 0, 1, 4, 4, 4, 4, 4]},
        "double_prune_total_num_components_192_freq_mask_50_adapt_epochs_90_pct_0.2_iters_1_0.0004":
            {'ff1': [4, 6, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [4, 4, 4, 7, 8, 8, 5, 8, 8, 8, 6, 6],
             'mhsa': [4, 8, 4, 4, 4, 4, 4, 0, 0, 0, 0, 0], 'ff2': [3, 4, 4, 4, 2, 0, 0, 0, 2, 3, 0, 0]},
        "double_prune_total_num_components_192_freq_mask_50_adapt_epochs_90_pct_0.25_iters_1_0.0004":
            {'ff1': [2, 6, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [2, 4, 4, 6, 8, 8, 8, 8, 8, 8, 8, 8],
             'mhsa': [8, 8, 4, 4, 4, 1, 0, 0, 0, 0, 0, 0], 'ff2': [0, 4, 4, 0, 0, 0, 0, 0, 2, 4, 4, 3]},

        "double_prune_total_num_components_192_freq_mask_50_adapt_epochs_90_pct_0.1_iters_1_0.0005":
            {'ff1': [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [4, 4, 4, 4, 4, 4, 4, 5, 7, 8, 8, 8],
             'mhsa': [4, 4, 4, 4, 4, 4, 4, 4, 3, 0, 0, 0], 'ff2': [4, 4, 4, 4, 0, 0, 0, 4, 4, 4, 4, 4]},
        "double_prune_total_num_components_192_freq_mask_50_adapt_epochs_90_pct_0.15_iters_1_0.0005":
            {'ff1': [2, 5, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [2, 4, 4, 4, 4, 6, 4, 8, 8, 8, 8, 8],
             'mhsa': [4, 6, 4, 4, 4, 4, 4, 4, 1, 0, 0, 0], 'ff2': [0, 4, 4, 4, 1, 0, 0, 4, 4, 4, 4, 4]},
        "double_prune_total_num_components_192_freq_mask_50_adapt_epochs_90_pct_0.2_iters_1_0.0005":
            {'ff1': [2, 5, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4], 'cgmlp': [1, 4, 4, 5, 5, 8, 8, 8, 8, 8, 8, 8],
             'mhsa': [4, 4, 4, 4, 4, 4, 1, 3, 0, 0, 0, 0], 'ff2': [0, 4, 4, 4, 0, 0, 0, 0, 4, 4, 4, 4]},
        "double_prune_total_num_components_192_freq_mask_50_adapt_epochs_90_pct_0.25_iters_1_0.0005":
            {'ff1': [0, 8, 4, 4, 4, 4, 4, 4, 4, 4, 5, 4], 'cgmlp': [0, 4, 4, 4, 8, 8, 8, 8, 8, 8, 8, 8],
             'mhsa': [4, 8, 4, 4, 4, 0, 0, 1, 0, 0, 0, 0], 'ff2': [0, 4, 4, 1, 0, 0, 0, 1, 4, 4, 4, 4]}
    }
