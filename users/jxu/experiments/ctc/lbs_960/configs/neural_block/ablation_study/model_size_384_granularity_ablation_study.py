...
def returnn_config_generator(train_data_config: dict, dev_data_config: dict, peak_lr: float) -> dict:
    ...
    dict_recog_component_dist = {
        ...
        "double_prune_total_num_components_360_adjust_dropout_True_beta_0.1_first_taylor_update_step_1000":
            {'ff1': [7, 9, 8, 8, 8, 8, 8, 8, 8, 11, 15, 12], 'ff2': [2, 8, 5, 0, 0, 5, 7, 8, 8, 8, 8, 8],
             'conv': [4, 4, 12, 12, 12, 12, 12, 16, 16, 16, 16, 16], 'mhsa': [6, 12, 6, 6, 6, 6, 6, 6, 6, 5, 0, 0]},
        "double_prune_total_num_components_648_adjust_dropout_True_beta_0.1_first_taylor_update_step_1000":
            {'ff1': [20, 27, 16, 16, 16, 15, 16, 16, 16, 16, 18, 16],
             'ff2': [18, 16, 15, 12, 1, 3, 3, 6, 15, 16, 16, 8],
             'conv': [24, 23, 27, 22, 23, 24, 24, 28, 30, 32, 31, 26], 'mhsa': [12, 12, 7, 6, 6, 6, 6, 6, 6, 5, 0, 0]},
        ...
        "double_prune_total_num_components_2376_adjust_dropout_True_beta_0.1_first_taylor_update_step_1000":
            {'ff1': [47, 78, 64, 64, 61, 54, 63, 63, 64, 64, 118, 128],
             'ff2': [49, 64, 52, 24, 11, 21, 9, 39, 63, 64, 70, 64],
             'conv': [25, 48, 82, 83, 90, 94, 97, 105, 119, 128, 128, 128],
             'mhsa': [6, 12, 6, 6, 6, 6, 6, 6, 6, 6, 6, 0]},
        "double_prune_total_num_components_13896_adjust_dropout_True_beta_0.1_first_taylor_update_step_1000":
            {'ff1': [272, 443, 372, 345, 337, 295, 330, 371, 383, 406, 638, 729],
             'ff2': [220, 346, 269, 226, 147, 187, 216, 303, 365, 402, 509, 453],
             'conv': [164, 277, 421, 434, 478, 479, 530, 611, 674, 708, 756, 762],
             'mhsa': [6, 12, 6, 6, 6, 6, 6, 6, 6, 6, 6, 0]},
        ...
        "double_prune_total_num_components_360_adjust_dropout_True_beta_0.1_gradient_update_step_1000":
            {'ff1': [8, 9, 8, 8, 8, 8, 8, 8, 8, 10, 8, 8], 'ff2': [5, 8, 5, 7, 4, 7, 6, 5, 8, 8, 0, 0],
             'conv': [4, 8, 12, 12, 12, 12, 12, 13, 16, 15, 13, 12], 'mhsa': [12, 12, 12, 12, 11, 7, 6, 6, 7, 6, 0, 0]},
        "double_prune_total_num_components_648_adjust_dropout_True_beta_0.1_gradient_update_step_1000":
            {'ff1': [14, 16, 16, 16, 16, 16, 16, 16, 16, 16, 24, 19],
             'ff2': [3, 16, 14, 1, 1, 3, 5, 16, 16, 16, 16, 16],
             'conv': [7, 10, 23, 24, 24, 24, 25, 27, 32, 32, 32, 32], 'mhsa': [10, 12, 12, 11, 6, 6, 6, 6, 6, 6, 6, 1]},
        ...
        "double_prune_total_num_components_2376_adjust_dropout_True_beta_0.1_gradient_update_step_1000":
            {'ff1': [61, 72, 64, 64, 60, 56, 60, 63, 64, 64, 72, 118],
             'ff2': [30, 63, 59, 24, 11, 9, 4, 25, 61, 64, 64, 64],
             'conv': [27, 47, 89, 94, 92, 94, 95, 104, 117, 126, 128, 128],
             'mhsa': [12, 12, 10, 8, 6, 6, 6, 6, 6, 6, 6, 6]},
        "double_prune_total_num_components_13896_adjust_dropout_True_beta_0.1_gradient_update_step_1000":
            {'ff1': [299, 471, 378, 347, 328, 318, 315, 349, 377, 392, 507, 649],
             'ff2': [204, 343, 255, 244, 171, 148, 203, 209, 303, 386, 418, 398],
             'conv': [180, 289, 447, 454, 485, 509, 536, 610, 667, 710, 752, 758],
             'mhsa': [12, 12, 9, 7, 6, 6, 6, 6, 6, 6, 6, 6]}
    }
