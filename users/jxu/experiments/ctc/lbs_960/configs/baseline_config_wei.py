...
from i6_experiments.users.jxu.experiments.ctc.lbs_960.pytorch_networks import \
    conformer_ctc_d_model_512_num_layers_12_wei_hyper as conformer_ctc
...
def run_lbs_960_torch_conformer_wei_hyper() -> SummaryReport:
    ...
    system.add_experiment_configs(
        "Conformer_CTC_d_model_512_num_layers_12_epochs_25_peark_lr_2e_04_batch_15000_wei_hyper",
        get_returnn_config_collection(data.train_data_config, data.cv_data_config, lr=peak_lr_2e_04, batch_size=15000)
    )
    ...
    system.add_experiment_configs(
        "Conformer_CTC_d_model_512_num_layers_12_epochs_25_peark_lr_3e_04_batch_15000_wei_hyper",
        get_returnn_config_collection(data.train_data_config, data.cv_data_config, lr=peak_lr_3e_04, batch_size=15000)
    )
    ...
    system.add_experiment_configs(
        "Conformer_CTC_d_model_512_num_layers_12_epochs_25_peark_lr_4e_04_batch_15000_wei_hyper",
        get_returnn_config_collection(data.train_data_config, data.cv_data_config, lr=peak_lr_4e_04, batch_size=15000)
    )
    ...
    system.add_experiment_configs(
        "Conformer_CTC_d_model_512_num_layers_12_epochs_25_peark_lr_5e_04_batch_15000_wei_hyper",
        get_returnn_config_collection(data.train_data_config, data.cv_data_config, lr=peak_lr_5e_04, batch_size=15000)
    )
