        ...
        # for k_annealing_step, k_reduction_per_iter in [(8, 1), (9.5, 1), (12, 1), (13.5, 1)]:
            for layer_dropout_mod_select, layer_dropout_fix_mod in [(0, 0.3)]:
                ...
                system.add_experiment_configs(
                    f"lp_15_thee_model_subepochs_600_peak_lr_{str_peak_lr}_k_annealing_{k_annealing_step}_{k_reduction_per_iter}_layer_dropout_{str_layer_dropout}_mod_48",
                ...
                system.add_experiment_configs(
                    f"lp_15_thee_model_subepochs_600_peak_lr_{str_peak_lr}_k_annealing_{k_annealing_step}_{k_reduction_per_iter}_layer_dropout_{str_layer_dropout}_mod_32",
                    get_returnn_config_collection(data.train_data_config, data.cv_data_config, lr=peak_lr_dict,
                                                  batch_size=15000 * 160, network_args=network_args, kwargs={})
                )
                ...
                system.add_experiment_configs(
                    f"lp_15_thee_model_subepochs_600_peak_lr_{str_peak_lr}_k_annealing_{k_annealing_step}_{k_reduction_per_iter}_layer_dropout_{str_layer_dropout}_mod_16",
                    get_returnn_config_collection(data.train_data_config, data.cv_data_config, lr=peak_lr_dict,
                                                  batch_size=15000 * 160, network_args=network_args, kwargs={})
                )
