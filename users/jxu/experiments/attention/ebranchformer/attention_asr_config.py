...
from i6_experiments.users.zeineldeen.models.asr.encoder.ebranchformer_encoder import (
...
@dataclass
class EbranchformerEncoderArgs(EncoderArgs):
    num_blocks: int = 17
    enc_key_dim: int = 512
    att_num_heads: int = 8
    ff_dim: int = 1024
...
def create_config(
    ...
    if isinstance(encoder_args, EbranchformerEncoderArgs):
