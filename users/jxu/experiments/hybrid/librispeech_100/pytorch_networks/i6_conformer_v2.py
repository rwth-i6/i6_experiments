...
from i6_models.i6_models.assemblies.conformer import ConformerBlockV1Config, ConformerEncoderV1Config
...
class VGG4LayerPoolFrontendV1(nn.Module):
    ...
    def __init__(self, model_cfg: VGG4LayerPoolFrontendV1Config):
        ...
        self.frontend_linear = nn.Linear(model_cfg.input_size // model_cfg.pool_kernel_size[1] * model_cfg.conv4_channels, 384)
...
def export_trace(*, model: Model, model_filename: str):
    ...
    # dummy_data_len, _ = torch.sort(torch.randint(low=30, high=30, size=(1,), device="cpu", dtype=torch.int32), descending=True)
