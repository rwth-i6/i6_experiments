...
from i6_models.i6_models.assemblies.conformer import ConformerBlockV1Config
from i6_models.i6_models.parts.conformer import ConformerMHSAV1Config, ConformerConvolutionV1Config, \
    ConformerPositionwiseFeedForwardV1Config
from i6_models.i6_models.parts.conformer import ConformerMHSAV1, ConformerPositionwiseFeedForwardV1
...
class ConformerConvolutionV1(nn.Module):
    ...
    def __init__(self, model_cfg: ConformerConvolutionV1Config):
        ...
        self.norm = nn.BatchNorm1d(model_cfg.channels)
...
class Conformer(torch.nn.Module):
    ...
    *Conformer: Convolution-augmented Transformer for Speech Recognition*
    ...
    def __init__(
        ...
        self.downsample_conv = torch.nn.Conv1d(in_channels=input_dim, out_channels=input_dim, kernel_size=5, stride=2,
                                               padding=2)
        ...
        self.upsample_conv = torch.nn.ConvTranspose1d(in_channels=input_dim, out_channels=input_dim, kernel_size=5,
                                                      stride=2, padding=1)
...
class Model(torch.nn.Module):
    ...
    def forward(
        ...
        if self.training:
            ...
            audio_features_time_masked_2 = mask_along_axis(audio_features_time_masked, mask_param=20, mask_value=0.0,
                                                           axis=1)
            audio_features_time_masked_3 = mask_along_axis(audio_features_time_masked_2, mask_param=20, mask_value=0.0,
                                                           axis=1)
