...
def lid_aware_sc_ctc(
    ...
    for specauc_start_epoch in [30]:
        model_config = get_model_config(vocab_size_without_blank=vocab_size, network_args={"specauc_start_epoch": specauc_start_epoch, "lid_sc_layer": 3, "sc_layer": [6,9,]})
        recog_model_config = get_model_config(vocab_size_without_blank=vocab_size, network_args={"lid_sc_layer": 3, "sc_layer": [6,9,]}, )
        ...
        for peak_lr in learning_rates:
            ...
            train_args = {
                **copy.deepcopy(train_args_adamw03_accum2_jjlr),
                "network_module": "language_aware_sc_ctc",
            ...
            train_job = run_exp(
                prefix_name + f"conformer_new/lid_aware_sc_ctc/ctc/{vocab_name.split('.')[0]}/{batch_size}_{bpe_size}_lr{peak_lr}",
