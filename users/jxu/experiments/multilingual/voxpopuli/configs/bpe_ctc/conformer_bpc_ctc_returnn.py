...
from i6_experiments.users.jxu.experiments.multilingual.voxpopuli.data.get_data import get_voxpopuli_data_per_lang, get_voxpopuli_data_with_upsampling
...
def conformer_ctc_returnn(
    ...
    from i6_experiments.users.jxu.experiments.multilingual.voxpopuli.pytorch_networks.i6modelsV1_VGG4LayerActFrontendV1_v6_onnx_exportable_returnn import \
        get_model_config
        ...
        for peak_lr in learning_rates:
            train_args_adamw03_accum2_jjlr = {
                "config": {
                    ...
                    "extern_data": {"data": {"dim": 1}, "targets": {"dim": vocab_size+1, "sparse": True}}
                },
                "debug": True,
            }
            ...
            train_args = {
                **copy.deepcopy(train_args_adamw03_accum2_jjlr),
                "network_module": "i6modelsV1_VGG4LayerActFrontendV1_v6_onnx_exportable_returnn",
            ...
            train_data = CTCTrainingDatasets(
                train=get_voxpopuli_data_with_upsampling("/u/kaloyan.nikolov/experiments/multilang_0325/output/voxpopuli_asr",
