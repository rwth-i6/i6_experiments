...
def run_lbs_960_conformer_rel_pos() -> SummaryReport:
    prefix = "experiments/ctc/conformer_baseline_small"
    ...
    recog_args = exp_args.get_ctc_recog_step_args(
        num_classes=num_outputs,
        epochs=[450, num_subepochs],
        prior_scales=[0.3],
        lm_scales=[0.5, 0.8, 1.0],
        feature_type=FeatureType.SAMPLES,
    ...
    for peak_lr in [1e-3]:
        for aux_losses in [{"12": 1, "8":0.3}]:
            ...
            system.add_experiment_configs(
                f"from_scratch_lbs_960_lr_{str_peak_lr}",
