...
def bpe128_ls960_0924_base():
    ...
    DecoderConfig = FlashlightDecoderConfig | GreedyDecoderConfig
    ...
    for detach_logits in [True, False]:
        ...
        model_config = ModelConfig(
            ...
            share_bias_compute=detach_logits,  # hacky way to do it wo changing hash/too much
        )
        ...
        for epoch in [500]:
            ...
            tune_and_evaluate_helper(
                training_name + f"/4gram_ep{epoch}",
                asr_model,
