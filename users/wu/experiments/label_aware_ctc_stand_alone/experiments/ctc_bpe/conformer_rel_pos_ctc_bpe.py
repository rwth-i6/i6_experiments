...
def bpe128_ls960_0924_base():
    ...
    from ...pytorch_networks.ctc.conformer_rel_pos_ctc_blank_bias_new_cfg import (
        SpecaugConfig,
    ...
    model_config = ModelConfig(
        ...
        aux_ctc_loss_layers=[7, 11],
        aux_ctc_loss_scales=[0.3, 1.0],
    )
    ...
    network_module = "ctc.conformer_rel_pos_ctc_blank_bias_new"
    train_args_radam = {
    ...
    training_name = (
        ...
        + "/"
        + network_module
        + ".512dim_sub4_100eps_sp_lp_fullspec_gradnorm_radam_lr5e-4"
    )
