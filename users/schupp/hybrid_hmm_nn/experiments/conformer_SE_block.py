...
# ------------------------------------------
gs.ALIAS_AND_OUTPUT_SUBDIR = "conformer/se_block/"
type = 'conformer'
prefix = 'conformer_'
...
def run_exp():
  train_SE_block_default()


def train_SE_block_default():
  name = f"conf__SE_block_default"
  ...
  _enc_half_args["tbs_version"] = "se_block"
  ...
  rec_epochs = [5, 10, 20, 40, 100, 120] + [160, 180, 190, 200] # Extendet epochs for extendent train
