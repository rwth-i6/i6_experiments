...
# ------------------------------------------
gs.ALIAS_AND_OUTPUT_SUBDIR = "conformer/grad_noise/"
type = 'conformer'
prefix = 'conformer_'
...
def run_exp(): #  'swish' -> is same as baseline
  train_grad_noise(noise=0.01)
  train_grad_noise(noise=0.1)

def train_grad_noise(noise=0.1):
  name = f"conf__grad-noise-{noise}"
  ...
  _nn_train_args["crnn_config"]["gradient_noise"] = noise
