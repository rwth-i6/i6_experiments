...
def run_exp():
  ...
  stage[8] = {
    "drop": [0.02 ,0.03, 0.05, 0.1],
    "l2" : [0.00005, 0.0001, 0.00015, 0.0002, 0.0003]
  }

  s = 8 # stage to reduce amount of concurrent trains...

  for drop in [0.02, 0.03, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3]:
    for L2 in [0.05, 0.005, 0.0001, 0.00015, 0.0002, 0.0003, 0.0004, 0.00005]:
