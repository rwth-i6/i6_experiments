...
def conformer_enc_layer_all_in_one_ff_gating(
  ...
  if with_stochastic_depth:
    network[f"{name}_ff1_out"] = {
      "class" : "eval",
      "eval" : f"self.network.get_config().typed_value('stoch_depth')(source(0), source(1), {survival_prob})",
