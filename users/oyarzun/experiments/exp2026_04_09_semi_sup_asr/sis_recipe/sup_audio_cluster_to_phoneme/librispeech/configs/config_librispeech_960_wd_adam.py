        ...
        [
            *[
                (
                    ...
                    f"optimizer-{cl}_epsilon-{epsilon}_weight_decay-{weight_decay}",
                )
                for cl, epsilon, weight_decay in ablations  # each tuple is a different test config ; basically an ablation
            ]
        ]
    ):
        print("new")
