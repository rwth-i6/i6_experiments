...
def eval_model_rasr(
    ...
    for checkpoint_name in checkpoints:
        ...
        search_function = CallImport(
            code_object_path="i6_experiments.users.oyarzun.experiments.exp2026_04_09_unsupervised_asr.models.recognition.discrete_audio_aed.rasr.forward_step._get_rasr_search_function",
