...
def calc_align_stats():
  statistics_job = AlignmentStatisticsJob(
    alignment=TEDLIUM2BPE1057_CTC_ALIGNMENT.alignment_paths["train"],
    json_vocab=TEDLIUM2BPE1057_CTC_ALIGNMENT.vocab_path,
    blank_idx=TEDLIUM2BPE1057_CTC_ALIGNMENT.model_hyperparameters.blank_idx,
