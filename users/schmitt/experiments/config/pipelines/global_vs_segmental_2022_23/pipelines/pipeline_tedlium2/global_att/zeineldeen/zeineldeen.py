...
from i6_experiments.users.schmitt.experiments.config.pipelines.global_vs_segmental_2022_23.pipelines.pipeline_tedlium2.global_att.zeineldeen.alias import alias as base_alias
...
def get_global_att_config_builder():
  variant_params = {
    "dependencies": TEDLIUM2BPE1057_LABELS,
    "dataset": {
      "feature_type": "raw",
      "corpus": TEDLIUM_CORPUS
    },
    "network": {"decoder_version": None},
    "config": {
