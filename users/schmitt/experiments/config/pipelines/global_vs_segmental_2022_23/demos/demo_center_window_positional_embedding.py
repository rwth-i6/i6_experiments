...
network = {
  ...
  'output': {
    ...
    'unit': {
      ...
      # "print_segment_starts1_2": {
      #     "class": "print",
      #     "from": "segment_starts1",
      #     "is_output_layer": True
      # },
      'segment_starts2': {
        'class': 'eval',
  ...
  'label_model': {
    ...
    'unit': {
      ...
      "segment_delta1": {
        "class": "switch",
        "condition": "segment_delta_max_mask",
        "true_from": 20,
        "false_from": "segment_delta0"
      },
      "segment_delta2": {
        "class": "eval",
        "from": ["segment_delta1"],
      ...
      "print_segment_delta_embed": {
        "class": "print",
        "from": "segment_delta_embed",
        "is_output_layer": True
      },
      "print_segment_starts1": {
        "class": "print",
        "from": "segment_starts1",
        "is_output_layer": True
      },
      # "print_cur_label_position": {
      #   "class": "print",
      #   "from": "label_position",
      #   "is_output_layer": True
      # },
      # "print_prev_label_position": {
      #   "class": "print",
      #   "from": "prev:label_position",
      #   "is_output_layer": True
      # },
      "print_targetb": {
        "class": "print",
