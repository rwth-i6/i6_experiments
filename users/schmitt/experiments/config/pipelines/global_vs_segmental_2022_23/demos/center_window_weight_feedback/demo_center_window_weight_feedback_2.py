...
att_heads_dim = DimensionTag(kind=DimensionTag.Types.Spatial, description="att_heads", dimension=1)
...
network = {
  ...
  "initial_seq_lens_range": {
    ...
    "from": "initial_seq_lens",
    "out_spatial_dim": initial_segment_dim
  },
  "initial_output_layer": {
    "class": "constant",
    "value": 0.,
    "shape_deps": ["initial_seq_lens_range"],
    "shape": [batch_dim, initial_segment_dim, att_heads_dim]
  },
  'label_model': {
    'class': 'rec',
    'from': [],
    'unit': {
      ...
      "overlap_range": {
        ...
        "axis": "stag:sliced-time:overlap_accum_weights"
      },
      "overlap_start": {
        "class": "combine",
      ...
      "accum_att_weights_scattered": {
        ...
        "position_axis": "stag:sliced-time:overlap_accum_weights",
      ...
      'accum_att_weights': {
        ...
        'from': ['prev:accum_att_weights_scattered', 'att_weights', 'inv_fertility'],
        'out_type': {
          'dim': 1,
          'shape': (None, 1)
          },
