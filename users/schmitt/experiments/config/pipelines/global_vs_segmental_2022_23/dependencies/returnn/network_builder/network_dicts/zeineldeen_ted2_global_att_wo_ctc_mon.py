    ...
    "output": {
        ...
        "unit": {
            ...
            "expected_att_weights_pos": {
                "class": "combine",
                "kind": "mul",
                "from": ["att_weights", "base:enc_len_range"],
                "allow_broadcast_all_sources": True,
            },
            "expected_att_weights_pos_reduce": {
                "class": "reduce",
                "from": "expected_att_weights_pos",
                "mode": "sum",
                "axes": ["T"],
                "keep_dims": False,
                "initial_output": 0,
            ...
            "expected_att_weights_pos_delta": {
                ...
                "from": [
                    "expected_att_weights_pos_reduce",
                    "prev:expected_att_weights_pos_reduce",
                ],
            },
            "monotonic_att_weights_loss": {
                "class": "eval",
                "eval": "0.8 * (tf.math.abs(source(0) - 1) - (source(0) - 1)) + 0.2 * (tf.math.abs(source(0) "
                "- 30) + (source(0) - 30))",
                "from": "expected_att_weights_pos_delta",
                "loss": "as_is",
            },
            "monotonic_att_weights_penalty_squeeze": {
                "class": "squeeze",
                "from": "monotonic_att_weights_loss",
                "axis": "except_batch",
            },
            "s": {
                "class": "rnn_cell",
