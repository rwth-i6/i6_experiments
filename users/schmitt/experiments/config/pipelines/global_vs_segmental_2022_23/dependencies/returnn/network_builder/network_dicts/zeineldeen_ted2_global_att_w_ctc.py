network = {
    ...
    "global_mean": {
        ...
        "eval": "exec('import numpy') or "
                "numpy.loadtxt('/u/zeineldeen/setups/ubuntu_22_setups/2023-04-17--conformer-att/work/i6_core/returnn/dataset/ExtractDatasetMeanStddevJob.UHCZghp269OR/output/mean', "
    ...
    "global_stddev": {
        "class": "eval",
        "eval": "exec('import numpy') or "
                "numpy.loadtxt('/u/zeineldeen/setups/ubuntu_22_setups/2023-04-17--conformer-att/work/i6_core/returnn/dataset/ExtractDatasetMeanStddevJob.UHCZghp269OR/output/std_dev', "
                "dtype='float32') + (source(0) - source(0))",
        "from": "log10_",
    },
}