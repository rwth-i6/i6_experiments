...
default_variant_enc_dec = dict(
  ...
  pretrain_type="best", epoch_split=6, enc_type="lstm")

seg_model_variants = {
  "seg.bpe.full-ctx.time-red6.fast-rec.fast-rec-full.seg.mlp-att.am2048.prev-att-in-state.frame-length-model-in_am+prev-out-embed.no-ctx-reg": {
    "config": dict(default_variant_transducer, use_attention=True, label_type="bpe", lstm_dim=1024, ctx_size="inf",
                   ...
                   label_model_focal_loss=0.0, att_ctx_reg=False),
  },
}
