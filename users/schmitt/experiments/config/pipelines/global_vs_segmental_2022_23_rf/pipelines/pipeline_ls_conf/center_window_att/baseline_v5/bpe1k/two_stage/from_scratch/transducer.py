...
def run_exps():
  ...
  for (
    ...
    ("v1", 1, False, False),  # standard transducer
    # (None, False),  # transducer with LSTM attention
    ("v2", None, True, False),  # transducer with transformer attention
    ("v3", None, True, True),  # transducer with transformer w/o cross attention
  ]:
    gpu_mem_rqmts = [24]
    if alias == "v1":
