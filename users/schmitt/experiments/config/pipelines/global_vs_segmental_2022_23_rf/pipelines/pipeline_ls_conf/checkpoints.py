...
external_checkpoints.update({
  ...
  # "luca-aed-bpe1k": PtCheckpoint(Path("/work/asr3/zeyer/schmitt/model_checkpoints/segmental_models_2022_23_rf/luca-global-aed-no-ctc-bpe1k-100ep_converted.pt")),
})
