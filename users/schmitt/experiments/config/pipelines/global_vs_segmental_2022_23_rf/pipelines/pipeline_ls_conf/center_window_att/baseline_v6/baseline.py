...
from i6_experiments.users.schmitt.experiments.config.pipelines.global_vs_segmental_2022_23_rf.pipelines.pipeline_ls_conf.center_window_att.baseline_v6.alias import alias as base_alias
...
def center_window_att_baseline_rf(
        ...
        gaussian_att_weight_std: float = 1.0,
):
  for win_size in win_size_list:
    alias, config_builder = get_center_window_att_config_builder_rf(
      ...
      gaussian_att_weight_opts={"std": gaussian_att_weight_std},
    )
