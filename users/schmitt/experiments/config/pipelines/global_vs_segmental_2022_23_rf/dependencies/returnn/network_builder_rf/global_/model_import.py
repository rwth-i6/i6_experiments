  ...
  _ParamMapping.update(
    {
      ...
      "encoder.enc_ctx.weight": "enc_ctx/W",
      "encoder.enc_ctx.bias": "enc_ctx/b",
      "encoder.inv_fertility.weight": "inv_fertility/W",
      "label_decoder.target_embed.weight": "output/rec/target_embed0/W",
      "label_decoder.weight_feedback.weight": "output/rec/weight_feedback/W",
      "label_decoder.s_transformed.weight": "output/rec/s_transformed/W",
      "label_decoder.energy.weight": "output/rec/energy/W",
      "label_decoder.readout_in.weight": "output/rec/readout_in/W",
      "label_decoder.readout_in.bias": "output/rec/readout_in/b",
      "label_decoder.output_prob.weight": "output/rec/output_prob/W",
      "label_decoder.output_prob.bias": "output/rec/output_prob/b",
    }
  )
  # conformer
...
def map_param_func_v2(reader, name: str, var: rf.Parameter) -> numpy.ndarray:
  ...
  if name == "label_decoder.s.ff_weight":
  ...
  if name == "label_decoder.s.rec_weight":
    value = reader.get_tensor("output/rec/s/rec/lstm_cell/kernel")
