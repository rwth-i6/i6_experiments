...
def get_best_net_dict(
        ...
        use_l2, att_ctx_with_bias, focal_loss, att_ctx_reg, enc_type):
  net_dict = {"#info": {"att_num_heads": att_num_heads, "enc_val_per_head": (lstm_dim * 2) // att_num_heads}}
  ...
  if enc_type == "lstm":
    net_dict.update({
      ...
      "lstm1_fw": {
        "class": "rec", "unit": "nativelstm2", "n_out": lstm_dim, "direction": 1, "from": ["lstm0_pool"],
        "dropout": 0.3, "L2": 0.0001 if use_l2 else None}, "lstm1_bw": {
        "class": "rec", "unit": "nativelstm2", "n_out": lstm_dim, "direction": -1, "from": ["lstm0_pool"],
        "dropout": 0.3, "L2": 0.0001 if use_l2 else None}, "lstm1_pool": {
        "class": "pool", "mode": "max", "padding": "same", "pool_size": (2,), "from": ["lstm1_fw", "lstm1_bw"],
        "trainable": False},

      "lstm2_fw": {
        "class": "rec", "unit": "nativelstm2", "n_out": lstm_dim, "direction": 1, "from": ["lstm1_pool"],
        "dropout": 0.3, "L2": 0.0001 if use_l2 else None}, "lstm2_bw": {
        "class": "rec", "unit": "nativelstm2", "n_out": lstm_dim, "direction": -1, "from": ["lstm1_pool"],
        "dropout": 0.3, "L2": 0.0001 if use_l2 else None}, "lstm2_pool": {
        "class": "pool", "mode": "max", "padding": "same", "pool_size": (1,), "from": ["lstm2_fw", "lstm2_bw"],
        "trainable": False},

      "lstm3_fw": {
        "class": "rec", "unit": "nativelstm2", "n_out": lstm_dim, "direction": 1, "from": ["lstm2_pool"],
        "dropout": 0.3, "L2": 0.0001 if use_l2 else None}, "lstm3_bw": {
        "class": "rec", "unit": "nativelstm2", "n_out": lstm_dim, "direction": -1, "from": ["lstm2_pool"],
        "dropout": 0.3, "L2": 0.0001 if use_l2 else None}, "lstm3_pool": {
        "class": "pool", "mode": "max", "padding": "same", "pool_size": (1,), "from": ["lstm3_fw", "lstm3_bw"],
        "trainable": False},

      "lstm4_fw": {
        "class": "rec", "unit": "nativelstm2", "n_out": lstm_dim, "direction": 1, "from": ["lstm3_pool"],
        "dropout": 0.3, "L2": 0.0001 if use_l2 else None}, "lstm4_bw": {
        "class": "rec", "unit": "nativelstm2", "n_out": lstm_dim, "direction": -1, "from": ["lstm3_pool"],
        "dropout": 0.3, "L2": 0.0001 if use_l2 else None}, "lstm4_pool": {
        "class": "pool", "mode": "max", "padding": "same", "pool_size": (1,), "from": ["lstm4_fw", "lstm4_bw"],
        "trainable": False},

      "lstm5_fw": {
        "class": "rec", "unit": "nativelstm2", "n_out": lstm_dim, "direction": 1, "from": ["lstm4_pool"],
        "dropout": 0.3, "L2": 0.0001 if use_l2 else None}, "lstm5_bw": {
        "class": "rec", "unit": "nativelstm2", "n_out": lstm_dim, "direction": -1, "from": ["lstm4_pool"],
        "dropout": 0.3, "L2": 0.0001 if use_l2 else None},
  ...
  net_dict.update({
    ...
    "output": {
      "class": "rec", "from": [], "unit": {
        ...
        "att": {
          "class": "merge_dims",
          "axes": ["dim:%s" % att_num_heads, ("dim:%s" % (lstm_dim * 2)) if enc_type == "lstm" else "f"],
          "from": ["att0"]},
        # (B, H*V)
        "lm": {
