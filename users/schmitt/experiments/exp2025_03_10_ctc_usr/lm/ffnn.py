...
from i6_experiments.users.schmitt.model_interfaces import ModelDefWithCfg, TrainDef, ModelDef
...
def get_ffnn_lm(vocab: Bpe, context_size: int, num_layers: int = 2, ff_hidden_dim: int = 2048, dropout: float = 0.0, embed_dropout: float = 0.0) -> ModelWithCheckpoint:
    ...
    from i6_experiments.users.schmitt.datasets.librispeech import LibrispeechLmDataset
