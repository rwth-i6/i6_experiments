...
def _add_params():
  ...
  _ParamMapping.update(
    {
      ...
      "decoder.energy.weight": "output/rec/energy/W",
      "decoder.readout_in.weight": "output/rec/readout_in/W",
      "decoder.readout_in.bias": "output/rec/readout_in/b",
      "decoder.output_prob.weight": "output/rec/output_prob/W",
      "decoder.output_prob.bias": "output/rec/output_prob/b",
    }
  )
  # conformer
  for layer_idx in range(12):
    ...
    # ctc
    _ParamMapping[
      f"enc_aux_logits_{layer_idx + 1}.weight"
    ] = f"ctc/W"
    _ParamMapping[
      f"enc_aux_logits_{layer_idx + 1}.bias"
    ] = f"ctc/b"
