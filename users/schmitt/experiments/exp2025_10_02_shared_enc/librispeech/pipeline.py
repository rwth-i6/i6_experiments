...
def search_v2(
    ...
    search_job.add_alias(prefix_name + "/search_job")
    tk.register_output(search_job.get_one_alias(), search_job.out_files["search_out.py.gz"])
...
def training(training_name, datasets, train_args, num_epochs, returnn_exe, returnn_root, use_v2_serialization: bool = False):
    """
    :param training_name:
    :param datasets:
    :param train_args:
    ...
    returnn_config = get_training_config(training_datasets=datasets, use_v2_serialization=use_v2_serialization, **train_args)
