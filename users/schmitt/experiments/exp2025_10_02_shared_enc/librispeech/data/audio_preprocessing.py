...
import logging
from i6_experiments.users.enrique.jobs.fairseq.wav2vec.wav2vec_data_utils import get_rvad_root, get_fairseq_root, w2v_manifest
...
class Wav2VecUDeleteSilencesInAudioJob(Job):
    ...
    __sis_hash_exclude__ = {"environment": "/work/smt4/zeineldeen/enrique.leon.lozano/py_envs/fairseq_env_v3",
                            "fairseq_root": "/u/enrique.leon.lozano/setups/ubuntu_22_setups/fairseq_2025_03_11/work/Fairseq/fairseq_w2vu/fairseq",
                            "rvad_root": None, "name_the_manifests_just_train_and_valid": True}
    ...
    def __init__(
        ...
        self.rqmt = {"time": 64, "cpu": concurrent, "gpu": 1, "mem": 32}
...
class Wav2VecUFeaturizeAudioJob(Job):
    ...
    def __init__(
        ...
        self.out_features_precompute_pca512_cls128_mean = self.output_path(
            "audio_features/precompute_pca512_cls128_mean", directory=True)
        self.out_features_precompute_pca512_cls128_mean_pooled = self.output_path(
            "audio_features/precompute_pca512_cls128_mean_pooled", directory=True)
