...
def py():
    ...
    if self_training_rounds == 0:
        alt_decoder = False
    assert decoding_imp in ["flashlight", "albert-flashlight", "albert-lm", "albert-greedy", "marten-greedy",
                            "gradients"]
    ...
    wav2vec_large_lv60_config_9h_v4 = dict_update_deep(
        wav2vec_large_lv60_config_v1,
        {
            "train_ds_str": "_train-clean-100-short",
            "freeze_encoder_first_n_steps": 1_250,
    ...
    max_config_v2 = dict_update_deep(
        wav2vec_base_config_v3,
        {
            "epochs": 2,
            "num_gpus": 1,
    ...
    train_configs = [
        ...
        *[(dict_update_deep(
        ...
        # *[(dict_update_deep(
        #     copy.deepcopy(wav2vec_large_lv60_config_9h_v4),
        #     {
        #         "train_epoch_wise_filter": None,
        #         "vocab": vocab_,
        #     }
        # ), (
        #        f"wav2vec-large-lv60-9h-v4/nep-{200}_sgpu_no-ep-filter_vocab-{vocab_}"
        #    )) for vocab_ in [
        #     "bpe128",
        # ]],
        ...
        *[(dict_update_deep(
           ...
           )) for n_epochs, am_scale, lm_scale, prior_scale, accum_grad, peak_lr, lr_schedule_type, blank_penalty_opts
            in [
                # stop grad + lower peak lr + diff scales
                ...
                (5, {"steps": [500, 1_500], "values": [0.1, 0.1, 0.4]}, 0.5,
                 {"steps": [500, 1_500], "values": [0.4, 0.4, 0.8]}, 1, 1e-4, "static", None),
    ...
    train_configs = [
        ...
        # (max_config_v2, "max-v2/ffnn8-bpe-lm-pseudo-labels"),
        *[(dict_update_deep(
            copy.deepcopy(max_config_v2),
            {
                "self_training_rounds": i,
                "hyperparameters_self_training_updates": [
                    {
                        "norm_am_after_weight": False,
                        "lm_weight": lm_weight,
               ...
               f"max-v2/ffnn8-bpe-lm-pseudo-labels_st-lm-{lm_weight}_prior-{prior_weight}_am-{am_weight}")
        ) for i, lm_weight, prior_weight, am_weight in [
            # (1, 0.7, 0.1, 0.2),  # only blank for second pseudo labels
            (4, 0.7, 0.7, 0.05),  # same seq regardless of audio (varying lengths)
            (2, 0.7, 0.7, 0.2),  #
            (2, 0.7, 0.7, 0.3),  #
        ]],
        # (dict_update_deep(
        ...
        *[(dict_update_deep(
           ...
           f"sup-max-v1/peak-lr-1e-3_init-{train_ds_str}_{n_epochs}-epochs_specaug-{specaugment_steps}_speedpert-{speed_pert_discrete_values}/specaug-self-{specaugment_steps_self}")
            for train_ds_str, n_self_train, n_epochs, specaugment_steps, speed_pert_discrete_values, specaugment_steps_self in [
                ...
                # "200": {"dev-clean": 20.16, "dev-other": 37.66, "test-clean": 20.76, "test-other": 39.37}
                # ("train-clean-100-max-10s", 0, 100, (5000, 15000, 25000), [0.7, 0.8, 0.9, 1.0, 1.1], (5000, 15000, 25000)),
                # "100": {"dev-clean": 18.26, "dev-other": 36.93, "test-clean": 19.07, "test-other": 39.06}
                # ("train-clean-100-max-10s", 0, 50, (5000, 15000, 25000), [0.7, 0.8, 0.9, 1.0, 1.1], (5000, 15000, 25000)),
                # "50": {"dev-clean": 18.5, "dev-other": 39.28, "test-clean": 19.36, "test-other": 41.37}
                # ("train-clean-100-max-10s", 0, 50, (1000, 2000, 5000), [0.7, 0.8, 0.9, 1.0, 1.1], (1000, 2000, 5000)),
                # "50": {"dev-clean": 17.36, "dev-other": 36.63, "test-clean": 18.16, "test-other": 38.64}
                ("train-clean-100-max-10s", 4, 50, (1000, 2000, 3000), [0.7, 0.8, 0.9, 1.0, 1.1], (1000, 2000, 3000)),
                # "50": {"dev-clean": 17.22, "dev-other": 36.25, "test-clean": 18.0, "test-other": 37.96}
                ("train-clean-100-max-10s", 4, 50, (1000, 2000, 3000), [0.7, 0.8, 0.9, 1.0, 1.1], (5000, 15000, 25000)),
                # "50": {"dev-clean": 17.8, "dev-other": 36.75, "test-clean": 18.7, "test-other": 38.78}
                # ("train-clean-100-max-10s", 0, 50, (500, 1000, 2000), [0.7, 0.8, 0.9, 1.0, 1.1], (500, 1000, 2000)),
                # "50": {"dev-clean": 17.8, "dev-other": 36.75, "test-clean": 18.7, "test-other": 38.78}
                # ("train-clean-100-max-10s", 0, 50, (100, 500, 1000), [0.7, 0.8, 0.9, 1.0, 1.1], (100, 500, 1000)),
                # "50": {"dev-clean": 18.72, "dev-other": 38.13, "test-clean": 19.42, "test-other": 39.78}
                # ("train-clean-100-max-10s", 0, 50, (0, 500, 1000), [0.7, 0.8, 0.9, 1.0, 1.1], (0, 500, 1000)),
                # "50": {"dev-clean": 18.72, "dev-other": 38.13, "test-clean": 19.42, "test-other": 39.78}
                # ("train-clean-100-max-10s", 0, 100, (1000, 2000, 3000), [0.7, 0.8, 0.9, 1.0, 1.1], (1000, 2000, 3000)),
                # "200": {"dev-clean": 24.24, "dev-other": 41.25, "test-clean": 25.12, "test-other": 42.82}
                # ("train-clean-100-max-10s", 0, 200, (1000, 2000, 3000), [0.7, 0.8, 0.9, 1.0, 1.1], (1000, 2000, 3000)),
                # "50": {"dev-clean": 18.1, "dev-other": 38.52, "test-clean": 19.0, "test-other": 40.64}
                # ("train-clean-100-max-10s", 0, 50, (5000, 15000, 25000), [0.7, 0.8, 0.9, 1.0, 1.1, 1.2], (5000, 15000, 25000)),
                # "50": {"dev-clean": 17.19, "dev-other": 36.09, "test-clean": 18.13, "test-other": 38.31}
                # ("train-clean-100-max-10s", 0, 50, (1000, 2000, 3000), [0.7, 0.8, 0.9, 1.0, 1.1, 1.2], (1000, 2000, 3000)),
                # "40": {"dev-clean": 18.24, "dev-other": 37.55, "test-clean": 18.78, "test-other": 39.88}
                # ("train-clean-100-max-10s", 0, 40, (1000, 2000, 3000), [0.7, 0.8, 0.9, 1.0, 1.1], (1000, 2000, 3000)),
                # "30": {"dev-clean": 21.88, "dev-other": 42.7, "test-clean": 22.47, "test-other": 44.86}
        ...
        #   },
        # ),
        #    f"sup-5best-v1/peak-lr-1e-3_init-{train_ds_str}_{n_epochs}-epochs_specaug-{specaugment_steps}_speedpert-{speed_pert_discrete_values}/specaug-self-{specaugment_steps_self}")
        #   for train_ds_str, n_self_train, n_epochs, specaugment_steps, speed_pert_discrete_values, specaugment_steps_self
        #   in [
        #     ("100h", 4, 50, (5000, 15000, 25000), [0.7, 0.8, 0.9, 1.0, 1.1], (5000, 15000, 25000)),
        #   ]
        # ],
        ...
        *[(dict_update_deep(
           ...
           f"sup-max-wav2vec-large-lv60-v1/peak-lr-{peak_lr}_init-{train_ds_str}_{n_epochs}-epochs_frz-enc-{freeze_encoder_first_n_steps}")
            for train_ds_str, n_self_train, n_epochs, peak_lr, freeze_encoder_first_n_steps in [
                # 100h
                ("100h", 0, 2, 1e-3, 0),
                ("100h", 0, 4, 1e-3, 0),
                ("100h", 0, 8, 1e-3, 2_500),
                ("100h", 0, 10, 1e-3, 2_500),
                ("100h", 0, 15, 1e-3, 2_500),
                ("100h", 0, 20, 1e-3, 2_500),
                ("100h", 0, 25, 1e-3, 2_500),
                ("100h", 0, 25, 1e-4, 2_500),
                ("100h", 0, 50, 1e-4, 2_500),
                ("100h", 0, 50, 1e-3, 2_500),
                ("100h", 0, 100, 1e-3, 2_500),
                ("100h", 0, 100, 1e-4, 2_500),
                # 10h max 10s
                ("train-clean-100-max-10s", 0, 10, 1e-4, 0),
                ("train-clean-100-max-10s", 0, 25, 1e-4, 0),
                ("train-clean-100-max-10s", 0, 50, 1e-4, 0),
                ("train-clean-100-max-10s", 0, 100, 1e-4, 0),
            ]
        ],
        *[(dict_update_deep(
            copy.deepcopy(sup_max_config_v1),
           ...
           f"sup-max-wav2vec-large-lv60-v1_init-{train_ds_str}/peak-lr-{peak_lr}_{n_epochs}-epochs_hidden-dropout-{hidden_dropout}_att-dropout-{att_dropout}")
            for train_ds_str, n_self_train, n_epochs, peak_lr, hidden_dropout, att_dropout in [
                # 1h
                # "20": {"dev-clean": 100.0, "dev-other": 100.0, "test-clean": 100.0, "test-other": 100.0}
                # ("1h", 0, 20, 1e-3, 0.1, 0.1),  # underfitting
                # {"dev-clean": 12.17, "dev-other": 19.32, "test-clean": 12.48, "test-other": 19.46}
                # ("1h", 0, 25, 1e-3, 0.1, 0.1),
                # "27": {"dev-clean": 37.93, "dev-other": 43.43, "test-clean": 39.37, "test-other": 43.63}
                # ("1h", 0, 27, 1e-3, 0.1, 0.1),
                # "30": {"dev-clean": 10.39, "dev-other": 18.17, "test-clean": 10.56, "test-other": 18.7}
                ("1h", 0, 30, 1e-3, 0.1, 0.1),
                # "40": {"dev-clean": 13.92, "dev-other": 24.66, "test-clean": 14.31, "test-other": 25.08}
                # ("1h", 0, 40, 1e-3, 0.1, 0.1),  # overfitting
                # {"dev-clean": 14.68, "dev-other": 25.33, "test-clean": 15.22, "test-other": 26.7}
                # ("1h", 0, 40, 1e-3, 0.11, 0.11),
                # "40": {"dev-clean": 13.29, "dev-other": 23.47, "test-clean": 13.88, "test-other": 24.03}
                # ("1h", 0, 40, 1e-3, 0.12, 0.12),
                # "40": {"dev-clean": 100.0, "dev-other": 100.0, "test-clean": 100.0, "test-other": 100.0}
                # ("1h", 0, 40, 1e-3, 0.13, 0.13),
                # "40": {"dev-clean": 100.0, "dev-other": 100.0, "test-clean": 100.0, "test-other": 100.0}
                # ("1h", 0, 40, 1e-3, 0.2, 0.2),
                # "40": {"dev-clean": 59.21, "dev-other": 64.18, "test-clean": 60.21, "test-other": 63.1}
                # ("1h", 0, 40, 1e-3, 0.3, 0.3),
                # "80": {"dev-clean": 19.12, "dev-other": 30.42, "test-clean": 20.01, "test-other": 30.99}
                # ("1h", 0, 80, 1e-3, 0.1, 0.1),  # overfitting
            ]
        ],
        *[(dict_update_deep(
            copy.deepcopy(sup_max_config_v1),
           ...
           f"sup-max-wav2vec-large-lv60-v1_init-{train_ds_str}/peak-lr-{peak_lr}_init-{train_ds_str}_{n_epochs * repeat_epoch}-epochs")
            for train_ds_str, n_self_train, n_epochs, peak_lr, layer_dropout, mask_feature_prob, mask_feature_length, mask_time_prob, repeat_epoch in [
                # 10min
                # 80: {"dev-clean": 100.0, "dev-other": 100.0, "test-clean": 100.0, "test-other": 100.0}
                # ("10min", 0, 80, 1e-3, 0.0, 0.0, 10, 0.05, 1),  # underfitting
                # "160": {"dev-clean": 35.23, "dev-other": 43.53, "test-clean": 36.49, "test-other": 44.31}
                # ("10min", 0, 160, 1e-3, 0.0, 0.0, 10, 0.05, 1),
                # "33": {"dev-clean": , "dev-other": , "test-clean": , "test-other": }
                ("10min", 0, 100, 1e-3, 0.1, 0.008, 64, 0.075, 33),
            ]
        ],
        *[(dict_update_deep(
            copy.deepcopy(wav2vec_large_lv60_config_9h_v1),
    ...
    for train_config, alias_name in train_configs:
        ...
        num_shards_pseudo = train_config.get("num_shards_pseudo", None)

        # training hyperparameters
        hidden_dropout = train_config.get("hidden_dropout", None)
        att_dropout = train_config.get("att_dropout", None)
        layer_dropout = train_config.get("layer_dropout", None)
        mask_feature_prob = train_config.get("mask_feature_prob", None)
        mask_feature_length = train_config.get("mask_feature_length", None)
        mask_time_prob = train_config.get("mask_time_prob", None)

        # dataset hyperparameters
        repeat_epoch = train_config.get("repeat_epoch", 1)
        ...
        hyperparameters_self_training_updates = train_config.get("hyperparameters_self_training_updates", [])
        ...
        pseudo_nbest = train_config.get("pseudo_nbest", 1)
        self_training_rounds = train_config.get("self_training_rounds", 0)
        speed_pert = train_config.get("speed_pert", True)
        speed_pert_discrete_values = train_config.get("speed_pert_discrete_values", [0.7, 0.8, 0.9, 1.0, 1.1])
        use_tensorboard = train_config.get("use_tensorboard", False)
        if use_tensorboard:
            config_updates["use_tensorboard"] = True

        specaugment_steps = train_config.get("specaugment_steps", None)
        if specaugment_steps is not None:
            assert isinstance(specaugment_steps, tuple) and len(
                specaugment_steps) == 3, "specaugment_steps should be a list of 3 elements"
            config_updates["specaugment_steps"] = specaugment_steps
        specaugment_steps_self = train_config.get("specaugment_steps_self", None)
        ...
        def _get_lr_config(lr_schedule_type: str, epochs: int, peak_lr: float, bs_feat: int):
        ...
        lr_config = _get_lr_config(lr_schedule_type, epochs, peak_lr, bs_feat)

        if self_training_rounds > 0:
            self_epochs = train_config.get("self_epochs", None)
            if self_epochs is None:
        ...
        if decoding_imp == "marten-greedy":
            ...
            if self_training_rounds > 0:
                hyperparamters_self_training = []
            else:
                hyperparamters_self_training = None

            for i in range(self_training_rounds):
                hyperparamters_self_training.append(copy.deepcopy(decoder_hyperparameters))
                hyperparamters_self_training[i].update(hyperparameters_self_training_updates[i])

            # if alt_decoder:
            #   # alt_decoder_hyperparameters_updates
        ...
        if use_w2v_model:
            ...
            if train_config.get("ignore_params_prefixes", None) is not None:
                config_updates["preload_from_files"]["wav2vec2_base"]["ignore_params_prefixes"] = train_config[
            ...
            if train_config.get("freeze_encoder_first_n_steps", 2_500) != 2_500:  # 4 GPUS, otherwise: 10_000
                ...
                pass
            if train_config.get("unfrozen_encoder_layers", None) is not None and w2v_opts[
                'freeze_encoder_first_n_steps'] > 0:
            ...
            if hidden_dropout is not None and hidden_dropout != 0.1:
                w2v_opts["hidden_dropout"] = hidden_dropout
            if att_dropout is not None and att_dropout != 0.1:
                w2v_opts["att_dropout"] = att_dropout

            # layer_dropout = train_config.get("layer_dropout", None)
            # mask_feature_prob = train_config.get("mask_feature_prob", None)
            # mask_feature_length = train_config.get("mask_feature_length", None)
            # mask_time_prob = train_config.get("mask_time_prob", None)
            if layer_dropout is not None and layer_dropout != 0.0:
                w2v_opts["layer_dropout"] = layer_dropout
            if mask_feature_prob is not None and mask_feature_prob != 0.0:
                w2v_opts["mask_feature_prob"] = mask_feature_prob
            if mask_feature_length is not None and mask_feature_length != 10:
                w2v_opts["mask_feature_length"] = mask_feature_length
            if mask_time_prob is not None and mask_time_prob != 0.05:
                w2v_opts["mask_time_prob"] = mask_time_prob
        ...
        if self_training_rounds > 0:
            ...
            if specaugment_steps_self is not None:
                assert isinstance(specaugment_steps_self, tuple) and len(
                    specaugment_steps_self) == 3, "specaugment_steps_self should be a list of 3 elements"
                config_updates_self_training["specaugment_steps"] = specaugment_steps_self
            ...
            if not reset_steps:
                ...
                #     peak_lr = 5e-4
                #     config_updates_self_training["learning_rate_piecewise_values"] = [peak_lr * 2e-2, peak_lr,
                #                                                                       peak_lr * 2e-2,
                #                                                                       peak_lr * 2e-3]
                # LR_str = "_LR2-6e4"
                # else:
                ...
                #     peak_lr = 1e-3
                #     config_updates_self_training["learning_rate_piecewise_values"] = [peak_lr * 1e-2, peak_lr,
                #                                                                       peak_lr * 1e-2,
                #                                                                       peak_lr * 1e-3]
                #     LR_str = "_LRwu-e3"
                # add something to hash so first training is different and correct epochs are saved

                # why should this be in the config?
        ...
        train_exp(
            ...
            hyperparamters_self_training=hyperparamters_self_training if self_training_rounds > 0 else None,
...
def train_exp(
    ...
    if config_updates.get("decode_every_step", False):
        ...
        if config_updates.get("start_with_prior_gamma_steps", 0) > 0 and label_prior:
            config_updates["frame_prior"] = get_prior_from_unigram(task.prior_dataset.vocab, task.prior_dataset, vocab,
                                                                   False)
    ...
    if model_config:
        ...
        if "train_language_model" in mc:
            if (not config.get("decode_every_step", False) and not use_sum_criterion) or mc["train_language_model"][
                "class"] == "ngram":
    ...
    if tune_hyperparameters and tune_version >= 2:
        ...
        dec_params = decoder_hyperparameters[0] if isinstance(decoder_hyperparameters,
                                                              tuple) else decoder_hyperparameters
        ...
        if config_updates_self_training and "hyperparameters_decoder" in config_updates_self_training:
            ...
            if config_updates_self_training["hyperparameters_decoder"]["lm_order"] != decoder_hyperparameters[
                "lm_order"]:
                assert train_lm is not None
                dec_params_train = config_updates_self_training["hyperparameters_decoder"]
                prior_tune_train, lm_tune_train = _tune_prior_and_lm(label_prior, task, emp_prior, search_config,
                                                                     train_lm,
    ...
    if hyperparamters_self_training is not None and isinstance(hyperparamters_self_training, tuple):
        pst = hyperparamters_self_training[0]
    elif isinstance(hyperparamters_self_training, list):
        pst = hyperparamters_self_training[0]
    else:
        pst = hyperparamters_self_training

    def _get_decoding_alias():
        lm_scale, prior_scale = decoder_hyperparameters.get("lm_weight", None), decoder_hyperparameters.get(
            "prior_weight", None)
    ...
    recog_training_exp(
        ...
        exclude_epochs=sorted(list(model_with_checkpoint[0].fixed_epochs))[
            :-1] if not decode_all_fixed_epochs_init else (),
    ...
    if calc_last_pseudo_labels or self_training_rounds > 0:
        if isinstance(model_with_checkpoint[0], ModelWithCheckpoint):
            pseudo_label_model = model_with_checkpoint[0]
        else:
            assert isinstance(model_with_checkpoint[0], ModelWithCheckpoints)
            pseudo_label_model = model_with_checkpoint[0].get_last_fixed_epoch()
    ...
    if self_training_rounds > 0:
        ...
        assert isinstance(hyperparamters_self_training, list) and len(
            hyperparamters_self_training) == self_training_rounds

    # Do self training on pseudo labels
    for i in range(self_training_rounds):
        assert pseudo_label_path_dict is not None, "Pseudo label path is not set"

        hyperparamters_self_training_ = hyperparamters_self_training[i]
        ...
        if tune_hyperparameters:
            ...
            # tune parameters for decoding
            dec_params = hyperparamters_self_training_[0] if isinstance(hyperparamters_self_training_,
                                                                        tuple) else hyperparamters_self_training_
            prior_tune, lm_tune = _tune_prior_and_lm(label_prior, task, emp_prior, search_config, recog_lm,
                                                     model_with_checkpoint[i + 1].get_last_fixed_epoch(), vocab_file,
                                                     vocab_opts_file, vocab_w_blank_file,
                                                     prefix_self_training + "/tune",
                                                     dec_params, 128)
            dec_params["prior_weight"] = prior_tune
            dec_params["lm_weight"] = lm_tune
            scales = {"lm_weight": lm_tune}
            ...
            if "hyperparameters_decoder" in config_updates_self_training:
                assert not isinstance(hyperparamters_self_training_, tuple)
                if config_updates_self_training["hyperparameters_decoder"]["lm_order"] != hyperparamters_self_training_[
                    "lm_order"]:
                    dec_params_train = config_updates_self_training["hyperparameters_decoder"]
                    prior_tune_train, lm_tune_train = _tune_prior_and_lm(label_prior, task, emp_prior, search_config,
                                                                         train_lm,
                                                                         model_with_checkpoint[
                                                                             i + 1].get_last_fixed_epoch(),
                                                                         vocab_file, vocab_opts_file,
                                                                         vocab_w_blank_file,
                                                                         prefix_self_training + "/tune_train",
                                                                         dec_params_train,
                                                                         128)
                    config_updates_self_training["hyperparameters_decoder"]["prior_weight"] = prior_tune_train
                    config_updates_self_training["hyperparameters_decoder"]["lm_weight"] = lm_tune_train
                    ...
                    config_updates_self_training["hyperparameters_decoder"]["prior_weight"] = prior_tune
                    config_updates_self_training["hyperparameters_decoder"]["lm_weight"] = lm_tune
            elif isinstance(hyperparamters_self_training_, tuple):
                if hyperparamters_self_training_[1]["lm_order"] != hyperparamters_self_training_[0]["lm_order"]:
                    dec_params_train = hyperparamters_self_training_[0]
                    prior_tune_train, lm_tune_train = _tune_prior_and_lm(label_prior, task, emp_prior, search_config,
                                                                         train_lm,
                                                                         model_with_checkpoint[
                                                                             i + 1].get_last_fixed_epoch(),
                                                                         ...
                                                                         dec_params_train,
                                                                         128)
                    hyperparamters_self_training_[1]["prior_weight"] = prior_tune_train
                    hyperparamters_self_training_[1]["lm_weight"] = lm_tune_train
                else:
                    hyperparamters_self_training_[1]["prior_weight"] = prior_tune
                    hyperparamters_self_training_[1]["lm_weight"] = lm_tune

        sc = search_config.copy()
        if isinstance(hyperparamters_self_training_, tuple):
            hst = (hyperparamters_self_training_[0].copy(), hyperparamters_self_training_[1])
            if hst[0].get("keep_best_decoding", False):
                hst[0].pop("keep_best_decoding")
                sc["__prev_hyps"] = pseudo_label_path_dict
        else:
            hst = hyperparamters_self_training_.copy()
...
def model_recog_lm(
    ...
    return recog_flashlight_ngram(model=model, data=data, data_spatial_dim=data_spatial_dim,
                                  arpa_4gram_lm=arpa_4gram_lm,
