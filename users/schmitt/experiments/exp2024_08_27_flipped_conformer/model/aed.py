...
from .encoder.global_ import GlobalConformerEncoder
from .encoder.ff import LinearEncoder
...
class AEDModel(rf.Module):
  def __init__(
    ...
    enc_disable_self_attention = encoder_opts.pop("disable_self_attention", {})
    ...
    if enc_disable_self_attention:
      # Disable self-attention in encoder.
      from .disable_self_att import apply_disable_self_attention_

      apply_disable_self_attention_(self.encoder, enc_disable_self_attention)
