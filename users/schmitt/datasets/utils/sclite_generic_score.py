...
def sclite_score_recog_out_to_ref(
    recog_output: RecogOutput,
    *,
    ref: RecogOutput,
    corpus_name: str,
    sclite_additional_args: Optional[List[str]] = None,
) -> ScoreResult:
    """
    score
...
def sclite_score_hyps_to_ref(
    hyps_text_dict: tk.Path,
    *,
    ref_text_dict: tk.Path,
    corpus_name: str = "<undefined-corpus-name>",
    sclite_additional_args: Optional[List[str]] = None,
) -> ScoreResult:
    """
    score
    ...
    score_job = ScliteJob(
        ...
        precision_ndigit=2,
        additional_args=sclite_additional_args,
    )
