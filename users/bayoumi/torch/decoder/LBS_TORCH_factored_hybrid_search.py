__all__ = ["LBSTorchFactoredHybridDecoder"]
...
from i6_experiments.users.raissi.torch.decoder.TORCH_factored_hybrid_search import (
    TORCHFactoredHybridDecoder,
)

class LBSFactoredHybridDecoder(TORCHFactoredHybridDecoder):
    def __init__(
        self,
        name: str,
