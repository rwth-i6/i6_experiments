...
from i6_experiments.users.raissi.torch.nick_example_recipes.pytorch_networks.ctc.conformer_new.i6modelsV1_VGG4LayerActFrontendV1_v6_onnx_exportable import LogMelFeatureExtractionV1OnnxExportable
...
class Model(torch.nn.Module):
    def __init__(self, model_config_dict, **kwargs):
        ...
        self.final_linear = nn.Linear(conformer_size, self.cfg.label_target_size)
