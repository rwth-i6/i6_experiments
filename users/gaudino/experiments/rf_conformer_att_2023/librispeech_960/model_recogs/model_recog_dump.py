    ...
    while True:
        ...
        if model.search_args["use_ctc"]:
            ...
            ctc_prefix_scores, ctc_state = ctc_prefix_scorer(
                ...
                last_ids=target_ctc,
                state=ctc_state,
                att_w=att_weights if model.search_args["window_margin"] > 0 else None,
            )
            ...
            label_log_prob = (
                label_log_prob + model.search_args["ctc_scale"] * ctc_prefix_scores
            )
...
# RecogDef API
model_recog_dump: RecogDef[Model]
model_recog_dump.output_with_beam = True
model_recog_dump.output_blank_label = "<blank>"
model_recog_dump.batch_size_dependent = False
