...
Used to train attention models on Librispeech 960h
Includes the recognition with the newly trained models

Check alberts code for the tuning of the training parameters he did to get the dev 5.4 model.

I broke some hashes so part of the code I used is commented out.

Also tried training ILMs here but they did not converge.

This file is very long and includes also the Model definition and the training and recognition logic.
"""
...
def sis_run_with_prefix(prefix_name: Optional[str] = None):
    ...
    # recogs with bpe 10k ATT/CTC model
    ...
    # recogs with bpe 10k noCTC model
