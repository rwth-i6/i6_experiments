...
from i6_experiments.users.zeyer.lr_schedules.lin_warmup_invsqrt_decay import (
    dyn_lr_lin_warmup_invsqrt_decay,
)
from i6_experiments.users.zeyer.lr_schedules.piecewise_linear import (
...
my_config_11gb = config_11gb.copy()
my_config_11gb.update(
    dict(
...
_lrlin_oclr_steps_by_bs_nep = {
    (8, 125): [
        ...
        279_000,
        310_000,
    ],  # ~2485steps/ep, 125 eps -> 310k steps in total
    (8, 250): [
        279_000,
        558_000,
        621_000,
    ],  # ~2485steps/ep, 250 eps -> 621k steps in total
    (8, 500): [
        558_000,
        1_117_000,
        1_242_000,
    ...
    (20, 2000): [
        ...
        1_757_000,
        1_952_000,
    ],  # total steps after 2000 epochs: 1.952.394
    (30, 2000): [
        587_000,
        1_174_000,
        1_305_000,
...
def _get_cfg_lrlin_oclr_by_bs_nep(
    bs_feat: int, n_ep: int, *, peak_lr: float = 1e-3
) -> Dict[str, Any]:
    """
    ...
    return {
        ...
        "learning_rate_piecewise_steps": _lrlin_oclr_steps_by_bs_nep[
            (bs_feat // 1000, n_ep)
        ],
        "learning_rate_piecewise_values": [
            peak_lr * 1e-2,
            peak_lr,
            peak_lr * 1e-2,
            peak_lr * 1e-3,
