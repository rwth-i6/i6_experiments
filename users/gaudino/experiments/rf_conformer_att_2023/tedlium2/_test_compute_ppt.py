...
from i6_experiments.users.gaudino.experiments.rf_conformer_att_2023.tedlium2.lm_import_2023_11_09 import MakeModel
from i6_experiments.users.gaudino.experiments.rf_conformer_att_2023.tedlium2.model_forward_lm import model_forward_lm

from i6_experiments.users.gaudino.experiments.rf_conformer_att_2023.search_data_opts import \
    search_data_opts_ted2 , search_data_opts_librispeech960
...
def test_compute_perplexity():
    ...
    print("Out spatial dim:", seq_targets.dims[1], seq_targets.dims[1].get_size_tensor().raw_tensor)
    breakpoint()
