...
Code for training new models on Tedlium 2.
I did not get the same as the tensorlfow baseline.
But did not tune too much. Actually did not know what to tune.
...
def sis_run_with_prefix(prefix_name: Optional[str] = None):
    ...
    #     "base-11gb-v3-lrlin8e_5_261k_aux4_8",
    #     my_config_11gb,
    #     config_updates={
    #         "learning_rate": 1.0,
    #         "dynamic_learning_rate": dyn_lr_piecewise_linear,
    ...
    # train_exp( # does not converge
    #     "base-11gb-v3-lrlin8e_5_lrmax8e_4_261k",
    #     my_config_11gb,
    #     config_updates={
    #         "learning_rate": 1.0,
    #         "dynamic_learning_rate": dyn_lr_piecewise_linear,
