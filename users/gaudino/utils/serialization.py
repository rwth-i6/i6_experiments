...
def get_import_native_ops_code() -> str:
    root_path = os.path.join(gs.BASE_DIR, "i6_native_ops")
    # root_path = os.path.join(gs.BASE_DIR, gs.RECIPE_PREFIX, "i6_native_ops")
    return f"sys.path.insert(0, {root_path!r})\n"
