...
from .streaming_conformer import Model as StreamingConformer
...
from .streaming_conformer_v2_cfg import ModelConfig
...
class Model(nn.Module):
    ...
    def forward(
        ...
        conformer_out, out_mask = self.conformer(conformer_in, mask, lookahead_size=self.lookahead_size)  # (B, N, C', F')
