...
from ..conformer_2.conformer_vrnn_parallel import (
    Mode,
    ConformerVRNNEncoderV1,

    ConformerEncoderV3Config,
    VRNNV1Config
)
...
from .vrnn_transducer_cfg import ModelConfig
...
class Model(nn.Module):
    def __init__(self, model_config_dict, **kwargs):
        ...
        conformer_config = ConformerEncoderV3Config(
            num_layers=self.cfg.num_layers,
            frontend=frontend,
            vrnn_config=VRNNV1Config(
                input_dim=self.cfg.conformer_size,
                dropout=self.cfg.vrnn_dropout,
                activation=self.cfg.vrnn_activation,
            ),
        ...
        self.conformer = ConformerVRNNEncoderV1(cfg=conformer_config)
    ...
    def forward(
        ...
        conformer_outs = self.conformer(conformer_in, mask, lah_size_frames)
