...
from .conf_dual_0525_v1 import StreamableFeatureExtractorWithAmplitudePerturbation
...
class Model(nn.Module):
    def __init__(self, model_config_dict: ModelConfig, **kwargs):
        ...
        self.feature_extraction = StreamableFeatureExtractorWithAmplitudePerturbation(
