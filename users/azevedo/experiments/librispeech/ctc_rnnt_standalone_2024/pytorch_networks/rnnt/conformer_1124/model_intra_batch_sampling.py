...
from ..conformer_0924.uni_lah_carryover_cfg import ModelConfig
...
from ..conformer_0924.conformer_uni_lah_carryover import ConformerEncoderCOV1
from .conf_intra_batch_sampling import ConformerEncoderInBatchSamplingV1
...
def train_step(*, model: Model, data, run_ctx, **kwargs):
    ...
    if ctc_logprobs is not None:
        ...
        run_ctx.mark_as_loss(name="ctc.smpl", loss=ctc_loss, inv_norm_factor=num_phonemes,
                             scale=model.cfg.ctc_output_loss)

    run_ctx.mark_as_loss(name="rnnt.smpl", loss=rnnt_loss, inv_norm_factor=num_phonemes)
