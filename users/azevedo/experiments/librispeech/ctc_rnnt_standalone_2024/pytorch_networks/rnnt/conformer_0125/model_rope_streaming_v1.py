...
from ..conformer_0924.uni_lah_carryover_cfg import ModelConfigV2 as ModelConfig
...
from .conf_rope_streaming_v1 import ConformerRoPEEncoderV1COV1
...
from ..auxil.functional import num_samples_to_frames, Mode, TrainingStrategy
...
class Model(torch.nn.Module):
    def __init__(self, model_config_dict, **kwargs):
        ...
        self.conformer = ConformerRoPEEncoderV1COV1(cfg=conformer_config)
...
def train_step(*, model: Model, data, run_ctx, **kwargs):
    ...
    if model.cfg.training_strategy == TrainingStrategy.UNIFIED:
        ...
        mode = Mode.STREAMING if TrainingStrategy.STREAMING else Mode.OFFLINE
        loss_dict = _train_step_mode(mode, scale=1)
