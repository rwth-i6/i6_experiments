...
from i6_experiments.users.azevedo.experiments.librispeech.ctc_rnnt_standalone_2024.pytorch_networks.rnnt.conformer_2.conformer_v2 import (
    ConformerEncoderV2
)
...
from .i6modelsV1_VGG4LayerActFrontendV1_v9_cfg import ModelConfig
...
class Model(nn.Module):
    def __init__(self, model_config_dict, **kwargs):
        ...
        conformer_config = ConformerEncoderV1Config(
            ...
            # creates the provided module_class (VGG4LayerActFrontendV1) based on the config
        ...
        self.chunk_ranges_weights: Optional[torch.Tensor] = torch.tensor(kwargs.get("chunk_ranges_weights", [])).float()
    ...
    def get_chunk_size(self, **kwargs):
        if self.chunk_ranges_weights.numel() > 0:   
            ...
            return sample_chunk_size(self.chunk_ranges_weights, chunk_ranges, self.choose_seq_len_p)
    ...
    def forward(
        ...
        chunk_size = self.get_chunk_size(raw_audio=raw_audio)
