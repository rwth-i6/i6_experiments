...
from .model_uni_lah_co_prefrontendlah_v1 import (
    Model as UnifiedPreLAHCOTransducer,
    Mode
)
...
class Model(UnifiedPreLAHCOTransducer):
...
def train_step(*, model: Model, data, run_ctx, **kwargs):
    ...
    scale = 1  # no online model scale used in vanilla streaming model
