...
class ConformerEncoderCOPreLAHV1(torch.nn.Module):
    ...
    def forward(
        self, data_tensor: torch.Tensor, sequence_mask: torch.Tensor, lookahead_size: Optional[float],
        carry_over_size: int, mode: Mode
        ...
        for module in self.module_list:
            # NOTE: offline mode also has LAH (unnecessary but easier)
