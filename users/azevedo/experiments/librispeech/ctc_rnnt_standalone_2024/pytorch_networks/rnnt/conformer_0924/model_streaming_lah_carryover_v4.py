...
from .uni_lah_carryover_cfg import ModelConfigV2 as ModelConfig
...
from .conf_lah_carryover_v3 import ConformerEncoderCOV3
...
class Model(torch.nn.Module):
    def __init__(self, model_config_dict, **kwargs):
        ...
        self.conformer = ConformerEncoderCOV3(cfg=conformer_config)
