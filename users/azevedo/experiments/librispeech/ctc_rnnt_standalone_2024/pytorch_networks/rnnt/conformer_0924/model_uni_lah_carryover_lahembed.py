...
from .uni_lah_carryover_cfg import ModelConfig
...
from .conformer_uni_lah_carryover_lahembed import ConformerEncoderCOLAHEmbedV1, ConformerEncoderV1Config
...
from ..auxil.functional import num_samples_to_frames, mask_tensor, Mode
...
class Model(torch.nn.Module):
    def __init__(self, model_config_dict, **kwargs):
        ...
        self.conformer = ConformerEncoderCOLAHEmbedV1(cfg=conformer_config)
