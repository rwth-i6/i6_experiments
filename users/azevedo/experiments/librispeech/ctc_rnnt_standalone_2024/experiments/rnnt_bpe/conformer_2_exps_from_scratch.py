...
def rnnt_bpe_ls960_1023_low_bpe_from_scratch_v2():
    prefix_name = "experiments/librispeech/ctc_rnnt_standalone_2024/ls960_ctv2_low_bpe_from_scratch"
    ...
    for BPE_SIZE in [128, ]:
        ...
        model_config_v5_sub4_512lstm = ModelConfig(
            ...
            ff_dropout=0.1,
            mhsa_dropout=0.1,
            conv_kernel_size=11,        # NOTE: changed this from 31
            final_dropout=0.1,
        ...
        train_args_11gb = {
            ...
            "net_args": {
                "model_config_dict": asdict(model_config_v5_sub4_512lstm),
                #"min_chunk_size": 0.15*16000,
                #"chunk_ranges_weights": [5, 2, 1, 0, 1, 0, 0, 0, 0],
                #"choose_seq_len_p": 0.2,
                "chunk_size": int(CHUNK_SIZE*16e3)
            },
        ...
        training_name = (
            ...
            "/" + network_module + "/" + str(CHUNK_SIZE) +
            "/" ".512dim_sub4_11gbgpu_25eps_from_scratch_radamv1_streamingv2"
        )
        ...
        # prep asr model for checkpoint 250
        asr_model = prepare_asr_model(
            training_name, train_job, train_args_11gb, with_prior=False,
