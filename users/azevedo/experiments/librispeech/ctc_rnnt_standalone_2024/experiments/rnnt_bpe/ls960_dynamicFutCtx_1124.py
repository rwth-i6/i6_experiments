...
def get_train_config(model_config, keep, accum_grads=1,  **kwargs):
    ...
    network_module = "rnnt.conformer_1124.model_dynamicFutCtx_v1"
...
def run_experiments(**kwargs):
    prefix_name = "experiments/librispeech/ctc_rnnt_standalone_2024/ls960_dynamicFutCtx_low_bpe_from_scratch"
    ...
    from ...pytorch_networks.rnnt.conformer_1124.model_dynamicFutCtx_v1_cfg import ModelConfig
    ...
    for experiment in experiments_config:
        ...
        for param_combi in param_combinations:
            model_config = ModelConfig(
                ...
                aggr_num_layers=1,
                aggr_lstm_dim=512,
                aggr_lstm_dropout=0.1,
                aggr_ff_dim=256,
                aggr_weights_dropout=0.1,
                aggr_attn_heads=4,
                aggr_bias=True,
                aggr_noise_std=1,

                avg_fut_latency=8,   # NOTE: this is in subs. frames (60ms)
            )
            ...
            training_name = (
                ...
                "%deps_" % (num_epochs//10) +
                "from_scratch_radamv1_specaug%d" % model_config.specauc_start_epoch + "/" +
...
def rnnt_bpe_ls960_1124_dynamicfutctxencoder():
    experiment_configs = {
        # 10: {
        #     "model_params": {
        #         "chunk_size": [2.4],# 1.2],
