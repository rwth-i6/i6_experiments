...
def streaming_ct_bpe_ls960_1023_low_bpe_from_scratch_DEPR():
    prefix_name = "experiments/librispeech/ctc_rnnt_standalone_2024/ls960_streaming_ct_low_bpe_from_scratch_DEPR"
    ...
    for CHUNK_SIZE, BPE_SIZE in product([2.72], [128, ]):   # [128, 512]
        ...
        model_config_v5_sub4_512lstm_mod = copy.deepcopy(model_config_v5_sub4_512lstm)
        model_config_v5_sub4_512lstm_mod.conv_kernel_size = 9
        ...
        network_module = "rnnt.conformer_1023.i6modelsV1_VGG4LayerActFrontendV1_i6_streamingv2"
        train_args_11gb = {
            "config": train_config_11gbgpu,
            "network_module": network_module,
            "net_args": {
                "model_config_dict": asdict(model_config_v5_sub4_512lstm_mod),
        ...
        training_name = (
            ...
            "/" + network_module + ".512dim_sub4_11gbgpu_25eps_from_scratch_radamv1_chunk_aware_1keps"
        )

        train_job_1k = training(training_name, train_data_bpe, train_args_11gb,
                                num_epochs=1000, **default_returnn)
        train_job_1k.rqmt["gpu_mem"] = 11
        train_job_1k.set_env("PYTORCH_CUDA_ALLOC_CONF", "expandable_segments:True")
        asr_model_1k = prepare_asr_model(
            training_name, train_job_1k, train_args_11gb, with_prior=False,
