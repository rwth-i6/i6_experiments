...
def switching_unified_lookahead_ls960_1023_low_bpe_from_scratch():
    prefix_name = "experiments/librispeech/ctc_rnnt_standalone_2024/ls960_switching_unified_lookahead_low_bpe_from_scratch"
    ...
    for CHUNK_SIZE, BPE_SIZE in product([0.5, 1.0, 2.72], [128, ]):   # [128, 512]
        ...
        for LOOKAHEAD in [3]:
            ...
            network_module = "rnnt.streaming_conformer.switching_unified_lah_transducer"
            ...
            for KERNEL_SIZE in [31, 7, 3]:
                ...
                training_name = (
                    ...
                    "/" + network_module + ".512dim_sub4_11gbgpu_25eps_from_scratch_radamv1_switching_unified_lah" +
