...
def get_train_config(model_config, keep, accum_grads=1,  **kwargs):
    ...
    network_module = "rnnt.streaming_conformer.vrnn_transducer_parallel"
...
def run_experiments(**kwargs):
    prefix_name = "experiments/librispeech/ctc_rnnt_standalone_2024/ls960_vrnnt_v1_low_bpe_from_scratch"
    ...
    from ...pytorch_networks.rnnt.streaming_conformer.vrnn_transducer_cfg import ModelConfig
    ...
    for experiment in experiments_config:
        ...
        for param_combi in param_combinations:
            model_config = ModelConfig(
                ...
                vrnn_dropout=param_combi["vrnn_dropout"],
                vrnn_activation=param_combi["vrnn_activation"],
            )
            ...
            training_name = (
                ...
                "%deps_" % (num_epochs//10) +
                "from_scratch_radamv1_vrnnt_v1_relu_specaug%d" % model_config.specauc_start_epoch + "/" +
...
def vrnn_conf_transducer_ls960_1023_low_bpe_from_scratch():
    experiment_configs = {
        # 10: {
        #     "model_params": {
        #         "chunk_size": [2.4 * 16e3],
