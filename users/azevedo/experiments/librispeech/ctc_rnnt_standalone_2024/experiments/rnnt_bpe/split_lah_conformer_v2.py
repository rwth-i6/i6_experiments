...
def run_experiments(**kwargs):
    prefix_name = "experiments/librispeech/ctc_rnnt_standalone_2024/ls960_split_lookahead_low_bpe_from_scratch"
    ...
    for experiment in experiments_config:
        ...
        for param_combi in param_combinations:
            ...
            training_name = (
                ...
                ".512dim_sub6_24gbgpu" +
                "%deps_" % (num_epochs//10) +
                "from_scratch_radamv1_split_lah_specaug%d" % model_config.specauc_start_epoch + "/" +
...
def split_lookahead_ls960_1023_low_bpe_from_scratch_updated_configs():
    experiment_configs = {
        10: {
            "model_params": {
                "chunk_size": [2.4],
