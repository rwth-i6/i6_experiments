...
def run_experiments(**kwargs):
    prefix_name = "experiments/librispeech/ctc_rnnt_standalone_2024/ls960_prelah_co_low_bpe_from_scratch"
    ...
    def evaluate_helper(
        ...
        beam_size: int = 1,
        use_gpu=False,
        decoder_module: str = "rnnt.decoder.carryover_prelah_decoder"
    ):
        """
    ...
    from ...pytorch_networks.rnnt.conformer_0924.uni_lah_carryover_cfg import ModelConfigPrefrontendLAH as ModelConfig
    ...
    for experiment in experiments_config:
        ...
        for param_combi in param_combinations:
            ...
            training_name = (
                ...
                "%deps_" % (num_epochs//10) +
                "from_scratch_radamv1_prelah_specaug%d" % model_config.specauc_start_epoch + "/" +
...
def prelah_ls960_1023_low_bpe_from_scratch():
    experiment_configs = {
        # 0: {
        #     "model_params": {
        #         "chunk_size": [2.4 * 16e3],
        ...
        #     "network_module": "model_switching_lah_co_prefrontendlah_v1",
        #     "accum_grads": 1,
        #     "gpu_mem": 24,
        #     "num_epochs": 250,
        ...
        #     "model_params": {
        #         "chunk_size": [2.4 * 16e3],
        #         "lookahead_size": [sec * 16e3 for sec in [0.48, 1.0, 2.0]],  # 5.0, 1000.0]],
        #         "kernel_size": [31],
        #         "specauc_start_epoch": [11],
        #         "carry_over_size": [2],
        #     },
        ...
        15: {
            ...
            "network_module": "model_switching_lah_co_prefrontendlah_v2",
            "accum_grads": 1,
            "gpu_mem": 24,
            "num_epochs": 1000,
            "keep": [300, 400, 500, 600, 700, 800, 900, 950, 980]
        ...
        # 20: {
        #     "model_params": {
        #         "chunk_size": [sec * 16e3 for sec in [0.6, 1.2]],
        #         "lookahead_size": [sec * 16e3 for sec in [0.48, 1.0, 2.0]],
        #         "kernel_size": [31],
        #         "specauc_start_epoch": [11],
        #         "carry_over_size": [4],
        #     },
        ...
        # unified model with lah before feature extraction
        30: {
            "model_params": {
                "chunk_size": [2.4 * 16e3],
                "lookahead_size": [0.48 * 16e3],
            ...
            "network_module": "model_uni_lah_co_prefrontendlah_v2",
            "accum_grads": 2,
            "gpu_mem": 24,
            "num_epochs": 1000,
            "keep": [300, 400, 500, 600, 700, 800, 900, 950, 980]
        ...
        #     "network_module": "model_switching_prefrontendlahembed",
        #     "accum_grads": 2,
        #     "gpu_mem": 24,
        #     "num_epochs": 1000,
        #     "keep": [300, 400, 500, 600, 700, 800, 900, 950, 980]
