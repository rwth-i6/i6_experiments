...
def streaming_ct_ls960_1023_low_bpe_from_scratch():
    prefix_name = "experiments/librispeech/ctc_rnnt_standalone_2024/ls960_streaming_ct_low_bpe_from_scratch"
    ...
    from ...pytorch_networks.rnnt.streaming_conformer.streaming_conformer_cfg import (
        FastConformerFrontendV1Factory,
        FrontendLayerType,
    ...
    for CHUNK_SIZE, BPE_SIZE in product([0.5, 1.0, 2.72, 15.0], [128, ]):
        ...
        model_config_v5_sub4_512lstm = ModelConfigNew(
        ...
        network_module = "rnnt.streaming_conformer.streaming_conformer"
        ...
        for KERNEL_SIZE in [3, 7, 11, 31]:

            if CHUNK_SIZE in [2.72, 15.0] and (KERNEL_SIZE not in [3, 31]):
                continue
            ...
            training_name = (
                ...
                "/" + network_module + ".512dim_sub4_11gbgpu_25eps_from_scratch_radamv1_chunk_aware" +
            ...
            train_job.rqmt["gpu_mem"] = 24 if CHUNK_SIZE >= 10.0 else 11
