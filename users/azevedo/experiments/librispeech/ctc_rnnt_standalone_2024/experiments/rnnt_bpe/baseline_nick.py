...
def rnnt_bpe_ls960_1023_low_bpe():
    ...
    for BPE_SIZE in [128, 256, 512, 1024]:
        ...
        #     BPE_SIZE) + "/" + network_module + ".512dim_sub6_24gbgpu_25eps_accum2_fullspec1_continue_from_ctc50eps"
        # train_job = training(training_name, train_data_bpe, train_args_warprnnt_fullspec_from_ctc, num_epochs=250,
        #                      **default_returnn)
        # train_job.rqmt["gpu_mem"] = 24
        # train_job.set_env("PYTORCH_CUDA_ALLOC_CONF", "expandable_segments:True")
        # asr_model = prepare_asr_model(
        #     training_name, train_job, train_args_warprnnt_fullspec_from_ctc, with_prior=False, datasets=train_data_bpe,
        ...
        if BPE_SIZE == 128:
            ...
            # for keep in KEEP:
            #     asr_model = prepare_asr_model(
            #         training_name, train_job, train_args_warprnnt_fullspec_from_ctc100_noacumm_sp_morel2,
            #         with_prior=False,
            #         datasets=train_data_bpe, get_specific_checkpoint=keep
            #     )
            #     evaluate_helper(
            ...
            model_config_v6_sub6_512lstm_start11_full_spec = copy.deepcopy(
                model_config_v5_sub6_512lstm_start1_full_spec)
            model_config_v6_sub6_512lstm_start11_full_spec.ctc_output_loss = 0.3

            train_args_v2_warprnnt_fullspec_noacumm_morel2_radam = copy.deepcopy(
                train_args_warprnnt_fullspec_noacumm_morel2_radam)
            train_args_v2_warprnnt_fullspec_noacumm_morel2_radam["net_args"] = {
                "model_config_dict": asdict(model_config_v6_sub6_512lstm_start11_full_spec)}
            train_args_v2_warprnnt_fullspec_noacumm_morel2_radam["debug"] = True

            training_name = prefix_name + "/" + str(
                BPE_SIZE) + "/" + network_module + ".512dim_sub6_24gbgpu_100eps_accum1_gradclip_fullspec11_morel2_from_scratch_rerun"
            train_job = training(training_name, train_data_bpe, train_args_v2_warprnnt_fullspec_noacumm_morel2_radam,
            ...
            # With speed perturbation
            train_args_warprnnt_fullspec_noacumm_morel2_radam_sp = copy.deepcopy(
                train_args_warprnnt_fullspec_noacumm_morel2_radam)
            ...
            train_args_warprnnt_fullspec_noacumm_midpeak_sp_morel2_radam = copy.deepcopy(
                train_args_warprnnt_fullspec_from_ctc100_noacumm_sp_morel2)
            ...
            train_args_warprnnt_fullspec_noacumm_midpeak_sp_morel2_radam["config"]["optimizer"] = {"class": "radam",
                                                                                                   "epsilon": 1e-12,
                                                                                                   "weight_decay": 1e-2,
                                                                                                   "decoupled_weight_decay": True}
            ...
            model_config_v5_sub6_512lstm_start11_full_midpeak_spec = copy.deepcopy(
                model_config_v5_sub6_512lstm_start1_full_spec)
            ...
            train_args_warprnnt_fullspec_noacumm_midpeak_sp_morel2_radam["net_args"] = {
                "model_config_dict": asdict(model_config_v5_sub6_512lstm_start11_full_midpeak_spec)}

            training_name = prefix_name + "/" + str(
                BPE_SIZE) + "/" + network_module + ".512dim_sub6_24gbgpu_100eps_accum1_gradclip_fullspec11_midpeak_sp_longconst_morel2_from_scratch"
            train_job = training(training_name, train_data_bpe,
                                 train_args_warprnnt_fullspec_noacumm_midpeak_sp_morel2_radam,
                                 num_epochs=1000, **default_returnn)
            train_job.rqmt["gpu_mem"] = 24
            train_job.set_env("PYTORCH_CUDA_ALLOC_CONF", "expandable_segments:True")
            for keep in KEEP:
                asr_model = prepare_asr_model(
                    training_name, train_job, train_args_warprnnt_fullspec_noacumm_midpeak_sp_morel2_radam,
                    with_prior=False,
                    datasets=train_data_bpe, get_specific_checkpoint=keep
                )
                evaluate_helper(
        ...
        if BPE_SIZE == 512:
            ...
            model_config_v5_sub6_512lstm_start11_full_spec_bpe512 = copy.deepcopy(
                model_config_v5_sub6_512lstm_start11_full_spec)
            ...
            model_config_v5_sub6_512lstm_start11_full_spec_bpe512_larger = copy.deepcopy(
                model_config_v5_sub6_512lstm_start11_full_spec_bpe512)
