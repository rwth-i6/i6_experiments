...
def bpe_ls960_1023_unified_lah(chunk_size: float, lookahead_size: int, kernel_size: int):
    prefix_name = "example_setups/librispeech/ctc_rnnt_standalone_2024/ls960_ctc_bpe_5k_unified_lah"
    ...
    keep = [80, 150, 200, 300, 400, 450, 480, 500]
    accum_grads = 2
    train_config_24gbgpu_amp = {
        ...
        #############
        "batch_size": 360 * 16000 // accum_grads,  # GPU MEM still very moderate, but larger batch did not help
    ...
    training_name = (
        prefix_name + "/" + network_module + ".512dim_sub6_24gbgpu_50eps_unified_lah" +
