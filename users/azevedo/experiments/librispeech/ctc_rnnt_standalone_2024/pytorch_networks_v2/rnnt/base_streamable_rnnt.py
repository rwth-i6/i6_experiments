...
from .predictors.base_predictor import PredictorConfig, Predictor
from .joiners.base_joiner import StreamableJoinerConfig, StreamableJoiner
...
class StreamableRNNT(StreamableModule):
    def __init__(self, model_config_dict: Dict):
        ...
        self.joiner: StreamableJoiner = ModuleFactoryV1(
        ...
        # FIXME: is this correct? is already defined in feature extractor right?
