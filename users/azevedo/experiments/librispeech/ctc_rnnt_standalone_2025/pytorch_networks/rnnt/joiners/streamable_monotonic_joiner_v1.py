...
from .streamable_joiner_v1 import StreamableJoinerConfig
from ...base_config import BaseConfig


@dataclass(kw_only=True)
class StreamableMonotonicJoinerConfig(StreamableJoinerConfig):  # NOTE: StreamableJoinerConfig.from_dict needs to return cls

    def module(self):
        return StreamableMonotonicJoinerV1
...
class StreamableMonotonicJoinerV1(StreamableModule):
    ...
    def __init__(self, cfg: StreamableMonotonicJoinerConfig) -> None:
        super().__init__()
