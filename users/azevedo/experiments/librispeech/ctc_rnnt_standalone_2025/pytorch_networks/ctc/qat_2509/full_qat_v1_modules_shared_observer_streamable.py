"""
Fixes mhsa norm
adds streamable mhsa for streamable ctc models
"""
...
###############################################################################################################
# NOTE: now streamable
class QuantizedMultiheadAttentionStreamable(StreamableModule):
    def __init__(self, cfg: QuantizedMultiheadAttentionV4Config, soft_in_quant, soft_out_quant):
        super().__init__()
        self.cfg = cfg
        ...
        self.norm_out_quant = soft_in_quant
        ...
        self.soft_out_quant = soft_out_quant
