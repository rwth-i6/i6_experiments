...
class StreamableCTC(StreamableModule):
    def __init__(self, model_config_dict: Dict, **kwargs):
        ...
        self.encoder_out_linear = torch.nn.Linear(self.cfg.encoder.encoder_size, self.cfg.label_target_size + 1)
    ...
    def forward_offline(self, raw_audio: torch.Tensor, raw_audio_len: torch.Tensor):
        ...
        # encoder_out = self.final_dropout(encoder_out)
        logits = self.encoder_out_linear(encoder_out)
