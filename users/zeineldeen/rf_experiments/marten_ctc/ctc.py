...
def py():
    ...
    vocab = "bpe128"
    # vocab = "bpe10k"
    use_flashlight_ctc_decoder = True
    ...
    assert use_greedy != use_flashlight_ctc_decoder
    ...
    elif use_flashlight_ctc_decoder:
        decoder_hyperparameters = {
            "log_add": False,
            "nbest": 1,
            "beam_size": 12,
    ...
    train_exp(
        ...
        f"-{vocab}" + (greedy_str if use_greedy else (("-recog_lm" + lm_hyperparamters_str) if use_flashlight_ctc_decoder else "-recog_albert")),
        config_11gb_v6_f32_accgrad1_mgpu4_pavg100_wd1e_4,
        model_recog_lm if use_flashlight_ctc_decoder else model_recog,
...
def model_recog_lm(
    *,
    ...
    print(list(model.wb_target_dim.vocab.labels))
