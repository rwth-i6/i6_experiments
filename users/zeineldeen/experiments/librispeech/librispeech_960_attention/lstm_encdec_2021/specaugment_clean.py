from returnn_common.models.base import LayerRef, Module, Rec, get_extern_data, get_special_layer, ILayerMaker
...
def specaugment_eval_func(data, network,
                          min_frame_masks=1, mask_each_n_frames=100, max_frames_per_mask=20,
