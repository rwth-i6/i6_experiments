...
class DownloadLibriSpeechLongCorpusJob(Job):
    ...
    def __init__(self):
        ...
        self.out_corpus_folders = {corpus_key: self.output_path("%s" % corpus_key) for corpus_key in self.corpus_keys}
...
class LibriSpeechLongCreateBlissCorpusJob(Job):
    ...
    def run(self):
        ...
        for transcript in self._transcripts:
            ...
            recording.audio = "{0}/{1}_{2:04d}.flac".format(
                transcript["path"], transcript["chapter"], transcript["segment"]
            )
