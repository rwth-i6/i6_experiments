...
def conformer_baseline():
    ...
    # # TODO: mixup + wd
    # for reduce_dim_factor in [0.7]:
    #     for weight_drop in [0.0, 0.1, 0.2]:
    ...
    #                 }
    #
    #                 name = f"base3_conf_{12}l_lstm_1l_conv{6}_drop{drop}_wd{weight_drop}_ep{ep}_specaug3_initEp40_dimReduce{reduce_dim_factor}"
