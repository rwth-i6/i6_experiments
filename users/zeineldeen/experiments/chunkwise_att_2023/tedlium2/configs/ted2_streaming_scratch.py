...
def conformer_baseline():
    ...
    from i6_experiments.users.zeineldeen.experiments.chunkwise_att_2023.tedlium2.configs.ted2_streaming import (
        get_ctc_rna_based_chunk_alignments,
    )
    ...
    ctc_chunksync_align = get_ctc_rna_based_chunk_alignments(
        ...
        model_ckpt=None,  # will use best AED+CTC ckpt
    )
                    ...
                    for att_drop in [0.0]:
                        for weight_drop in [0.1]:
                            for enc_drop in [0.15]:
                                ...
                                args["speed_pert"] = False  # can not work with fixed alignment
