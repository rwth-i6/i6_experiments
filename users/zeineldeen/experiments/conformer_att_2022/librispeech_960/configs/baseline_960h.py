...
def conformer_baseline():
    ...
    run_exp(
        "base_conf_12l_lstm_1l_conv6_OCLR_sqrdReLU_bpe1k_maxSeqLen-109",
        train_args=args,
        num_epochs=435,
        bpe_size=BPE_1K,
    )
    ...
    run_exp(
        "base_conf_12l_lstm_1l_conv6_OCLR_sqrdReLU_bpe5k_maxSeqLen-82", train_args=args, num_epochs=435, bpe_size=BPE_5K
    )
    ...
    for peak_lr in [9e-4]:
        ...
        args["oclr_opts"]["peak_lr"] = peak_lr
        run_exp(
            f"base_conf_12l_lstm_1l_conv6_OCLR_sqrdReLU_cyc915_ep2035_peak{peak_lr}", train_args=args, num_epochs=2035
        )
