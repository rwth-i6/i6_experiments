...
class EBranchformerEncoder(ConformerEncoderV2):
    ...
    * Ref: https://arxiv.org/pdf/2210.00077.pdf
    ...
    def _create_conformer_block(self, i, source):
        ...
        conv_gating_mlp = self._create_conv_gating_mlp(prefix_name, ff_module1, i)

        # merge two branches
        merge_module = self._create_merge_module(
            prefix_name, source=ff_module1, global_extracter=mhsa, local_extracter=conv_gating_mlp, layer_index=i
        )
