...
class ConformerDecoder:
    ...
    def __init__(
        ...
        replace_cross_att_w_masked_self_att=False,
    ...
    def _create_mhsa(self, prefix, source):
        ...
        att = self.subnet_unit.add_merge_dims_layer(
            "{}_att".format(prefix), att0, axes="static"
        )  # (B, H*V) except_batch
    ...
    def _create_ff_module(self, prefix_name, i, source):
        ...
        if self.use_sqrd_relu:
            ...
            swish_act = self.subnet_unit.add_eval_layer(
