...
def get_prior_config(
    ...
    returnn_config = ReturnnConfig(config=config, post_config=post_config,python_prolog=python_prolog, python_epilog=[serializer])
    return returnn_config


def get_feature_variance_config(
    forward_dataset,
    network_module: str,
    config: Dict[str, Any],
    net_args: Dict[str, Any],
    ...
    """
    Get a config for forward-only statistics extraction jobs.
    """
...
def get_dump_config(
    ...
    """
    Get a config for forward-only dumping.
    """
    ...
    serializer = serialize_forward(
        ...
        unhashed_net_args=unhashed_net_args,
        forward_module=None,
        forward_step_name="dump_features",
        forward_init_args=forward_args,
        unhashed_forward_init_args=unhashed_forward_args,
        debug=debug,
    )
...
def get_pca_label_stats_config(
    forward_dataset,
    network_module: str,
    config: Dict[str, Any],
    net_args: Dict[str, Any],
    ...
    """
    Get a config for forward-only PCA label-statistics jobs.
    """
