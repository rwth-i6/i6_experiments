"""
Number conversion taken from the unofficial Tacotron implementation by Keith Ito
...
class TacotronNumberConversionJob(PythonLineModificationJob):
    """
