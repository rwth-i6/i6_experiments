...
from .i6modelsV1_VGG4LayerActFrontendV1_v8_cfg import ModelConfig, PredictorConfig
...
class Model(torch.nn.Module):
    def __init__(self, model_config_dict, **kwargs):
        ...
        if self.cfg.ctc_output_loss > 0:
            self.encoder_ctc = nn.Linear(conformer_size, self.cfg.label_target_size + 1)
