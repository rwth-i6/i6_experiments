...
from ...tts_shared.db_mel_features import DbMelFeatureExtraction, DbMelFeatureExtractionConfig
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.decoder = NarTacoDecoder(
            ...
            mel_target_size=config.feature_extraction_config.num_filters,
...
def train_step(*, model: Model, data, run_ctx, **kwargs):
    ...
    with torch.no_grad():
        audio_features, audio_features_len = model.feature_extracton(squeezed_features, raw_audio_len)
    ...
    mel_loss = mel_loss / model.config.feature_extraction_config.num_filters
