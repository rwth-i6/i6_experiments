...
from .serializer import get_pytorch_serializer_v2, get_pytorch_serializer_v3
...
def get_training_config(
    ...
    base_config = {
        ...
        "learning_rates": list(np.linspace(1e-5, 1e-3, 20)) + list(np.linspace(1e-3, 1e-6, 230)),
        #############
    ...
    serializer = get_pytorch_serializer_v3 if use_v3 else get_pytorch_serializer_v2
