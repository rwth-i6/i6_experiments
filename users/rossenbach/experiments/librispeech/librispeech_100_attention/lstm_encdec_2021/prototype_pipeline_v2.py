...
@lru_cache()
def build_test_dataset(dataset_key, returnn_python_exe, returnn_root, output_path):
    bpe_size=2000
...
def training(prefix_name, returnn_exe, returnn_root, **kwargs):
    ...
    dev_other, dev_other_reference = build_test_dataset("dev-other", returnn_python_exe=returnn_exe, returnn_root=returnn_root, output_path=prefix_name)
