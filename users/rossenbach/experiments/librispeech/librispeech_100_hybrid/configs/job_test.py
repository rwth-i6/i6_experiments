...
def get_pytorch_returnn_configs(
    ...
    def construct_from_net_kwargs(base_config, net_kwargs, explicit_hash=None):
        ...
        if recognition:
            pytorch_export = Import(
                PACKAGE + ".pytorch_networks.%s.export_returnn" % model_type,
                import_as="export"
            )
    ...
    return {
        # "torchaudio_conformer_v2_subx2_lchunk": construct_from_net_kwargs(medium_lchunk_config, {"model_type": "torchaudio_conformer_v2_subup_large"}),#
        "torchaudio_conformer_v3_subx2_lchunk": construct_from_net_kwargs(medium_lchunk_config, {"model_type": "torchaudio_conformer_v3_subup_large"}),#
