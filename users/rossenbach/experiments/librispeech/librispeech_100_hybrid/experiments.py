...
from .default_tools import RETURNN_RC_ROOT, RASR_BINARY_PATH_U22
...
def run_hybrid_baseline_pytorch():
    ...
    returnn_exe = tk.Path("/work/asr4/rossenbach/rescale/pytorch_mixed_precision/launch_rnn.sh", hash_overwrite="GENERIC_RETURNN_LAUNCHER")
    blas_lib = tk.Path("/work/tools/asr/tensorflow/2.3.4-generic+cuda10.1+mkl/bazel_out/external/mkl_linux/lib/libmklml_intel.so", hash_overwrite="TF23_MKL_BLAS")
