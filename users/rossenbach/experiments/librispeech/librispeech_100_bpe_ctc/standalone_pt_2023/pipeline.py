...
from i6_core.returnn.training import GetBestTFCheckpointJob, GetBestPtCheckpointJob
...
def get_best_checkpoint(train_job: ReturnnTrainingJob):
    """
    get best checkpoint based on dev_loss_ctc

    :param train_job:
    :return:
    """
    return GetBestPtCheckpointJob(
