...
def forward_init_hook(run_ctx, **kwargs):
    ...
    vocab = Vocabulary.create_vocab(
        vocab_file="/work/asr4/rossenbach/sisyphus_work_folders/tts_asr_2023_work/i6_core/returnn/vocabulary/ReturnnVocabFromPhonemeInventory.paQ9HU4t5srU/output/vocab.pkl",
