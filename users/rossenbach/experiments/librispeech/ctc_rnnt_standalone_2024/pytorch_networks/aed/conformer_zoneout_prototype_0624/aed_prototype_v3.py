...
from .aed_prototype_v3_cfg import ModelConfig, AdditiveAttentionConfig, AttentionLSTMDecoderV1Config
...
def train_step(*, model: Model, data, run_ctx, **kwargs):
    ...
    ce_loss = nn.functional.cross_entropy(
        decoder_logits.transpose(1, 2), targets_masked.long(), reduction="sum", label_smoothing=model.label_smoothing,
    )  # [B,N]
