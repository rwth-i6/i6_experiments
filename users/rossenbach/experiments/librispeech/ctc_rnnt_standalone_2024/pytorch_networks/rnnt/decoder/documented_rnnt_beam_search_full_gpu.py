...
def _compute_updated_scores(
    ...
    """
    # TODO: edit
    hypo_scores = torch.stack([h.score for h in hypos]).unsqueeze(1)  # [beam_width, 1]
...
class RNNTBeamSearch(torch.nn.Module):
    ...
    def _search(
        ...
        for t in range(n_time_steps):
            ...
            # TODO: edit
            _, sorted_idx = torch.concatenate([self.hypo_sort_key(hypo) for hypo in outer_hypos]).topk(beam_width)
