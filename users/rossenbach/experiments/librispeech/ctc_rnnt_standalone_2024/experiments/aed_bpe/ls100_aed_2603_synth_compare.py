...
def aed_bpe_ls100_2603_synth_compare():
    ext_prefix_name = "experiments/librispeech/ctc_rnnt_standalone_2024/ls100_aed/2603_low_bpe"
    ...
    for BPE_SIZE in [2000]:
        ...
        model_zeineldeen_config = ModelConfig(
            ...
            mhsa_with_bias=True,
            conv_kernel_size=31,
            ctc_softmax_dropout=0.2,
            encoder_out_dropout=0.2,
            specauc_start_epoch=11,  # try just as for RNN-T
            ...
            label_smoothing=0.1,
            label_smoothing_start_epoch=21,
        )
