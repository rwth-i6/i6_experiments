...
def ls100_bpe_kazuki_lstm():

    for BPE_SIZE in [128, 512, 2000]:
        prefix_name = "experiments/librispeech/ctc_rnnt_standalone_2024/ls100_bpe_lstm_lm/%i_lstm" % BPE_SIZE
        ...
        add_lm("ls100_bpe%i_2x2024_kazuki_lstmlm_3ep" % BPE_SIZE, lm_model=NeuralLM(
