...
def ls100_kazuki_trafo():

    # only the 24 layer 5 ep model for 2000
    for BPE_SIZE in [512, 2000]:
        prefix_name = "experiments/librispeech/ctc_rnnt_standalone_2024/lm_bpe_ls100/bpe_%i_trafo" % BPE_SIZE
        ...
        add_lm("ls100_bpe%i_trafo24x768_5ep" % BPE_SIZE, lm_model=NeuralLM(
