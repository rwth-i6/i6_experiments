...
from ....storage import vocoders, add_duration, duration_alignments, add_synthetic_data
...
def run_tacotron2_decoder_tts():
    ...
    prefix = "experiments/loquacious/standalone_2025/tts/ar/tacotron2_decoder/"
    ...
    net_module = "ar_tts.tacotron2_decoding.tacotron2_decoding_v3"

    from ....pytorch_networks.ar_tts.tacotron2_decoding.tacotron2_decoding_v3 import (
    ...
    result_corpus = synthesize_dataset(
        syn_name,
        tts_model=tts_model,
        decoder="ar_tts.tacotron2_decoding.simple_gl_decoder",
