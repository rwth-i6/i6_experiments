...
def medium_bpe_kazuki_lstm():
    ...
    for BPE_SIZE in [128, 1000]:
        prefix_name = "experiments/loquacious/standalone_2025/lm_bpe/train_medium_bpe_%i_lstm" % BPE_SIZE
        ...
        add_lm("medium_bpe%i_2x2048_kazuki_lstmlm_5ep" % BPE_SIZE, lm_model=NeuralLM(
        ...
        perplexity_helper(training_name, bpe_size=BPE_SIZE, train_args=train_args, checkpoint=train_job.out_checkpoints[500])
