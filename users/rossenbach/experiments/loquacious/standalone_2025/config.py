...
def get_training_config(
    ...
    :param include_native_ops: needs extra i6_native_ops losses (e.g. RNN-T loss)
    ...
    :param add_cache_manager: used for caching with LMDataset
    """
