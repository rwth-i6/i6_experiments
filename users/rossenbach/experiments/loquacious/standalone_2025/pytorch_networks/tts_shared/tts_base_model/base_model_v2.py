...
from ..encoder.transformer_v2 import TTSTransformerTextEncoderV2Config, TTSTransformerTextEncoderV2
...
class BaseTTSModelV2(nn.Module):
    ...
    def __init__(
        ...
        self.encoder = TTSTransformerTextEncoderV2(cfg=encoder_config, speaker_embedding_size=speaker_embedding_size)
    ...
    def forward_encoder(self, phon_labels, labels_lengths, speaker_label=None, speaker_embedding=None):
        ...
        h, h_mask = self.encoder(phon_labels=phon_labels, labels_lengths=labels_lengths, speaker_embedding=speaker_embedding)
