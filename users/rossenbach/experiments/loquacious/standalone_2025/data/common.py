...
class DatasetSettings:
    ...
    Args:
        ...
        train_partition_epoch: use this split of the data for one training epoch
        train_seq_ordering: see RETURNN settings on sequence sorting
        train_additional_options: further RETURNN training options
    """
...
def build_training_datasets(
    ...
    :param dev_ogg: path to the ted dev zip, potentially containing altered transcriptions
    ...
    if explicit_devtrain_ogg:
        devtrain_zip_dataset = OggZipDataset(
            files=explicit_devtrain_ogg,
            audio_options=audio_datastream.as_returnn_audio_opts(),
            target_options=label_datastream.as_returnn_targets_opts(),
            seq_ordering="sorted_reverse",
        )
...
def build_test_dataset(
    ...
    """
    ogg_zip_dict = get_ogg_zip_dict(returnn_root=MINI_RETURNN_ROOT, returnn_python_exe=RETURNN_EXE)
...
def build_short_dev_dataset(
    ...
    filtered_bliss = get_dev_short_bliss()
