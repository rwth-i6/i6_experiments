...
def run_librispeech_100_common_tts_baseline_no_silence_prep(
  ...
  #  alignments[align + "/no_sil_p"] = system.alignments["tts_align_forced-align"][align].alternatives["bundle"]
  return (
    system.alignments["tts_align_forced-align"]["tts_align_sat"].alternatives["bundle"],
