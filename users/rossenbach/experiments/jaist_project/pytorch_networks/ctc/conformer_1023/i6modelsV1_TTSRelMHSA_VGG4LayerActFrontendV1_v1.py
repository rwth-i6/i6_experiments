"""
Conformer model using MHSA from Glow-TTS
"""
...
from .i6modelsV1_TTSRelMHSA_VGG4LayerActFrontendV1_v1_cfg import ModelConfig

from ...tts_shared.encoder.rel_mhsa import GlowTTSMultiHeadAttentionV1Config, GlowTTSMultiHeadAttentionV1


@dataclass
class ConformerTTSMHSABlockV1Config(ModelConfiguration):
    """
    Attributes:
    ...
    mhsa_cfg: GlowTTSMultiHeadAttentionV1Config
    conv_cfg: ConformerConvolutionV1Config


class ConformerTTSMHSABlockV1(nn.Module):
    """
    Conformer block module
    """

    def __init__(self, cfg: ConformerTTSMHSABlockV1Config):
        """
        :param cfg: conformer block configuration with subunits for the different conformer parts
        """
        super().__init__()
        self.ff1 = ConformerPositionwiseFeedForwardV1(cfg=cfg.ff_cfg)
        self.mhsa = GlowTTSMultiHeadAttentionV1(cfg=cfg.mhsa_cfg)
    ...
    def forward(self, x: torch.Tensor, /, sequence_mask: torch.Tensor) -> torch.Tensor:
        ...
        x = self.mhsa(x, x, sequence_mask) + x  #  [B, T, F]
...
@dataclass
class ConformerTTSMHSAEncoderV1Config(ConformerEncoderV1Config):
    """
    Attributes:
    ...
    block_cfg: ConformerTTSMHSABlockV1Config


class ConformerTTSMHSAEncoderV1(torch.nn.Module):
    """
    ...
    def __init__(self, cfg: ConformerTTSMHSAEncoderV1Config):
        """
        ...
        self.module_list = torch.nn.ModuleList([ConformerTTSMHSABlockV1(cfg.block_cfg) for _ in range(cfg.num_layers)])
...
class Model(torch.nn.Module):
    def __init__(self, model_config_dict, **kwargs):
        ...
        conformer_config = ConformerTTSMHSAEncoderV1Config(
            ...
            block_cfg=ConformerTTSMHSABlockV1Config(
                ...
                mhsa_cfg=GlowTTSMultiHeadAttentionV1Config(
                    ...
                    window_size=self.cfg.mhsa_window_size
                ),
                conv_cfg=ConformerConvolutionV1Config(
        ...
        self.conformer = ConformerTTSMHSAEncoderV1(cfg=conformer_config)
