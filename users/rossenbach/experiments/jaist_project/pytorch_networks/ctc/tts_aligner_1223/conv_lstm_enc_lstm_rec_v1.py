...
def train_step(*, model: Model, data, run_ctx, **kwargs):
    ...
    run_ctx.mark_as_loss(name="ctc", loss=ctc_loss, inv_norm_factor=num_phonemes, scale=1.0)
    ...
    if run_ctx.epoch >= model.tts_loss_from_epoch:
        ...
        run_ctx.mark_as_loss(name="rec_l1", loss=l1loss, inv_norm_factor=num_frames, scale=1.0)
