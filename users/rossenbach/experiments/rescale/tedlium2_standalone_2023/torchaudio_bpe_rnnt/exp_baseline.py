...
def conformer_rnnt_baseline():
    ...
    #     "network_module": "rnnt.conformer_1023.i6modelsV1_VGG4LayerActFrontendV1_v4",
    ...
    #         }
    #         run_exp(
    #             prefix_name + "conformer_1023/i6modelsV1_VGG4LayerActFrontendV1_v4_JJLR/lm%.1f_prior%.2f_bs1024_th14" % (
    ...
    #         }
    #         run_exp(
    #             prefix_name + "conformer_1023/i6modelsV1_VGG4LayerActFrontendV1_v4_JJLR_sub6/lm%.1f_prior%.2f_bs1024_th14" % (
    #                 lm_weight, prior_scale),
    #             datasets=train_data, train_args=train_args, search_args=search_args, with_prior=True)
    ...
    #         }
    #         run_exp(
    #             prefix_name + "conformer_1023/i6modelsV1_VGG4LayerActFrontendV1_v4_JJLR_sub6_transparent/lm%.1f_prior%.2f_bs1024_th14" % (
    #                 lm_weight, prior_scale),
    #             datasets=train_data, train_args=train_args, search_args=search_args, with_prior=True)
    ...
    run_exp(
        prefix_name + "conformer_1023/i6modelsV1_VGG4LayerActFrontendV1_v5_JJLR_sub6_start20/bs12",
        datasets=train_data, train_args=train_args, search_args=search_args, with_prior=False)
    ...
    run_exp(
        ...
        datasets=train_data, train_args=train_args, search_args=search_args, with_prior=False, evaluate_epoch=134)
