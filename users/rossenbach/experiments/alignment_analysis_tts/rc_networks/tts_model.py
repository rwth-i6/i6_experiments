...
class NARTTSModel(nn.Module):
    ...
    def __init__(
        ...
        self.conv_stack = ConvStack(in_dim=self.embedding_dim, dropout=(dropout, dropout, dropout))
        ...
        self.decoder = Decoder(in_dim=2*self.enc_lstm_dim, dec_lstm_size_1=dec_lstm_size, dropout=dropout)
        if self.gauss_up:
