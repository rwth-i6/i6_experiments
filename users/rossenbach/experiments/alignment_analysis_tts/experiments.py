...
from .default_tts.experiments import get_ctc_based_tts, get_optimized_tts_models, get_ls460_models, get_ls960_models, get_oclr_tts_models
...
def run_experiments_limited():
    """
    Experiments linked from 2021 setup into 2023 setup
    """
    get_optimized_tts_models()
    get_oclr_tts_models()
