...
class CTCAligner(nn.Module):
    ...
    def __init__(
        ...
        self.audio_embedding = nn.Linear(in_dim=self.feature_extractor.out_feature_dim, out_dim=self.audio_hidden_dim)
    ...
    def __call__(
        ...
        _, audio_features, audio_time = self.feature_extractor(audio_samples)
...
def construct_network(
    ...
    **kwargs
    ...
    :return:
    """
    audio_time_dim = audio_data.dim_tags[audio_data.time_dim_axis]
    label_time_dim = label_data.dim_tags[label_data.time_dim_axis]
    phoneme_time_dim = phoneme_data.dim_tags[phoneme_data.time_dim_axis]
    net = CTCAligner(
    ...
    out = net(
        audio_samples=nn.get_extern_data(audio_data),
