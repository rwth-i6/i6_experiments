...
from ...setups.common.hdf import RasrFeaturesToHdf, RasrForcedTriphoneAlignmentToHDF
    ...
    *,
    ...
    s.experiments["fh"]["priors"] = combine_priors_across_hmm_states(
        PriorInfo.from_triphone_job(
            tk.Path(
                "/work/asr3/raissi/shared_workspaces/gunz/kept-experiments/2023-04--thesis-baselines/priors/tri-from-scratch-conf-ph-3-dim-512-ep-600-cls-WE-lr-v7-sa-v1-bs-11000-ep-550"
            )
        ),
