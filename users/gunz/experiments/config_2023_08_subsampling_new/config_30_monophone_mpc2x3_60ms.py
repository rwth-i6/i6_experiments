    ...
    *,
    ...
    base_config = {
        ...
        **CONF_SA_CONFIG,
        ...
        "chunking": subsample_chunking(CONF_CHUNKING_60MS, ss_factor),
    ...
    if run_performance_study:
        ...
        recog_args = dataclasses.replace(best_config, altas=2, beam=22, lm_scale=best_config.lm_scale + 0.01)
