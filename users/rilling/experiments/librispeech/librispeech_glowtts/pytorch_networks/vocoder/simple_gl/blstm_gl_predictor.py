...
from i6_experiments.users.rilling.experiments.librispeech.librispeech_glowtts.pytorch_networks.feature_extraction import (
    DbMelFeatureExtractionConfig, DbMelFeatureExtraction,
)
...
def train_step(*, model: Model, data, run_ctx, **kwargs):
    samples = data["audio_features"]  # [B, T', 1]
    samples_len = data["audio_features:size1"]  # [B]
