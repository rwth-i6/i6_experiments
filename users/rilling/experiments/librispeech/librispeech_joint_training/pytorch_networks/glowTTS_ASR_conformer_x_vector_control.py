...
from .shared.i6modelsV1_VGG4LayerActFrontendV1_v4_cfg import \
        SpecaugConfig, VGG4LayerActFrontendV1Config_mod, ModelConfig, FlowDecoderConfig, TextEncoderConfig
...
class Model(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.encoder = TextEncoder(text_encoder_config, out_channels=self.cfg.out_channels, gin_channels=self.cfg.gin_channels)
 
        self.decoder = FlowDecoder(decoder_config, in_channels=self.cfg.out_channels, gin_channels=self.cfg.gin_channels)
