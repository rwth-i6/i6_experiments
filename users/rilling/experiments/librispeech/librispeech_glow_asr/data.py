...
def get_librispeech_lexicon(
    corpus_key="train-clean-100", with_g2p: bool = True, add_unknown_phoneme_and_mapping=False, add_silence=False
) -> tk.Path:
    """
    ...
    if with_g2p:
        return extend_lexicon_with_tts_lemmas(
            get_g2p_augmented_bliss_lexicon_dict(use_stress_marker=False, output_prefix="datasets_tts_like")[corpus_key]
        )
    else:
        return extend_lexicon_with_tts_lemmas(get_bliss_lexicon(use_stress_marker=False, output_prefix="datasets_tts_like"))
