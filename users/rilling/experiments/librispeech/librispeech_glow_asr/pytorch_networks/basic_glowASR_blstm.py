...
class Model(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        blstm_config = BlstmEncoderV1Config(num_layers=final_n_layers, input_dim=out_channels, hidden_dim=final_hidden_channels, dropout=p_dropout_dec, enforce_sorted=False)
    ...
    def forward(self, raw_audio, raw_audio_len):
        with torch.no_grad():
            ...
            run_ctx = get_run_ctx()
            if self.training and run_ctx.epoch >= 10 and False:
