...
from i6_experiments.users.zhang.experiments.apptek.datasets.spanish.f8kHz.data import get_task_data
...
ALIAS_PREFIX = "datasets/spanish/f8kHz"
...
def get_asr_task(
    ...
    **kwargs,
    ...
    task = SpanishTask(
        ...
        main_measure_name="test_set.ES_US.f8kHz.dev_callhome-v4.ref.ff_wer",
