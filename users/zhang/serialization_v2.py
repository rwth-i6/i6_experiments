...
class ReturnnConfigWithNewSerialization(ReturnnConfig):
    ...
    def __init__(self, config: Dict[str, Any], post_config: Optional[Dict[str, Any]] = None, extra_sys_paths: Sequence[str] = []):
        super().__init__(config=config, post_config=post_config, sort_config=False)
        self.extra_sys_paths = extra_sys_paths
