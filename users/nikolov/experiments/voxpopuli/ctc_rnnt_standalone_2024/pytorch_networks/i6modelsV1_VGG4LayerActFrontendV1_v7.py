...
def train_step(*, model: ModelConfig, **kwargs):
    ...
    raw_audio = raw_audio.type(torch.cuda.FloatTensor)
    ...
    print("logit_lengths", audio_features_len)
    print("targets", labels.size())
    ...
    kwargs.get("run_ctx", None).mark_as_loss(name="rnnt", loss=rnnt_loss, inv_norm_factor=num_phonemes)
...
def get_model_config(vocab_size_without_blank: int, network_args: dict) -> ModelConfig:
    ...
    return model_config_v5_sub6_512lstm