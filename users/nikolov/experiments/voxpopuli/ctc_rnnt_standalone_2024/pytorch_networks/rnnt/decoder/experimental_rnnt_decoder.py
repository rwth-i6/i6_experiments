...
def forward_step(*, model, data, run_ctx, **kwargs):
    ...
    if run_ctx.batched_encoder_decoding:
        ...
        hyps = [hypothesis[0][0] for hypothesis in batched_hypotheses]  # exclude last sentence end token
    else:
        for i in range(raw_audio.shape[0]):
            ...
            hyps.append(hypothesis[0][0])  # exclude last sentence end token
