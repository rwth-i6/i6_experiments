...
def eow_phon_ls960_1023_base():
    ...
    tune_and_evaluate_helper(
        training_name+"/onnx_export", asr_model, default_decoder_config, lm_scales=[2.3, 2.5, 2.7], prior_scales=[0.2, 0.3, 0.4], decoder_module='ctc.decoder.flashlight_ctc_v1_onnx_split'
    )
