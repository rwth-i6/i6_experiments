...
from i6_experiments.users.nikolov.experiments.voxpopuli.ctc_rnnt_standalone_2024.serializer_noreturnn import get_pytorch_serializer_v3
...
def get_training_config(
    ...
    config = {**base_config, **copy.deepcopy(extra_config or {}), **copy.deepcopy(config)}
