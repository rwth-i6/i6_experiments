...
class Model(torch.nn.Module):
    ...
    def __init__(self, epoch, step, **kwargs):
        ...
        self.old_spec = kwargs.pop("old_spec")
        ...
        mhsa_cfg = ConformerMHSAV1Config(
            input_dim=conformer_size, num_att_heads=att_heads, att_weights_dropout=self.dropout, dropout=self.dropout,
        )
        ...
        conformer_cfg = ConformerEncoderV1Config(num_layers=self.num_layers, frontend=frontend, block_cfg=block_cfg)
    ...
    def forward(
        ...
        mask = _lengths_to_padding_mask(audio_features_len, audio_features_masked_2)
