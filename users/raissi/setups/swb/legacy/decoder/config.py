...
class SWBSearchParameters(SearchParameters):
    @classmethod
    def default_monophone(cls, *, priors: PriorInfo, frame_rate: int = 1) -> "SWBSearchParameters":
        return cls(
            beam=22,
            beam_limit=500_000,
            ...
            non_word_phonemes="[LAUGHTER],[NOISE],[VOCALIZEDNOISE]",
            we_pruning=0.5,
            we_pruning_limit=10000,
        )

    @classmethod
    def default_diphone(cls, *, priors: PriorInfo, frame_rate: int = 1) -> "SWBSearchParameters":
        return cls(
            beam=20,
            beam_limit=500_000,
    ...
    @classmethod
    def default_triphone(cls, *, priors: PriorInfo, frame_rate: int = 1) -> "SWBSearchParameters":
        return cls(
            beam=20,
            beam_limit=500_000,
            lm_scale=11.0,
    ...
    @classmethod
    def default_joint_diphone(cls, *, priors: PriorInfo, frame_rate: int = 1) -> "SWBSearchParameters":
        return cls(
            beam=20,
            beam_limit=500_000,
            lm_scale=1.8 if frame_rate > 1 else 6.0,
