...
from ..returnn_config_helpers import get_forward_config_v2
...
def ctc_label_sync_eval_auto_scale(
    ...
    frozen_scales[Scales.CTC.value] = 1.0
    ...
    autoscale_id = simplified_id = "ctc_aed_autoscale"
    ...
    beam_size = 64
    forward_config = {
        "batch_size": 5_000 * 160,
        "max_seqs": 200,
    }
    forward_config_low_batch_size = {
        "batch_size": 2_000 * 160,
        "max_seqs": 200,
    }
    ...
    network_import_path = "pytorch_networks.conformer_aed_v1.Model"
