...
def get_checkpoint(get_best_averaged_checkpoint: tuple[int, str] | None, get_last_averaged_checkpoint: int | None,
                   get_specific_checkpoint: int | None, train_job, training_name) -> tuple[Any, PtCheckpoint]:
