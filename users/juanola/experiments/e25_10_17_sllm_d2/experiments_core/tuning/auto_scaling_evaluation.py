...
def ctc_label_sync_eval_auto_scale(
    ...
    returnn_ctc_n_best_config = get_forward_config_v2(
        ...
        forward_method="forward_step_v2", # TODO: check if this works!
    ...
    rescore_data = { # TODO: add prior and SLLM to be tuned here?
        "class": "MetaDataset",
        "datasets": {
            "orig_data": tune_dataset_dict["dataset"],
            "hyps": rescore_data
        },
        "data_map": {
            "audio": ("orig_data", "data"), # TODO?? data was audio first...
