...
class ExperimentVersion(Enum):
    ...
    V7_TUNED_DROPOUT_300 = "SLLM_td_300"
    SLLM_BV2_PRE_D_S_C_F1 = "SLLM_pretrained_d_s_c_f1"
    SLLM_BV2_PRE_D_S_C_F2 = "SLLM_pretrained_d_s_c_f2"
    SLLM_BV2_PRE_D_S_C_F5 = "SLLM_pretrained_d_s_c_f5"
    SLLM_BV2_PRE_ED_S_C_F1 = "SLLM_pretrained_ed_s_c_f1"
    SLLM_BV2_PRE_ED_S_C_F2 = "SLLM_pretrained_ed_s_c_f2"
    SLLM_BV2_DS_PRE_D_S_C_F1 = "SLLM_ds_pretrained_d_s_c_f1"
    SLLM_BV2_4GPU_10K = "SLLM_small_linear_4gpu_10k"
    SLLM_BV2_4GPU_10K_PRE_D_S_C = "SLLM_small_linear_4gpu_10k_pre_d_c"

    SLLM_BV2_DS_PRE_D_B_C = "SLLM_ds_pretrained_d_b_c"
    SLLM_BV2_DS_PRE_ED_B_C = "SLLM_ds_pretrained_ed_b_c"
    SLLM_BV2_DS_PRE_D_B_C_F2 = "SLLM_ds_pretrained_d_b_c_f2"
    SLLM_BV2_DS_PRE_ED_B_C_F1 = "SLLM_ds_pretrained_ed_b_c_f1"
    ...
    SLLM_BV3_PRE_ED_S_C_LORA = "SLLM_pretrained_ed_s_c_lora"
    SLLM_BV3_PRE_ED_S_C_LORA_small = "SLLM_pretrained_ed_s_c_lora_small"
    ...
    V7_S2 = "SLLM_td_s2"
    V7_S2V2 = "SLLM_td_s2v2"
    V5_LINEAR_ADAPTER_S2 = "SLLM_small_linear_adapter_s2"
    V5_LINEAR_ADAPTER_S2V2 = "SLLM_small_linear_adapter_s2v2"
    ...
    SLLM_BV2_PRE_ED_S_C_V2 = "SLLM_pretrained_ed_s_c_v2"
    SLLM_BV2_PRE_ED_S_LM_V2 = "SLLM_pretrained_ed_s_lm_v2"
    V15_SMALL_SLLM_LR4_V2 = "SLLM_small_12finetuning_lr4_v2"
...
_EXPERIMENT_BUILDERS = {
    ...
    ExperimentVersion.SLLM_BV2_PRE_D_B_T: bv2_pre_d_b_t, # Not used
    ExperimentVersion.SLLM_BV2_PRE_ED_B_T: bv2_pre_ed_b_t, # Not used
    ...
    ExperimentVersion.V7_TUNED_DROPOUT_300: exp_v7_300,
    ExperimentVersion.SLLM_BV2_PRE_D_S_C_F1: bv2_pre_d_s_c_f1,
    ExperimentVersion.SLLM_BV2_PRE_D_S_C_F2: bv2_pre_d_s_c_f2,
    ExperimentVersion.SLLM_BV2_PRE_D_S_C_F5: bv2_pre_d_s_c_f5,
    ExperimentVersion.SLLM_BV2_PRE_ED_S_C_F1: bv2_pre_ed_s_c_f1,
    ExperimentVersion.SLLM_BV2_PRE_ED_S_C_F2: bv2_pre_ed_s_c_f2,
    ExperimentVersion.SLLM_BV2_DS_PRE_D_S_C_F1: bv2_with_ds_pre_d_s_c_f1,
    ExperimentVersion.SLLM_BV2_4GPU_10K: SLLM_small_linear_4gpu_10k,
    ExperimentVersion.SLLM_BV2_4GPU_10K_PRE_D_S_C: SLLM_small_linear_4gpu_10k_pre_d,

    ExperimentVersion.SLLM_BV2_DS_PRE_D_B_C: bv2_ds_pre_d_b_c,
    ExperimentVersion.SLLM_BV2_DS_PRE_ED_B_C: bv2_ds_pre_ed_b_c,
    ExperimentVersion.SLLM_BV2_DS_PRE_D_B_C_F2: bv2_ds_pre_d_b_c_f2,
    ExperimentVersion.SLLM_BV2_DS_PRE_ED_B_C_F1: bv2_ds_pre_ed_b_c_f1,
    ...
    ExperimentVersion.SLLM_BV3_PRE_ED_S_C_LORA: bv3_pre_ed_s_c_lora,
    ExperimentVersion.SLLM_BV3_PRE_ED_S_C_LORA_small: bv3_pre_ed_s_c_lora_small,
    ...
    ExperimentVersion.V7_S2V2: exp_v7_s2v2,
    ExperimentVersion.V5_LINEAR_ADAPTER_S2: exp_v5_s2,
    ExperimentVersion.V5_LINEAR_ADAPTER_S2V2: exp_v5_s2v2,
    ...
    ExperimentVersion.SLLM_BV2_PRE_ED_S_C_V2: bv2_pre_ed_s_c_v2,
    ExperimentVersion.SLLM_BV2_PRE_ED_S_LM_V2: bv2_pre_ed_s_lm_v2,
    ExperimentVersion.V15_SMALL_SLLM_LR4_V2: exp_v15_small_12ep_lr4_v2,
