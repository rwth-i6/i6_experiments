...
from .experiment_config import exp_baseline, exp_v2, ExperimentConfig, exp_v3, exp_v4, exp_v5, exp_v6, exp_v7, exp_v8, \
    exp_v9
...
class ExperimentVersion(Enum):
    ...
    V8_TD_LRV2 = "SLLM_td_lrv2"
    V9_TD_LRV3 = "SLLM_td_lrv3"
    # Expand here
...
_EXPERIMENT_BUILDERS = {
    ...
    ExperimentVersion.V8_TD_LRV2: exp_v8,
    ExperimentVersion.V9_TD_LRV3: exp_v9,
    # Expand here
}
