...
def gmm_example_report_format(report: _Report_Type) -> str:
    ...
    out.append(f'Excel: '
    f'{str(results["dev-clean"]["Monophone"]["10"])},'
    f'{str(results["dev-other"]["Monophone"]["10"])},'
    f'{str(results["dev-clean"]["Triphone"]["08"])} / {str(results["dev-clean"]["Triphone"]["10"])},'
    f'{str(results["dev-other"]["Triphone"]["08"])} / {str(results["dev-other"]["Triphone"]["10"])},'
    f'{str(results["dev-clean"]["VTLN"]["08"])} / {str(results["dev-clean"]["VTLN"]["10"])},'
    f'{str(results["dev-other"]["VTLN"]["08"])} / {str(results["dev-other"]["VTLN"]["10"])},'
    f'{str(results["dev-clean"]["SAT"]["08"])} / {str(results["dev-clean"]["SAT"]["10"])},'
    f'{str(results["dev-other"]["SAT"]["08"])} / {str(results["dev-other"]["SAT"]["10"])},'
    f'{str(results["dev-clean"]["VTLN+SAT"]["08"])} / {str(results["dev-clean"]["VTLN+SAT"]["10"])},'
    f'{str(results["dev-other"]["VTLN+SAT"]["08"])} / {str(results["dev-other"]["VTLN+SAT"]["10"])}')
    return "\n".join(out)
