...
from i6_experiments.users.hilmes.common.setups.rasr import gmm_system
from i6_experiments.users.hilmes.common.setups.rasr.util import RasrSteps, OutputArgs

from i6_experiments.users.hilmes.common.tedlium2.gmm import baseline_args
from i6_experiments.users.hilmes.common.tedlium2.data import get_corpus_data_inputs
...
def run_tedlium2_common_baseline(
    ...
    final_output_args.define_corpus_type("dev2010", "test")
    final_output_args.define_corpus_type("tst2015", "test")
    final_output_args.define_corpus_type("tst2014", "test")
