...
from i6_experiments.users.hilmes.common.setups.rasr import util
...
def get_monophone_args():
    ...
    return util.GmmMonophoneArgs(linear_alignment_args, monophone_training_args, monophone_recognition_args, test_recognition_args={})
...
def get_cart_args(
    ...
    cart_questions = cart.PythonCartQuestions(
        phonemes=cart_questions_class.phonemes_boundary_silence,
...
def get_sat_args():
    ...
    return util.GmmSatArgs(
        ...
        sdm_args=sdm_args,
        test_recognition_args={"prev_ctm": util.PrevCtm(
            prev_step_key="tri",
            pronunciation_scale=1.0,
            lm_scale=25,
            iteration=10,
