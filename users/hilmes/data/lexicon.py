...
def get_lexicon():
  ...
  :rtype: Path
  """
  librispeech_100_lexicon = get_g2p_augmented_bliss_lexicon_dict(use_stress_marker=True)["train-clean-100"]
...
def get_360_lexicon():
    ...
    :rtype: Path
    """
    librispeech_100_lexicon = get_g2p_augmented_bliss_lexicon_dict(use_stress_marker=True)["train-clean-360"]
    static_bliss_lexcion = WriteLexiconJob(get_static_lexicon()).out_bliss_lexicon
    lexicon = MergeLexiconJob(bliss_lexica=[static_bliss_lexcion, librispeech_100_lexicon],
        sort_phonemes=True,
        sort_lemmata=False).out_bliss_lexicon
