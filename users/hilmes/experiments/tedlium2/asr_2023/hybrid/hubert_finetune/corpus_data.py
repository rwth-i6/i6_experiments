...
from i6_experiments.common.baselines.tedlium2.default_tools import RETURNN_EXE, RETURNN_RC_ROOT
...
def get_corpus_data_inputs(
    ...
    train_segments = all_train_segments
