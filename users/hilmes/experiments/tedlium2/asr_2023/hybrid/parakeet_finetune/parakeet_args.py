...
def get_pytorch_returnn_configs(
    ...
    base_config = {
        "extern_data": {
            ...
            },  # input: 80-dimensional waveforms
            "classes": {
                "dim": num_outputs,
                "shape": (None,),
    ...
    amp_config = copy.deepcopy(whisper_config)
    amp_config["torch_amp"] = {"dtype": "bfloat16"}
    ...
    del whisper_config["learning_rate"]
    ...
    return {
         "torch_parakeet": construct_from_net_kwargs(  # 5.1
            whisper_config,
            {
        ...
        "torch_parakeet_amp": construct_from_net_kwargs(  # 6.0
            amp_config,
            {
                "model_type": "parakeet_finetune",
                "config_dict": {
