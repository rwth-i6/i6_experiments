...
def build_data_input(
    ...
    :param raw_input: Whether to features were extracted or the raw audio is used as input
    ...
    if raw_input:
        return OggZipHdfDataInput(
            oggzip_files=[features],
            ...
            ogg_args={"segment_file": segment_list, "targets": None},
            alignment_data_key="data",
        )
    else:
        feat_dataset = {
            "class": "SprintCacheDataset",
...
def get_corpus_data_inputs(
    ...
    Dict[str, Union[HdfDataInput, OggZipHdfDataInput]],
    Dict[str, Union[HdfDataInput, OggZipHdfDataInput]],
    Dict[str, Union[HdfDataInput, OggZipHdfDataInput]],
    ...
    :param remove_faulty_segments: Whether to remove the two faulty segments
    :param raw_input: Whether to features were extracted or the raw audio is used as input
    :return:
    """
    ...
    if raw_input:
        assert feature_extraction_class is None
        extra_args = {
            c: {
        ...
        train_features = ogg_zip_dict["train"]
        cv_features = ogg_zip_dict["dev"]
        devtrain_features = ogg_zip_dict["train"]
    else:
