...
from .conformer_v1_uni_aggr_cfg_v1 import ModelConfig
...
@dataclass
class ConformerAggrEncoderV1Config(ModelConfiguration):
    """
    Attributes:
...
class ConformerAggrEncoderV1(nn.Module):
    """
    ...
    def __init__(self, cfg: ConformerAggrEncoderV1Config):
        """
...
class Model(torch.nn.Module):
    def __init__(self, model_config_dict, **kwargs):
        ...
        conformer_config = ConformerAggrEncoderV1Config(
        ...
        self.conformer = ConformerAggrEncoderV1(cfg=conformer_config)
