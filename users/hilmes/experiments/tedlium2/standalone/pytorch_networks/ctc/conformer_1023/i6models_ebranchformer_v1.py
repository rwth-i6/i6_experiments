...
from i6_models.parts.e_branchformer.merge import MergerV1Config
from i6_models.parts.e_branchformer.cgmlp import ConvolutionalGatingMLPV1Config
from i6_models.assemblies.e_branchformer.e_branchformer_v1 import EbranchformerEncoderV1, EbranchformerEncoderV1Config, EbranchformerBlockV1Config
...
class Model(torch.nn.Module):
    def __init__(self, model_config_dict, **kwargs):
        ...
        e_branchformer_config = EbranchformerEncoderV1Config(
        ...
        self.conformer = EbranchformerEncoderV1(cfg=e_branchformer_config)
