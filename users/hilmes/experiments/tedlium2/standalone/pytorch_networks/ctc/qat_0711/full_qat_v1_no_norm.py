...
from .full_qat_v1_modules_no_norm import LinearQuant, QuantizedMultiheadAttention, Conv1dQuant, ActivationQuantizer
...
class ConformerMHSAQuant(torch.nn.Module):
    ...
    def forward(self, input_tensor: torch.Tensor, sequence_mask: torch.Tensor) -> torch.Tensor:
        ...
        output_tensor, _ = self.mhsa(input_tensor, input_tensor, input_tensor, mask=inv_sequence_mask)  # [B,T,F]
