...
def forward_finish_hook(run_ctx, **kwargs):
    ...
    print("Total-time: %.2f, Batch-RTF: %.6f" % (run_ctx.total_time, run_ctx.total_time / run_ctx.running_audio_len_s))
    run_ctx.rtf_file.write("Total-time: %.2f, Batch-RTF: %.6f" % (run_ctx.total_time, run_ctx.total_time / run_ctx.running_audio_len_s))
...
def forward_step(*, model, data, run_ctx, **kwargs):
    ...
    if run_ctx.print_rtf:
        ...
        print("Batch-time: %.2f, Batch-RTF: %.6f" % (am_time, am_time / audio_len_batch))
