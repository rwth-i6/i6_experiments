"""
Config for the base CTC model with aux loss and ordering, v2 adds options for optional Blank elimination
"""
...
class DistillConfig:
    ...
    module_list: List[str]
    module_scales: List[float]
    aux_kd_loss_layers: Optional[List[int]]
    aux_kd_loss_scales: Optional[List[float]]
    final_dropout: float
    exp_targets: bool  # to test whether the exp is correct of wrong
    eliminate_blanks: bool
