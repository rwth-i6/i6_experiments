...
from .distill_hubert_v1_cfg import ModelConfig, DistillConfig
...
class Model(torch.nn.Module):
    ...
    def forward(
        ...
        if self.training or run_ctx.stage == "train_step":
            ...
            print(log_probs_list[-1].shape[1], teacher_logits.shape)
...
def train_step(*, model: Model, data, run_ctx, **kwargs):
    ...
    if model.distill_config.eliminate_blanks is True:
        soft_targets_loss = 0
        num_phonemes = 0
        for teacher_seq, student_seq in zip(teacher_logits, student_logits):
            ...
            print(teacher_seq.shape, teacher_seq)
