...
class QuantizedMultiheadAttention(nn.Module):
    ...
    def _create_linear_layer(self, weight_bits, output_dim=None):
        return TiledMemristorLinear(
            ...
            weight_precision=weight_bits if not weight_bits == 1.5 else 2,
            converter_hardware_settings=self.cfg.converter_hardware_settings,
