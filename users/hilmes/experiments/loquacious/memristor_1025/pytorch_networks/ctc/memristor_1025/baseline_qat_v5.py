...
v5 quantizes the frontend aswell
"""
...
from .baseline_qat_v5_cfg import (
...
from .baseline_qat_v5_modules import LinearQuant, QuantizedMultiheadAttention, Conv1dQuant, ActivationQuantizer, Conv2dQuant
