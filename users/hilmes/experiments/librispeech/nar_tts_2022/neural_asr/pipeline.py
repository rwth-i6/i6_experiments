...
def build_training_datasets(
    ...
    if synthetic_bliss:
        ...
        ogg_zip_job.add_alias(
            os.path.join(output_path, "LibriSpeech", "synthetic_ogg_zip_job")
        )
        training_ogg_combination = [train_clean_100_ogg] * original_scale + [ogg_zip_job.out_ogg_zip] * synthetic_scale
