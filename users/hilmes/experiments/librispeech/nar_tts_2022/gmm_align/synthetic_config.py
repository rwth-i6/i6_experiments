...
from i6_experiments.users.hilmes.experiments.librispeech.nar_tts_2022.gmm_align.data import (
    get_synth_corpus_data_inputs, get_sil_corpus_data_inputs, get_corpus_data_inputs_no_speaker, get_corpus_data_inputs
)
...
def run_librispeech_100_with_synthetic_data(
    synth_corpus,
    alias_prefix="experiments/librispeech/nar_tts_2022/gmm_align/synthetic", ls360=False, pool_variance=True
):
