...
from .memristor_v14_cfg import (
    QuantModelTrainConfigV14,
...
from .memristor_v14_modules import LinearQuant, ActivationQuantizer, QuantizedMultiheadAttention, Conv1dQuant
...
class Model(torch.nn.Module):
    def __init__(self, model_config_dict, **kwargs):
        ...
        super().__init__()
        self.train_config = QuantModelTrainConfigV14.from_dict(model_config_dict)
