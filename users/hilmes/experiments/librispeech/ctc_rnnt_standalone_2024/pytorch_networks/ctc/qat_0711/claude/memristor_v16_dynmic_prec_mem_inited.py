...
from .memristor_v16_dynmic_prec_modules import make_inference_memristor_linear
from .memristor_v16_dynmic_prec_modules_mem_inited import ActivationQuantizer, QuantizedMultiheadAttention
...
class ConformerPositionwiseFeedForwardQuant(nn.Module):
    ...
    def __init__(self, cfg: ConformerPositionwiseFeedForwardQuantV4Config):
        ...
        self.linear_ff = make_inference_memristor_linear(
        ...
        self.linear_out = make_inference_memristor_linear(
...
class ConformerConvolutionQuant(nn.Module):
    ...
    def __init__(self, model_cfg: ConformerConvolutionQuantV4Config):
        ...
        self.pointwise_conv1 = make_inference_memristor_linear(
        ...
        self.depthwise_conv = MemristorConv1d(
            ...
            weight_precision=dconv_prec if not dconv_prec == 1.5 else 2,
            converter_hardware_settings=model_cfg.converter_hardware_settings,
        ...
        self.pointwise_conv2 = make_inference_memristor_linear(
            in_features=model_cfg.channels,
