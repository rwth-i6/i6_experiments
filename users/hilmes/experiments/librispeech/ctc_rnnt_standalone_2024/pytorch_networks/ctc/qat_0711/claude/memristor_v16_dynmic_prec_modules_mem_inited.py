...
v14 adds weight sparsity / pruning (pruning not applicable at inference, mem_inited uses TiledMemristorLinear directly)
"""
...
from .memristor_v16_dynmic_prec_cfg import QuantizedConformerMHSARelPosV1Config
...
class QuantizedMultiheadAttention(nn.Module):
    ...
    def __init__(self, cfg: QuantizedConformerMHSARelPosV1Config):
        ...
        # projection matrices
        self.qkv_proj = make_inference_memristor_linear(
        ...
        self.out_proj = make_inference_memristor_linear(
            in_features=self.embed_dim,
        ...
        if cfg.with_linear_pos:
            self.linear_pos = make_inference_memristor_linear(
