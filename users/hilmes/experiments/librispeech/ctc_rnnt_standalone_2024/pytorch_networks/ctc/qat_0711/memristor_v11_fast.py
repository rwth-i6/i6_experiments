...
fast variant: identical to memristor_v11, but enables the SynaptogenML opt-in fast
inference path (synaptogen_ml.set_fast_inference) at import time. Paired with
memristor_v11_fast_mem_inited (the module actually used for the recog forward).
"""

# Enable the SynaptogenML opt-in fast inference path for this run.
...
from .memristor_v11_modules import LinearQuant, ActivationQuantizer, QuantizedMultiheadAttention, Conv1dQuant
