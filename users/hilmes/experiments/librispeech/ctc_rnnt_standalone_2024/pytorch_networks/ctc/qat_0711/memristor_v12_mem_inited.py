...
from .memristor_v12_cfg import (
    QuantModelTrainConfigV12,
...
from .memristor_v12_modules_mem_inited import ActivationQuantizer, QuantizedMultiheadAttention
...
class Model(torch.nn.Module):
    def __init__(self, model_config_dict, **kwargs):
        ...
        super().__init__()
        self.train_config = QuantModelTrainConfigV12.from_dict(model_config_dict)
        ...
        def _make_block_cfg(weight_bit_prec):
            return ConformerBlockQuantV1Config(
                ...
                mhsa_cfg=QuantizedConformerMHSARelPosV1Config(
                    ...
                    bit_prec_W_i=weight_bit_prec,
                    bit_prec_W_o=weight_bit_prec,
                    moving_average=self.train_config.moving_average,
                    ...
                    correction_settings=self.train_config.correction_settings,
                    with_bias=True,
                    bit_prec_learn_emb=weight_bit_prec,
