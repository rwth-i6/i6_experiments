"""
Energy-measure variant of memristor_v17_dynmic_prec_mem_inited: identical model, distinct
module name.

The eval pipeline appends "_mem_inited" to the recognition network module, so passing
"...claude.memristor_v17_dynmic_prec_energy" as recognition module resolves to this file.
...
from .memristor_v17_dynmic_prec_mem_inited import Model as _BaseModel
from .memristor_v17_dynmic_prec_mem_inited import (  # noqa: F401
    train_step,
    prior_init_hook,
    prior_step,
    prior_finish_hook,
