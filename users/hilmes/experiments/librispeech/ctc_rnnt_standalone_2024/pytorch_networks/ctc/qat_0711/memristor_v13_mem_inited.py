...
from .memristor_v13_cfg import (
    QuantModelTrainConfigV13,
...
from .memristor_v13_modules_mem_inited import ActivationQuantizer, QuantizedMultiheadAttention
...
class Model(torch.nn.Module):
    def __init__(self, model_config_dict, **kwargs):
        ...
        super().__init__()
        self.train_config = QuantModelTrainConfigV13.from_dict(model_config_dict)
