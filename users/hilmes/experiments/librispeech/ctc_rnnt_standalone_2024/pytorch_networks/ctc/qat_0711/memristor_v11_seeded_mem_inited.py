...
seeded variant: identical to memristor_v11_mem_inited, but fixes the RNG seed at
import time so the standard and fast paths draw identical noise streams and can be
compared directly.
"""
