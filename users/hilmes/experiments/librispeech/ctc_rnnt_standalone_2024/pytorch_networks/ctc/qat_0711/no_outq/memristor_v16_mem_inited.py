"""
no_outq variant of memristor_v16_mem_inited: identical model, distinct module name, with the
...
passing "ctc.qat_0711.no_outq.memristor_v16" resolves to this file, while the conversion and
prior jobs keep the plain v16 module and stay cached. The unmodified converted_model.pt is loaded
as-is; the out-quant observer keys become unexpected keys, which MiniReturnn tolerates
(load_state_dict with strict=False).
"""

from ..memristor_v16_mem_inited import *  # noqa: F401,F403
from ..memristor_v16_mem_inited import Model as _BaseModel
