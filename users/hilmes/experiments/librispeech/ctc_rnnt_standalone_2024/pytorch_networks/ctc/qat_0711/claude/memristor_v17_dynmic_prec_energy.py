"""
Energy-measure variant of memristor_v17_dynmic_prec: identical model, distinct module name.
...
from .memristor_v17_dynmic_prec import Model as _BaseModel
from .memristor_v17_dynmic_prec import (  # noqa: F401
    train_step,
    prior_init_hook,
    prior_step,
    prior_finish_hook,
