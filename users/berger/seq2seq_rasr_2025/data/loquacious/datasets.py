...
from ...common_deps.loquacious.corpus import get_bliss_corpus_dict as get_bliss_corpus_dict_
from ...common_deps.loquacious.corpus import get_ogg_zip_dict
from ...common_deps.loquacious.vocab import get_subword_nmt_bpe
