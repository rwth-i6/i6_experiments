...
from .config_02_conformer_transducer_phon_viterbi import py as py_viterbi
...
def returnn_config_generator(
    ...
    pretrained_checkpoint: PtCheckpoint,
    **kwargs,
) -> ReturnnConfig:
...
def run_exp(pretrained_checkpoint: PtCheckpoint) -> SummaryReport:
    ...
    recog_args = exp_args.get_transducer_recog_step_args(
        num_classes=num_outputs,
        lm_scales=[0.7],
        epochs=[40, 80, 160, 320, 480, num_subepochs],
...
def py() -> SummaryReport:
    ...
    summary_report.merge_report(run_exp(model), update_structure=True)
