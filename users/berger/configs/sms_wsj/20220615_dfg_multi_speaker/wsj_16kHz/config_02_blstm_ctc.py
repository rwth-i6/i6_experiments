...
def run_exp(**kwargs) -> Tuple[Dict[str, Any], SummaryReport]:
    ...
    nn_data_inputs = get_returnn_rasr_data_inputs(
        train_data_inputs={train_key: train_data_input},
        cv_data_inputs={dev_key: cv_data_input},
        dev_data_inputs=dev_data_inputs,
        test_data_inputs=test_data_inputs,
        align_data_inputs={train_key + "_align": train_data_input, dev_key + "_align": cv_data_input},
        am_args=am_args,
    )
    ...
    nn_args = get_nn_args(
        ...
        search_type=SearchTypes.GenericSeq2SeqSearch,
