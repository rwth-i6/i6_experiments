...
from .config_01e_ctc_blstm_rasr_features_wei_lex import py as py_ctc
from .config_02c_transducer_rasr_features_wei_lex import py as py_transducer
...
def run_exp(alignments: Dict[str, AlignmentData], viterbi_model_checkpoint: Checkpoint) -> SummaryReport:
    ...
    for lr, batch_size, accum_grad in [
        ...
        system.add_experiment_configs(
            f"Conformer_Transducer_Fullsum_wei-lex_lr-{lr}_bs-{batch_size*accum_grad}", returnn_configs
        )
