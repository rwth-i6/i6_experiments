...
from .config_01e_ctc_blstm_rasr_features_wei_lex import py as py_ctc_blstm
from .config_01f_ctc_conformer_rasr_features_wei_lex import py as py_ctc_conf
...
def run_exp(
    ...
    for label_smoothing, loss_boost_v2, peak_lr, loss_boost_scale, ctc_init in [
        ...
        system.add_experiment_configs(f"Conformer_Transducer_Viterbi_wei-lex_{suffix}_{name_suffix}", returnn_configs)
    ...
    train_job = system.get_train_job(f"Conformer_Transducer_Viterbi_wei-lex_lr-0.0008_{name_suffix}")
