    ...
    **kwargs,
    ...
    extra_config = {
        "train": {
            ...
            "sprintConfigStr": "--config=/u/berger/asr-exps/librispeech/20230210_baselines/config/extern_sprint_data/sprint.train.own_data.config --*.LOGFILE=nn-trainer.train.log --*.TASK=1 --*.corpus.segment-order-shuffle=true",
