...
def generate_returnn_config(
    ...
    **kwargs,
    ...
    # train_feature_hdf = MatchLengthsJob(train_feature_hdf, train_data_config["datasets"]["classes"]["files"][0]).out_hdf
        ...
        "train": {
            ...
            "datasets": {
                ...
                "classes": {
                    ...
                    "files": [
                        MatchLengthsJob(
                            PeakyAlignmentJob(train_data_config["datasets"]["classes"]["files"][0]).out_hdf,
                            train_align_hdf,
                        ).out_hdf
                    ],
                    "use_cache_manager": True,
