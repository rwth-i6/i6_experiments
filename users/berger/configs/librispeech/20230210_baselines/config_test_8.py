...
from .config_test_5 import RenameSegmentsJob, MatchLengthsJob
...
def generate_returnn_config(
    ...
    **kwargs,
    ...
    train_align_hdf = MatchLengthsJob(train_align_hdf, train_data_config["datasets"]["classes"]["files"][0]).out_hdf
    ...
    extra_config = {
        "train": {
            ...
            "datasets": {
                "data": {
                    "class": "HDFDataset",
                    "files": train_data_config["datasets"]["data"]["files"],
        ...
        "dev": {
            ...
            "datasets": {
                "data": {
                    "class": "HDFDataset",
                    "files": dev_data_config["datasets"]["data"]["files"],
                    "use_cache_manager": True,
                },
                "classes": {
                    "class": "HDFDataset",
                    "files": [PeakyAlignmentJob(f).out_hdf for f in dev_data_config["datasets"]["classes"]["files"]],
                    "use_cache_manager": True,
                    "seq_ordering": "random",
                    "partition_epoch": 1,
                },
