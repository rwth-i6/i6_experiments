...
class ToolPaths:
    ...
    nn_trainer_rasr_binary_path: Optional[tk.Path] = None
    ...
    def __post_init__(self) -> None:
        ...
        if self.nn_trainer_rasr_binary_path is None:
            self.nn_trainer_rasr_binary_path = self.rasr_binary_path
...
default_tools = ToolPaths(
    ...
    nn_trainer_rasr_binary_path=tk.Path("/u/berger/software/rasr_apptainer_no_tf/arch/linux-x86_64-standard"),
