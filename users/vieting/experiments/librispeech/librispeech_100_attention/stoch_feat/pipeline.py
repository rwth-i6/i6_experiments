...
def training(prefix_name, returnn_config, returnn_exe, returnn_root, num_epochs=250, log_verbosity=4):
    """
...
def search_single(
    ...
    wer = ReturnnComputeWERJob(search_words, recognition_reference, returnn_exe, returnn_root)
...
def search(prefix_name, returnn_config, checkpoint, test_dataset_tuples, returnn_exe, returnn_root, mail=True):
    """
