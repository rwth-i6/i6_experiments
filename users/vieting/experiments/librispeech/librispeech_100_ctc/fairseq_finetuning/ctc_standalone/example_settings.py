...
# Please replace all variables marked with <...>
# Check also the TODOs
import getpass
import os.path
...
CONTAINER_IMAGE = "/work/asr3/vieting/hiwis/pletschko/images/u22_torch1.13_fairseq_v2.sif"

# file systems to bind in a "<source_path>:<target_path>" format
# in case of "path not found" error: possibly add container bind
CONTAINER_BINDS = ["/work/asr4:/work/asr4", "/work/asr3:/work/asr3", 
                   "/work/asr3/vieting/hiwis/pletschko:/work/asr3/vieting/hiwis/pletschko",
                   "/work/common:/work/common", "/work/tools:/work/tools"]
        ...
        return EngineSelector(
            engines={
                ...
                "long": SimpleLinuxUtilityForResourceManagementEngine(
                    default_rqmt={"cpu": 1, "mem": 2, "gpu": 0, "time": 1}, gateway=SUBMIT_GATEWAY, 
