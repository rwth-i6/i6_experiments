...
from i6_core.text.label.sentencepiece

from i6_experiments.common.helpers.text_labels.sentencepiece import get_spm_settings
from i6_experiments.common.datasets.librispeech import get_ogg_zip_dict, get_bliss_lexicon, get_bliss_corpus_dict
...
def get_spm_datastream(librispeech_key: str, bpe_size: int, is_recog: bool, use_postfix: bool) -> SentencePieceDatastream
    """
