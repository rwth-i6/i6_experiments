...
def bpe_ls960_1023_low_vocab_test_confv2():
    ...
    from ...pytorch_networks.ctc.conformer_0524.i6modelsV2_VGG4LayerActFrontendV1_auxloss_v1_cfg import \
    ...
    network_module = "ctc.conformer_0524.i6modelsV2_VGG4LayerActFrontendV1_auxloss_v1"
    global_train_args = {
    ...
    for BPE_SIZE in [128, 512]:
        ...
        training_name = prefix_name + "/" + str(BPE_SIZE) + "/" + network_module + ".512dim_convfirst_sub4_24gbgpu_50eps"
        train_job = training(training_name, train_data_bpe, train_args, num_epochs=500, **default_returnn)
        train_job.rqmt["gpu_mem"] = 24
        asr_model = prepare_asr_model(
            training_name, train_job, train_args_decoding, with_prior=True, datasets=train_data_bpe, get_specific_checkpoint=500
        )
