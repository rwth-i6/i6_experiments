...
def bpe128_kazuki_lstm():

    for BPE_SIZE in [128, 512]:
        prefix_name = "experiments/librispeech/ctc_rnnt_standalone_2024/bpe_%i_lstm" % BPE_SIZE
        ...
        add_lm("bpe%i_2x2024_kazuki_lstmlm_2ep" % BPE_SIZE, lm_model=NeuralLM(
