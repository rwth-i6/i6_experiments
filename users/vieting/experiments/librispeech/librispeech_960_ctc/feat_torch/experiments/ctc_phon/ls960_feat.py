...
def eow_phon_ls960_relposencoder_0924_base():
    ...
    frontend_configs = {
        ...
        "2Dx6v12": VGGNLayerActFrontendV1Config(
            in_features=400 // 2 + 1,
            convs=[
                (32, (3, 3), (2, 1)),
                (64, (3, 3), (2, 1)),
        ...
        "2Dx6v13": VGGNLayerActFrontendV1Config(
            in_features=400 // 2 + 1,
            convs=[
                (32, (3, 3), (2, 1)),
                (64, (3, 3), (2, 1)),
        ...
        "2Dx6v14": VGGNLayerActFrontendV1Config(
            in_features=400 // 2 + 1,
            convs=[
                (32, (3, 3), (2, 1)),
                (64, (3, 3), (2, 2)),
        ...
        "2Dx6v15": VGGNLayerActFrontendV1Config(
            in_features=400 // 2 + 1,
            convs=[
                (32, (3, 3), (2, 2)),
                (64, (3, 3), (2, 2)),
        ...
        "2Dx4v2": VGGNLayerActFrontendV1Config(
            in_features=400 // 2 + 1,
            convs=[(32, (3, 3), (2, 1))] + [(64, (3, 3), 1), (64, (3, 3), (2, 1))] * 3 + [(32, (3, 3), 1)],
    ...
    for exp_name, window_size, window_shift, n_fft, specaug_version in [
        ...
        (f".stftsa.2Dx4v2", 400, 40, None, "stft_v47"),
        (f".stftsa.2Dx4v3", 400, 40, None, "stft_v47"),
        (f".stftsa.2Dx4v4", 400, 40, None, "stft_v47"),
        ...
        (f".stftsa.2Dx2v4", 400, 160, None, "stft_v47"),
        (f".stftsa.2Dx2v5", 400, 160, None, "stft_v47"),
        (f".stftsa.2Dx2v6", 400, 160, None, "stft_v47"),
        (f".stftsa.2Dx2v7", 400, 160, None, "stft_v47"),
    ]:
        stft_config = StftFeatureExtractionV1Config(
            window_size=window_size,
            window_shift=window_shift,
    ...
    for fe_key, specaug_version, out_channels, kernel_size, stride, freeze, init, activation in [
        ...
        ("2Dx6v10", "stft_v47", 80, 256, 10, False, None, None),
        ("2Dx6v11", "stft_v47", 80, 256, 10, False, None, None),
        ("2Dx4v2", "stft_v47", 80, 256, 40, False, None, None),
        ("2Dx4v3", "stft_v47", 80, 256, 40, False, None, None),
        ("2Dx4v4", "stft_v47", 80, 256, 40, False, None, None),
        ("2Dx4v5", "stft_v47", 80, 256, 40, False, None, None),
        ("2Dx4v6", "stft_v47", 80, 256, 40, False, None, None),
        ("2Dx2v4", "stft_v47", 80, 256, 160, False, None, None),
        ...
        ("2Dx6v12", "stft_v47", 128, 256, 10, False, None, None),
