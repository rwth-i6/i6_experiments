...
from .baseline_quant_v2_modules import LinearQuant, QuantizedMultiheadAttention
...
class Model(torch.nn.Module):
    def __init__(self, model_config_dict, quant_model_config_dict=None, **kwargs):
        ...
        if quant_model_config_dict:
            print("Using Quantizable Model")
            self.cfg = QuantModelConfigV1.from_dict(quant_model_config_dict)
