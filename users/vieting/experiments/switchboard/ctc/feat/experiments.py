    ...
    nn_args, report_args_collection = get_nn_args_baseline(
        nn_base_args={
            ...
            "smaller_masks_no_sorting": dict(
                returnn_args={
                    **base_returnn_args,
                    "specaug_config": {"enable_sorting": False, "max_feature": 8, **base_specaug_config},
                },
                feature_args=feature_args,
                lr_args=lr_args,
            ...
            "smaller_masks_with_sorting": dict(
                returnn_args={
                    **base_returnn_args,
                    "specaug_config": {"enable_sorting": True, "max_feature": 8, **base_specaug_config},
                },
                feature_args=feature_args,
                lr_args=lr_args,
