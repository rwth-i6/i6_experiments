    ...
    nn_args, report_args_collection = get_nn_args_baseline(
        nn_base_args = {
            "baseline_with_sorting": dict(
                returnn_args={**base_returnn_args, "specaug_config": {"enable_sorting": True, "max_feature": 15, "steps_per_epoch": 4100}},
                feature_args=feature_args,
                lr_args=lr_args,
                report_args={"batch_size": "2x5k", "enable_sorting": True, "max_feature": 15},
            ),
            "sorting_after_100_epochs": dict(
                returnn_args={**base_returnn_args, "specaug_config": {"enable_sorting": True, "sorting_start_epoch": 100, "max_feature": 15, "steps_per_epoch": 4100}},
                feature_args=feature_args,
                lr_args=lr_args,
                report_args={"batch_size": "2x5k", "enable_sorting": True, "sorting_start_epoch": 100, "max_feature": 15},
            ),
            "smaller_masks_no_sorting": dict(
                returnn_args={**base_returnn_args, "specaug_config": {"enable_sorting": False, "max_feature": 8, "steps_per_epoch": 4100}},
                feature_args=feature_args,
                lr_args=lr_args,
                report_args={"batch_size": "2x5k", "enable_sorting": False, "max_feature": 8},
            ),
            "smaller_masks_with_sorting": dict(
                returnn_args={**base_returnn_args, "specaug_config": {"enable_sorting": True, "max_feature": 8, "steps_per_epoch": 4100}},
                feature_args=feature_args,
                lr_args=lr_args,
                report_args={"batch_size": "2x5k", "enable_sorting": True, "max_feature": 8},
            ),
            "linear_growth_no_sorting": dict(
                returnn_args={**base_returnn_args, "specaug_config": {"enable_sorting": False, "mask_growth_strategy": "linear", "max_feature": 15, "steps_per_epoch": 4100}},
                feature_args=feature_args,
                lr_args=lr_args,
                report_args={"batch_size": "2x5k", "enable_sorting": False, "mask_growth_strategy": "linear", "max_feature": 15},
            ),
            "linear_growth_with_sorting": dict(
                returnn_args={**base_returnn_args, "specaug_config": {"enable_sorting": True, "mask_growth_strategy": "linear", "max_feature": 15, "steps_per_epoch": 4100}},
                feature_args=feature_args,
                lr_args=lr_args,
                report_args={"batch_size": "2x5k", "enable_sorting": True, "mask_growth_strategy": "linear", "max_feature": 15},
            ),
            "delayed_sorting_large_masks": dict(
                returnn_args={**base_returnn_args, "specaug_config": {"enable_sorting": True, "sorting_start_epoch": 200, "max_feature": 20, "steps_per_epoch": 4100}},
                feature_args=feature_args,
                lr_args=lr_args,
                report_args={"batch_size": "2x5k", "enable_sorting": True, "sorting_start_epoch": 200, "max_feature": 20},
            ),
            "early_sorting_large_masks": dict(
                returnn_args={**base_returnn_args, "specaug_config": {"enable_sorting": True, "sorting_start_epoch": 50, "max_feature": 20, "steps_per_epoch": 4100}},
                feature_args=feature_args,
                lr_args=lr_args,
                report_args={"batch_size": "2x5k", "enable_sorting": True, "sorting_start_epoch": 50, "max_feature": 20},
            ),
            "nonlinear_growth_with_sorting": dict(
                returnn_args={**base_returnn_args, "specaug_config": {"enable_sorting": True, "mask_growth_strategy": "step", "max_feature": 15, "steps_per_epoch": 4100}},
                feature_args=feature_args,
                lr_args=lr_args,
                report_args={"batch_size": "2x5k", "enable_sorting": True, "mask_growth_strategy": "step", "max_feature": 15},
            ),
        },
        num_epochs=450,
        evaluation_epochs=[350, 390, 400, 410, 450],
