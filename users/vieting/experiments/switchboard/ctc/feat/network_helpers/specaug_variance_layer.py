...
def calculate_frequency_response_variance(filter_layer):
    """
    Calculate the variance of the frequency response for each feature.
    
    :param tf.Tensor filter_layer: The filter layer tensor
    :return: Variance of frequency response for each feature
    :rtype: tf.Tensor
    """
    x = tf.convert_to_tensor(filter_layer)  # (256, 1, 150) = (N, 1, C)
