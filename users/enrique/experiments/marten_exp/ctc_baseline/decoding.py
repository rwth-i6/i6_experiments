...
from i6_experiments.users.enrique.experiments.marten_exp.ctc_baseline.model import Model, OUT_BLANK_LABEL
from i6_experiments.users.enrique.experiments.marten_exp.ctc_baseline.sum_criterion import sum_loss_ffnn, get_lm_logits, sum_loss_ngram_rf, sum_loss_ngram, sum_loss_ffnn_v2
...
def recog_flashlight_ngram(
    *,
    ...
    from i6_experiments.users.enrique.experiments.marten_exp.language_models.ffnn import FFNN_LM_flashlight
