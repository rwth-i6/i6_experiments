...
import logging
from i6_experiments.users.enrique.jobs.fairseq.wav2vec.wav2vec_data_utils import get_rvad_root #, get_fairseq_root
from sisyphus import tk

# fairseq_root = tk.Path("/u/enrique.leon.lozano/setups/ubuntu_22_setups/fairseq_2025_03_11/work/Fairseq/fairseq")
audio_dir = tk.Path("/u/corpora/speech/LibriSpeech/LibriSpeech/test-other")
...
def prepare_audio():
    ...
    job = Wav2VecUDeleteSilencesInAudioJob(
        ...
        # ),
        fairseq_root=tk.Path("/u/enrique.leon.lozano/setups/ubuntu_22_setups/fairseq_2025_03_11/work/Fairseq/fairseq_w2vu/fairseq"),
        audio_dir=audio_dir,
        valid_percent=0.01,
        extension="flac",
...
def featurize_audio():
    ...
    job = Wav2VecUFeaturizeAudioJob(
        ...
        input_audio_manifests=tk.Path(
            "/work/smt4/zeineldeen/enrique.leon.lozano/setups-data/ubuntu_22_setups/fairseq_2025_06_02/work/i6_experiments/users/enrique/jobs/fairseq/wav2vec/audio_preprocessing/Wav2VecUDeleteSilencesInAudioJob.p7rbJzKV7Pdj/output/preprocessed_manifest"
        ),
        # input_audio_manifests=tk.Path(
