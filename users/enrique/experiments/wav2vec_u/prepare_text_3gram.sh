...
# lid_path=$6
# sil_prob=$7
# # Accept the pruning thresholds as the 8th argument, for example: "0 0 3"
...
# echo "pruning thresholds are $pruning_threshold_1 $pruning_threshold_2 $pruning_threshold_3"
# echo "lg: $lg"
# echo "text_path: $text_path"
# echo "target_dir: $target_dir"
# echo "min_phones: $min_phones"
# echo "phonemizer: $phonemizer"
# echo "lid_path: $lid_path"
# echo "sil_prob: $sil_prob"
# echo "pruning_threshold_1: $pruning_threshold_1"
# echo "pruning_threshold_2: $pruning_threshold_2"
# echo "pruning_threshold_3: $pruning_threshold_3"
# echo "ph_lg: $ph_lg"
# echo "ESPEAK_PATH: $ESPEAK_PATH"
# echo "FAIRSEQ_ROOT: $FAIRSEQ_ROOT"
# echo "KENLM_ROOT: $KENLM_ROOT"
...
$KENLM_ROOT/lmplz -o 3 < $target_dir/phones/lm.phones.filtered.txt --discount_fallback >! $target_dir/phones/lm.phones.filtered.03.arpa
$KENLM_ROOT/build_binary $target_dir/phones/lm.phones.filtered.03.arpa $target_dir/phones/lm.phones.filtered.03.bin