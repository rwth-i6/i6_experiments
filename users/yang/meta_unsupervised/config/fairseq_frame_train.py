...
config_dir = "/u/zyang/setups/mini/recipe/i6_experiments/users/yang/meta_unsupervised/unsupervised/config/gan"
config_name = "w2vu_frame"
extra_configs = {'model.code_penalty': 2, 'model.gradient_penalty': 1.5, 'model.smoothness_weight': 0.75,
                 'common.seed': 4}
user_dir = tk.Path("/u/zyang/setups/mini/recipe/i6_experiments/users/yang/meta_unsupervised/unsupervised")
