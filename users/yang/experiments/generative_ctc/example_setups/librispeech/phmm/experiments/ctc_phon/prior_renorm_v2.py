...
def eow_phon_ls960_relposencoder_0924_base():
    prefix_name = "prior_renorm/librispeech/empirical_prior/"
    ...
    network_module = "ctc.conformer_0924.prior_renorm_ctc_v2"
    ...
    for train_prior_scale in [0.5]:
        for prior_match_loss_scale in [1e2, 50]:
            for disable_dropout_rate in [0.0, 0.1,0.2]:
                for blank_ratio in [0.7]:
                    name = f".prior_renorm_scale{train_prior_scale}_prior_batch_match_scale_{prior_match_loss_scale}_blank_ratio_{blank_ratio}_disable_dropout_{disable_dropout_rate}_smoothing_0.02"
                    ...
                    train_args_work2["net_args"]["model_config_dict"]["disable_dropout_rate"] = disable_dropout_rate
                    train_args_work2["net_args"]["model_config_dict"]['prior_smoothing_factor'] = 0.02
                    ...
                    tune_and_evaluate_helper(training_name, asr_model, default_decoder_config, lm_scales=[1.6,1.4,1.8], prior_scales=[0.2,0.4,0.5,0.6])
