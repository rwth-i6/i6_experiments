...
def bpe128_ls960_0924_base():
    prefix_name = "generative/librispeech/ctc_rnnt_standalone_2024/preload_blank_penalty_ctc_bpe_128"
    ...
    default_model_config.specauc_start_epoch = 5
    ...
    train_config_24gbgpu_amp_radam = {
        ...
        "learning_rates": list(np.linspace(5e-5, 5e-4, 48))
        + list(np.linspace(5e-4, 5e-5, 48))
        + list(np.linspace(5e-5, 1e-7, 4)),
        #############
        ...
        "preload_from_files": {
            "codebook": {
                ...
                # final training loss: about 2.8, need to double check
                #"filename": "/work/asr4/zyang/mini/work/i6_core/returnn/training/ReturnnTrainingJob.ePvQOf2CzHjj/output/models/epoch.1000.pt",
                "init_for_train": True,
    ...
    network_module = "ctc.conformer_0924.generative_ctc_v1_debug_preload"
    train_args_radam = {
    ...
    training_name = (
        ...
        + "/"
        + network_module
        + "debug_load_bestrq_trainable_enc_loss_ctc_blankpen"
    )
    train_job = training(training_name, train_data_bpe, train_config, num_epochs=100, **default_returnn)
