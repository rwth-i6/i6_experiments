...
def check_phoneme_text():
    prefix_name = "experiments/librispeech/phoneme_text"
    ...
    dev_bliss_corpus = tk.Path("/u/zyang/setups/mini/work/i6_core/corpus/transform/ApplyLexiconToCorpusJob.0vBUB2t7vGHg/output/corpus.xml.gz")
    train_bliss_corpus = tk.Path("/u/zyang/setups/mini/work/i6_core/corpus/transform/ApplyLexiconToCorpusJob.GBy1rIKI4Fg6/output/corpus.xml.gz")
    train_phon_text = CorpusToTxtJob(train_bliss_corpus).out_txt
    dev_phon_text = CorpusToTxtJob(dev_bliss_corpus).out_txt
    tk.register_output("train_phone_text", train_phon_text)
    tk.register_output("dev_phone_text", dev_phon_text)
