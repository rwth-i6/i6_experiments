...
def eow_phon_phmm_ls960_wav2vec2_generative():
    prefix_name = "example_setups/librispeech/phmm_standalone_2024/ls960_phmm_eow_phon_wav2vec2_generative"
    ...
    # Historical experiment records kept for reference:
    # run_training_and_search(
    #     ".base_aux6912_seqnce_lr1e-4_bs120x2_amp",
    #     base_model_config,
    # )
    #
    ...
    #
    # run_training_and_search(
    #     ".base_aux6912_seqnce_frozenenc_lr1e-4_bs200x2_amp",
    ...
    frozen_encoder_kernel1_stride1_model_config = ModelConfig(
        **{
            **asdict(base_model_config),
            "aux_loss_layers": [9],
            "aux_loss_scales": [1.0],
    ...
    run_training_and_search(
        ".kernel1_stride1_bnres_frozenenc_aux9",
        frozen_encoder_kernel1_stride1_model_config,
        num_epochs=100,
        decoding_layers=(9,),
    )

    trainable_encoder_kernel9_stride3_model_config = ModelConfig(
        **{
            **asdict(base_model_config),
            "aux_loss_layers": [9, 12],
            "aux_loss_scales": [0.3, 1.0],
    ...
    run_training_and_search(
        ".kernel9_stride3_bnres_trainableenc_aux912",
        trainable_encoder_kernel9_stride3_model_config,
        decoding_layers=(9, 12),
        gpu_mem=48,
        batch_size=140,
    )

    frozen_encoder_kernel9_stride3_model_config = ModelConfig(
        **{
            **asdict(base_model_config),
            "aux_loss_layers": [9],
            "aux_loss_scales": [1.0],
    ...
    run_training_and_search(
        ".kernel9_stride3_bnres_frozenenc_aux9",
        frozen_encoder_kernel9_stride3_model_config,
        num_epochs=100,
        decoding_layers=(9,),
    )
    ...
    fullsum_frozen_encoder_kernel9_stride3_model_config = ModelConfig(
        **{
            **asdict(frozen_encoder_kernel9_stride3_model_config),
...
py = eow_phon_phmm_ls960_wav2vec2_generative
