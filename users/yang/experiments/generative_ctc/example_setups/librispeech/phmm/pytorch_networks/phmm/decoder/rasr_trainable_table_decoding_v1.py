"""
LibRASR decoder for trainable table-transfer models.
"""
...
def forward_init_hook(run_ctx, **kwargs):
    ...
    run_ctx.lm_image_file = config.lm_image_file
...
def forward_step(*, model, data, run_ctx, **kwargs):
    ...
    input_ids_len = data[f"{run_ctx.data_key}:size1"].to(torch.long)
    ...
    hypotheses = []
    for seq_logprobs, seq_len in zip(log_probs, input_ids_len):
