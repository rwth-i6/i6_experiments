...
class ModelConfig:
    ...
    prior_match_loss: Optional[str]
    empirical_blank_ratio: Optional[float]
    prior_match_loss_scale: Optional[float]
    train_prior_scale: Optional[float] = 1.0
    disable_dropout_rate: Optional[float] = 0.2
    prior_smoothing_factor: Optional[float] = 1e-4
