...
from .cluster_sequence_phmm_generative_cfg import ModelConfig
...
class Model(nn.Module):
    """
    Segment-cluster generative pHMM model.

    Input is a sequence of cluster ids. The model is intentionally simple:
    embedding -> bidirectional Conv1d -> output projection -> log-sigmoid.
    """
    ...
    def __init__(self, model_config_dict, **kwargs):
        ...
        self.output = nn.Linear(self.cfg.hidden_size, self.cfg.label_target_size)
