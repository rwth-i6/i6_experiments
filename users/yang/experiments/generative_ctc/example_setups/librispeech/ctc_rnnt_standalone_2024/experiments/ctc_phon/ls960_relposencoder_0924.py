...
def eow_phon_ls960_relposencoder_0924_base():
    ...
    train_args_work8["post_config"] = {"num_workers_per_gpu": 2}
    ...
    tune_and_evaluate_helper(training_name, asr_model, default_decoder_config, lm_scales=[1.6], prior_scales=[0.2])
