...
def _forced_align(
  ...
  ctc_logits = model.ctc_output_layer(collected_outputs[ctc_enc_layer_id])
  ...
  print('target dyn size', model.target_dim_w_blank.dyn_size_ext)
  print('target size', model.target_dim_w_blank.size)
