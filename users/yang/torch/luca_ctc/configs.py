...
def const_linear_learning_rates(lr1, lr2, epoch1, epoch2):
    list_1 = [lr1] *  epoch1
    list_2 = list(np.linspace(lr1, lr2, num=epoch2))
    lr_list = list_1 + list_2
    return lr_list

def linear_const_linear_learning_rates(lr1,lr2,lr3, epoch1, epoch2, epoch3):
    list_1 = list(np.linspace(lr1,lr2, num=epoch1))
    list_2 = [lr2] * epoch2
    list_3 = list(np.linspace(lr2,lr3, num=epoch3))
    lr_list = list_1 + list_2 + list_3
    return lr_list
