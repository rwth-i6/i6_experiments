...
from i6_experiments.users.yang.torch.luca_ctc.model_conformer_ctc import from_scratch_model_def, from_scratch_training
...
def sis_run_with_prefix(prefix_name: Optional[str] = None):
    ...
    train_exp(  # dev-other 7.17
        "finetune-24gb-lrlin5e_6_ep20_1e_6_ep20-add-eos",
