...
import i6_experiments.users.yang.torch.returnn.learning_rates as learning_rates
...
def get_returnn_config(
    ...
    **kwargs,
    ...
    if extern_data_config or extern_data_dict:
        config_dict.update(
            get_extern_data_config(num_inputs=num_inputs, num_outputs=num_outputs, target=target,
                                   extern_data_dict=extern_data_dict, **kwargs)
        )
