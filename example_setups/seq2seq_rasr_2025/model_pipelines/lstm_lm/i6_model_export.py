...
from .i6_model_pytorch_modules import LstmLmScorer, LstmLmStateInitializer, LstmLmStateUpdater
...
def export_scorer(model_config: LstmLmModelV1Config, checkpoint: PtCheckpoint) -> tk.Path:
    ...
    hidden_dim = model_config.lstm_encoder_cfg.lstm_layers_cfg.hidden_dim
