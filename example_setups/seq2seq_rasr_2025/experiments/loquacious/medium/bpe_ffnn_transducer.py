    ...
    for variant in variants:
        ...
        if variant.tree_search:
            lexicon_file = get_bpe_bliss_lexicon(
                bpe_size=bpe_size, corpus_key="train.medium", add_blank=True, add_sentence_end_pron=False
            )
            ...
            vocab_file = get_bpe_vocab_file(bpe_size=bpe_size, corpus_key="train.medium", add_blank=True)
