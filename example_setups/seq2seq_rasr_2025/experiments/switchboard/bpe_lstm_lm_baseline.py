...
def run_bpe_lstm_lm_baseline(prefix: str = "switchboard/bpe_lstm-lm") -> Tuple[LstmLmConfig, PtCheckpoint]:
    ...
    return (model_config, train_job.out_checkpoints[300])  # type: ignore
