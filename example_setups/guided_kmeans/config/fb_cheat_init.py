"""Chunked guided k-means: FB search, Euclidean model, standard segmentation, cheating init."""
...
def run():
    ...
    latex_report = LatexTableReport(
        ...
        caption=f"Chunked FB k-means, cheating init: epoch 0 vs epoch {num_epochs - 1}.",
    )
    recog_results = []
