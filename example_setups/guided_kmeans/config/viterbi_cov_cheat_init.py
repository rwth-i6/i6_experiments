"""Chunked guided k-means: Viterbi search, Gaussian model, standard segmentation, cheating init."""
...
exp_dir = "viterbi_cov_cheat_init"
...
def run():
    ...
    latex_report = LatexTableReport(
        ...
        caption=f"Chunked Viterbi k-means + cov, cheating init: epoch 0 vs epoch {num_epochs - 1}.",
    )
    recog_results = []
