"""Chunked guided k-means: FB search, Gaussian model, standard segmentation, cheating init."""
...
def run():
    ...
    latex_report = LatexTableReport(
        ...
        caption=f"Chunked FB k-means + cov, cheating init: epoch 0 vs epoch {num_epochs - 1}.",
    )
    recog_results = []
