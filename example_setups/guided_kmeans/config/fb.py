"""Chunked guided k-means: FB search, Euclidean model, standard segmentation, random init."""
...
def run():
    ...
    latex_report = LatexTableReport(
        ...
        caption=f"Chunked FB k-means, random init: epoch 0 vs epoch {num_epochs - 1}.",
    )
    recog_results = []
