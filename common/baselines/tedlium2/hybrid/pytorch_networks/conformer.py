...
from i6_models.assemblies.conformer.conformer_v1 import ConformerEncoderV1Config, ConformerBlockV1Config, ConformerPositionwiseFeedForwardV1Config, ConformerConvolutionV1Config, ConformerMHSAV1Config
...
class Model(torch.nn.Module):
    ...
    def __init__(self, epoch, step, **kwargs):
        ...
        frontend_cfg = ConformerVGGFrontendV1Config(in_features=conformer_size, activation=nn.SiLU(), conv1_channels=32, conv2_channels=32, conv3_channels=64, conv4_channels=conformer_size,
            conv_kernel_size=(3, 3), pool1_kernel_size=(3, 3), pool2_kernel_size=(3, 3), pool1_strides=1, pool2_strides=1)
        frontend = SubassemblyWithConfig(module_class=ConformerVGGFrontendV1, cfg=frontend_cfg)
