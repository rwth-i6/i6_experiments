...
SWITCHBOARD1_PATH = tk.Path("/u/corpora/speech/switchboard_ldc/switchboard-1", hash_overwrite="LDC97S62-release2")
...
HUB5E00_TRANSCRIPT_PATH = tk.Path("/u/corpora/speech/switchboard_ldc/2000_hub5_eng_eval_tr", hash_overwrite="LDC2002T43")
